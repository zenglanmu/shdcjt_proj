...
String titlename = SystemEnv.getHtmlLabelName(570,user.getLanguage())+":"+SystemEnv.getHtmlLabelName(110,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<tr>
	...
	<td valign="top">
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=dff01"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=dff02"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=dff03"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=dff04"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=dff05"><%=SystemEnv.getHtmlLabelName(97,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=nff01"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=nff02"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=nff03"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=nff04"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=nff05"><%=SystemEnv.getHtmlLabelName(607,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=tff01"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=tff02"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=tff03"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=tff04"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=tff05"><%=SystemEnv.getHtmlLabelName(608,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=bff01"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>1</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=bff02"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>2</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=bff03"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>3</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=bff04"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>4</a></td>
		...
		<%	}else{%>
		  <tr CLASS=DataLight>
		<%	}%>
			<td><a href="/base/ffield/EditFreeField.jsp?tablename=c3&ffname=bff05"><%=SystemEnv.getHtmlLabelName(609,user.getLanguage())%> <%=SystemEnv.getHtmlLabelName(570,user.getLanguage())%>5</a></td>

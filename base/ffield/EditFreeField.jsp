			  ...
			  <TR>
				...
				<COL width="80%">
					...
					<TR>
					  ...
					  <TD class=Field><%if(canedit){%><INPUT class=InputStyle maxLength=100 size=20 name="fflabel" value="<%=Util.toScreenToEdit(RecordSet.getString(1),user.getLanguage())%>"><%}else{%><%=Util.toScreenToEdit(RecordSet.getString(1),user.getLanguage())%><%}%></TD>
					</TR>

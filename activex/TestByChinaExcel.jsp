...
//-->
        ...
        try{
            ...
            document.all("imgtd").innerHTML="&nbsp;<img src='/images/plugin/warning.gif' width=40 height=40/>";
        ...
        document.all("imgtd").innerHTML="&nbsp;<img src='/images/plugin/right.gif' width=40 height=40/>";
        }
        catch(e)
        {
        document.all("imgtd").innerHTML="&nbsp;<img src='/images/plugin/warning.gif' width=40 height=40/>";
        ...
        <tr>
            <td colspan="2" valign="top">
                <table width="660" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                        <td height="64" background="/images/plugin/back_2.gif">
                            <table width="226" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td><img src="/images/plugin/line_1.gif" width="84" height="2"/></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div id="spnResult" class="STYLE9"><img src="/images/loading2.gif" /><%=SystemEnv.getHtmlLabelName(22372, user.getLanguage())%></div>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr style="display:none">
                       <td><script language=javascript src="/workflow/mode/chinaexcelmenu.js"></script></td> 
                    </tr>
                </table>
            </td>
        </tr>

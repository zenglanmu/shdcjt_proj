...
String titlename = Util.toScreen("网上调查:结果统计",user.getLanguage(),"0");
String needfav ="1";
String needhelp ="";
...
<col width=25%><col width=55%><col width=10%><col width=10%>
  <TR class=Section>
    <TH colSpan=4>投票结果(共 <%=votingcount%> 人参与投票)</TH>
  </TR>
  <TR class=separator>
    <TD class=Sep1 colSpan=4></TD></TR>
<%
...
%>
  ...
  <tr class=datalight>
    <td colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;<img border=0 src="/images/ArrowRightBlue.gif"></img>投票人：   
<%   

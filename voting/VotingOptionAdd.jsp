  ...
  <tr><td>
    ...
    <tr><td>
        ...
        <tr>
          ...
          <td class=field>
    	    <input type="input" name="desc_<%=rowindex%>" class="inputStyle" onchange="checkinput1(desc_<%=rowindex%>,descspan_<%=rowindex%>)" style="width:85%"><span id="descspan_<%=rowindex%>"><IMG src='/images/BacoError.gif' align=absMiddle></span>
    	  </td>
    	  <td class=field>
	...
	for(j=0; j<ncol; j++) {
		...
		switch(j) {
			case 0:
	            ...
	            "<span id='descspan_"+rowindex+"'><IMG src='/images/BacoError.gif' align=absMiddle></span>"+
	            "</td>"+

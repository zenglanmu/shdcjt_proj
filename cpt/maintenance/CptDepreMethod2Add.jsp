  ...
  <TABLE class=form>
    ...
    <TR> 
      ...
      <TD class=Field> 
        ...
        <SPAN id=nameimage><%if(!isEdit) {%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></TD>
    </TR>
    <TR> 
      ...
      <TD class=Field> 
        ...
        <SPAN id=descriptionimage><%if(!isEdit) {%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></TD>
    </TR>
    </TBODY> 
  </TABLE>
	...
	for(j=0; j<ncol; j++) {
		...
		switch(j) {
			...
			case 2: 
				...
				var sHtml = "<input type=input  size=10 maxlength=9 name="+tempname+" onKeyPress='ItemNum_KeyPress()' 	onBlur=\"checknumber('"+tempname+"');checkinput('"+tempname+"','"+tempname+"image')\"> <span id=\""+tempname+"image\"><IMG src=\"/images/BacoError.gif\" align=absMiddle></span>";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				forCheck +=","+tempname;
				break;
			case 1: 
				...
				var sHtml = "<input type=input  size=10 maxlength=13 name="+tempname+" onKeyPress='ItemNum_KeyPress()' 	onBlur=\"checknumber('"+tempname+"');checkinput('"+tempname+"','"+tempname+"image')\"> <span id=\""+tempname+"image\"><IMG src=\"/images/BacoError.gif\" align=absMiddle></span>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				forCheck +=","+tempname;
				break;

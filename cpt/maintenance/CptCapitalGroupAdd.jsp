    ...
    <TD vAlign=top>
  	...
  	<COL width="80%">
        ...
        <TR>
          ...
          <TD class=Field><INPUT class=saveHistory maxLength=50 size=20 name="name" onchange='checkinput("name","nameimage")'><SPAN id=nameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
        </TR>
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(433,user.getLanguage())%></TD>
          <TD class=Field><INPUT class=saveHistory maxLength=150 size=50 name="description" onchange='checkinput("description","descriptionimage")'><SPAN id=descriptionimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
         </TR>        
        <TR>

...
if(detachable==0){
    response.sendRedirect("CptCapitalMaintenance.jsp?from=tree");
    return;
}
%>
...
<IFRAME name=contentframe id=contentframe src="/cpt/capital/CptCapitalMaintenance.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
  </TBODY>

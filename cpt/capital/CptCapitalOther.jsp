  ...
  <TABLE class=form>
    ...
    <tr> 
      ...
      <td class=Field><BUTTON type='button' class=Calendar id=selectotherdate onClick="getotherDate()"></button> 
        <span id=otherdatespan ><IMG src="/images/BacoError.gif" align=absMiddle></span> 
    ...
    <tr> 
      ...
      <td class=Field><BUTTON type='button' class=Browser id=SelectDeparment onClick="onShowDepartment()"></button> 
        <span class=saveHistory id=departmentspan><img src="/images/BacoError.gif" 
    ...
    <tr> 
      ...
      <td class=Field><BUTTON type='button' class=Browser id=SelectCostCenter onClick="onShowCostCenter()"></button> 
        <span class=saveHistory id=costcenterspan><img src="/images/BacoError.gif" 
            align=absMiddle></span> 
    ...
    <tr>
      ...
      <td class=Field><BUTTON type='button' class=Browser id=SelectStateID onClick="onShowStateID()"></button> 
        <span id=stateidspan><img src="/images/BacoError.gif" align=absMiddle></span> 
    ...
    <tr> 
      ...
      <td class=Field> 
        ...
        <span id=locationimage><img src="/images/BacoError.gif" align=absMiddle></span></td>
    </tr>
    <tr> 
...
sub onShowStateID()
	...
	stateidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

...
<tr>
<td><a href="CapitalExcelToDB.xls"><%=SystemEnv.getHtmlLabelName(18616,user.getLanguage())%></a></td>
</tr>
<tr>
...
<tr>
<td  align="left" colspan="3"><font color="#FF0000">
<%=SystemEnv.getHtmlLabelName(195,user.getLanguage())%></font></td></tr>
<tr><td  align="left" colspan="3"><font color="#FF0000">
<%=SystemEnv.getHtmlLabelName(1507,user.getLanguage())%></font></td></tr>
<tr><td  align="left" colspan="3"><font color="#FF0000">
<%=SystemEnv.getHtmlLabelName(1363,user.getLanguage())%>£¨<%=SystemEnv.getHtmlLabelName(163,user.getLanguage())%>/<%=SystemEnv.getHtmlLabelName(161,user.getLanguage())%>£©</font></td></tr>
<tr><td  align="left" colspan="3">
<font color="#FF0000"><%=SystemEnv.getHtmlLabelName(904,user.getLanguage())%></font></td></tr>
<tr><td  align="left" colspan="3">
<font color="#FF0000"><%=SystemEnv.getHtmlLabelName(603,user.getLanguage())%></font></td></tr>
<tr><td  align="left" colspan="3">
<font color="#FF0000"><%=SystemEnv.getHtmlLabelName(1364,user.getLanguage())%></font></td></tr>
<tr><td  align="left" colspan="3">
<font color="#FF0000"><%=SystemEnv.getHtmlLabelName(703,user.getLanguage())%>£¨
<%
String sql_type="";
int num=0;
if (rs.getDBType().equals("oracle")){
sql_type="select  name from cptCapitalType where rownum<=5";
}else if (rs.getDBType().equals("db2")){
sql_type="select name from cptCapitalType fetch first 5 rows only";
}else{
sql_type="select top 5 name from cptCapitalType ";
}
...
<tr><td  align="left" colspan="3">
<font color="#FF0000"><%=SystemEnv.getHtmlLabelName(831,user.getLanguage())%>£¨
<%
num=0;
if (rs.getDBType().equals("oracle")){
sql_type="select  assortmentname from CptCapitalAssortment where subassortmentcount=0 and rownum<=5";
}else if (rs.getDBType().equals("db2")){
sql_type="select assortmentname from CptCapitalAssortment where subassortmentcount=0 fetch first 5 rows only";
}else{
sql_type="select top 5 assortmentname from CptCapitalAssortment where subassortmentcount=0 ";
}
rs.executeSql(sql_type);
while (rs.next()){
    num++;
...
<tr><td align="left" colspan="3"><font color="#FF0000"><%=SystemEnv.getHtmlLabelName(705,user.getLanguage())%>£¨
<%
num=0;
if (rs.getDBType().equals("oracle")){
sql_type="select  unitname from LgcAssetUnit where rownum<=5";
}else if (rs.getDBType().equals("db2")){
sql_type="select unitname from LgcAssetUnit fetch first 5 rows only";
}else{
sql_type="select top 5 unitname from LgcAssetUnit ";
}
rs.executeSql(sql_type);
while (rs.next()){
    num++;
...
<tr><td align="left" colspan="3"><font color="#FF0000"><%=SystemEnv.getHtmlLabelName(406,user.getLanguage())%>£¨
<%
num=0;
if (rs.getDBType().equals("oracle")){
sql_type="select  currencyname from FnaCurrency where rownum<=5";
}else if (rs.getDBType().equals("db2")){
sql_type="select currencyname from FnaCurrency fetch first 5 rows only";
}else{
sql_type="select top 5 currencyname from FnaCurrency ";
}
rs.executeSql(sql_type);
while (rs.next()){
    num++;
...
<tr><td align="left" colspan="3">
<%=SystemEnv.getHtmlLabelName(713,user.getLanguage())%>£¨<%=SystemEnv.getHtmlLabelName(1367,user.getLanguage())%>,<%=SystemEnv.getHtmlLabelName(1366,user.getLanguage())%>,<%=SystemEnv.getHtmlLabelName(1368,user.getLanguage())%>,<%=SystemEnv.getHtmlLabelName(1369,user.getLanguage())%>,<%=SystemEnv.getHtmlLabelName(60,user.getLanguage())%>,<%=SystemEnv.getHtmlLabelName(1370,user.getLanguage())%>,<%=SystemEnv.getHtmlLabelName(811,user.getLanguage())%>£©
</td>
</tr>
<tr><td align="left" colspan="3">
...
<tr><td align="left" colspan="3"><font color="#FF0000"><%=SystemEnv.getHtmlLabelName(19799,user.getLanguage())%>£¨
<%
num=0;
if (rs.getDBType().equals("oracle")){
...
<tr><td align="left" colspan="3"><font color="#FF0000">
<%=SystemEnv.getHtmlLabelName(26451,user.getLanguage())%></font>
</td>
</tr>
</table>

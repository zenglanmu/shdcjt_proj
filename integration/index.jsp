...
<div class="h-all w-all" style='background:url(images/bg.png) top center no-repeat #F5F6FA;'>
<div class="center">
	<div class="h-85">&nbsp;</div>
	<div class="w-500 font36 colorfff p-t-30 " style="margin:0 auto;font-family:'Î¢ÈíÑÅºÚ';padding-left:120px;'">
		<%=SystemEnv.getHtmlLabelName(81371,user.getLanguage()) %>
	</div>
	<div class="w-600 font14  text-left  " style="color:#70a018; margin:0 auto;font-family:'Î¢ÈíÑÅºÚ';padding-left:250px;'">
			<div class="lh-160p p-l-20" style='background:url(images/icon.png) left center no-repeat'>	<%=SystemEnv.getHtmlLabelName(81372,user.getLanguage()) %>¡£</div>
					<div class="lh-160p p-l-20" style='background:url(images/icon.png) left center no-repeat'>	<%=SystemEnv.getHtmlLabelName(81373,user.getLanguage()) %>¡£</div>
					<div class="lh-160p p-l-20" style='background:url(images/icon.png) left center no-repeat'>	<%=SystemEnv.getHtmlLabelName(81374,user.getLanguage()) %>¡£</div>
					<div class="lh-160p p-l-20" >&nbsp;</div>
	</div>
	<div class="w-all  font14 text-left " style='margin:0 auto;font-family:Î¢ÈíÑÅºÚ;color:#70a018;'>
			
			<table width="100%" style='margin:0 auto;font-family:Î¢ÈíÑÅºÚ;color:#70a018;'>
				<tr>
					<td width="50%">
					</td>
			...
			<table class=" w-all" style="margin:0 auto;">
				<tr>
					<td class=' ' align='middle'>
						<div class="w-162">
							<div><img id="1"  src="images/1.png" class="hand"  onclick="onloadContent(1)"></div>
					...
					<td class=' ' align='middle'>
					<div class="w-162">
							<div><img id="2" src="images/2.png"  onclick="onloadContent(2)"  style="cursor: pointer;"></div>
					...
					<td class=' ' align='middle'>
					<div class="w-162">
							<div><img id="3" src="images/3.png" class="hand" onclick="onloadContent(3,1)"></div>
					...
					<td class=' ' align='middle'>
					<div class="w-162">
							<div><img id="4" src="images/4.png" class="hand" onclick="onloadContent(4,2)"></div>
					...
					<td class=' ' align='middle'>
					<div class="w-162">
							<div><img id="5" src="images/5.png " class="hand" onclick="onloadContent(5)"></div>
							<div class="font14 color333 m-t-10 hand"><%=SystemEnv.getHtmlLabelName(81386,user.getLanguage()) %></div>
							<div class="font12 lh-160p m-t-10 " style='color:#70a018;text-align: left;'>
									<ul>
										<li><%=SystemEnv.getHtmlLabelName(81387,user.getLanguage()) %></li>
										<li style=" list-style-type: none "></li>
										<li style=" list-style-type: none "></li>
									</ul>
							</div>
...
<script type="text/javascript">
	jQuery("img").hover(function(){
		$(this).attr("src","images/"+$(this).attr("id")+"_hover.png")
	},function(){

					...
					{	
						...
						if(list != null) {
							for(int i=0;i<list.size();i++) {
								...
								temp += "<td style='padding-top:0px;padding-bottom:0px;'><table   cellspacing=1 style='width:100%;margin-top:0px;margin-bottom:0px;padding-top:0;padding-bottom:0;'><tr><td style='width:50px;vertical-align: middle;'>结构体名</td><td style='width:220px;'><button type='button' class='browser' "; 
			...
			if("update".equals(opera))
			{
				...
				if(list != null) {
					for(int i=0;i<list.size();i++) {
						...
						temp += "<td style='padding-top:0px;padding-bottom:0px;'><table   cellspacing=1 style='width:100%;margin-top:0px;margin-bottom:0px;padding-top:0;padding-bottom:0;'><tr><td style='width:50px;vertical-align: middle;'>表名</td><td style='width:220px;'><button type='button' class='browser' "; 
			...
			if("update".equals(opera))
			{
				...
				if(list != null) {
					for(int i=0;i<list.size();i++) {
					   ...
					   temp += "<table   cellspacing=1 style='width:100%;margin-top:0px;margin-bottom:0px;padding-top:0;padding-bottom:0;'><tr><td style='width:50px;vertical-align: middle;'>表名</td><td style='width:220px;'><button type='button' class='browser' ";
						...
						if (temp.id!="" && temp.id != 0) 
						{
							...
							for(var ij=0;ij<tempsz.length;ij++)
							{
								if(tempsz[ij])
								{
										...
										var temp = "<td style='padding-top:0px;padding-bottom:0px;'><table   cellspacing=1 style='width:100%;margin-top:0px;margin-bottom:0px;padding-top:0;padding-bottom:0;'><tr><td style='width:50px;vertical-align: middle;'>结构体名</td><td style='width:220px;'><button type='button' class='browser' "; 
		    	 	...
		    	 	if (temp.id!="" && temp.id != 0)
		    	    {
							...
							for(var ij=0;ij<tempsz.length;ij++)
							{
								if(tempsz[ij])
								{
									...
									var temp = "<td style='padding-top:0px;padding-bottom:0px;'><table   cellspacing=1 style='width:100%;margin-top:0px;margin-bottom:0px;padding-top:0;padding-bottom:0;'><tr><td style='width:50px;vertical-align: middle;'>表名</td><td style='width:220px;'><button type='button' class='browser' "; 

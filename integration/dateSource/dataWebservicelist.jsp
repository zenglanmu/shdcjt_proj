...
<html>
	...
	<%
		...
		tableString =   " <table instanceid=\"sendDocListTable\" tabletype=\"checkbox\" pagesize=\""+perpage+"\" >"+
                ...
                "       <head>"+
                "           <col width=\"140\"  text=\""+SystemEnv.getHtmlLabelName(23963,user.getLanguage())+"\" column=\"poolname\"  transmethod=\"com.weaver.integration.util.IntegratedMethod.getSourcenameWEB\"  otherpara=\"column:id\" />"+
				"           <col width=\"140\"  text=\"WSDL"+SystemEnv.getHtmlLabelName(110,user.getLanguage())+"\" column=\"wsdladdress\"   />"+
				"           <col width=\"140\"  text=\""+SystemEnv.getHtmlLabelName(30650,user.getLanguage())+"\" column=\"pooldesc\"   />"+
                "       </head>"+
                " </table>";
	%>
	<body>
	...
	<script type="text/javascript">
		...
		function doAdd()
		{
			window.location.href="/integration/dateSource/dataWebserviceNew.jsp?hpid=<%=hpid%>";
		}
		function doUpdate(id)
		{
			window.location.href="/integration/dateSource/dataWebserviceNew.jsp?isNew=1&id="+id+"&hpid=<%=hpid%>";
		}
		function doDelete()
		{

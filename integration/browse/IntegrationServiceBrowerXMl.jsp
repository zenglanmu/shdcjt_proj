<%@ page import="weaver.general.Util" %><%@ page import="weaver.common.util.xtree.TreeNode" %><%@ page import="java.util.*" %><%@ page import="weaver.hrm.*" %><%@ page import="weaver.hrm.company.CompanyTreeNode"%><%@ page language="java" contentType="text/html; charset=GBK" %>
...
%><jsp:useBean id="SubCompanyComInfo" class="weaver.hrm.company.SubCompanyComInfo" scope="page" /><jsp:useBean id="CompanyComInfo" class="weaver.hrm.company.CompanyComInfo" scope="page" /><jsp:useBean id="DepartmentComInfo" class="weaver.hrm.company.DepartmentComInfo" scope="page" /><%
	...
	while(rs.next())
	{
		...
		jobTitleNode.setIcon("/images/treeimages/subCopany_Colse.gif");
		...
		while(rs02.next())
		{
			...
			jobTitleNode02.setIcon("/images/treeimages/subCopany_Colse.gif");

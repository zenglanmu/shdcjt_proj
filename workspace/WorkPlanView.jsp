...
String tempTable = "WPTempTable"+ Util.getRandom();
String sqlStr = "";
			     						...
			     						<tr class="<%=isLight%>">
			     							<td align="right">
			     								<A OnClick="doOnClickTd('<%=cdays%>')" style="CURSOR: hand;">
			     									<img border=0 src="/images/more.gif"></img>
			     								</a>
			     							</td>
			     						</tr>
		<%
		...
		%> 
			...
			<tr class="DataDark"><td valign="top">
			 ...
			 <%if (num==10)
			     ...
			     <A OnClick="doOnClickTd('<%=cdays%>')" style="CURSOR: hand;"><img border=0 src="/images/more.gif"></img></a>
			     </td></tr>
			<%}%>
			</table>
			</td>
...
function workPlanToggleleft(obj) {
	...
	if (f != null) {
		...
		if (c == "*,0") {
			...
			obj.value = "<img src='/images_face/ecologyFace_1/ClickMenuIcon/CM_2.gif' border=0 align='absmiddle'> <%=SystemEnv.getHtmlLabelName(16636,user.getLanguage())%>";
			//end
		} else { 
			f.cols = "*,0";
			//added by lupeng 2004.05.21 for TD487.
			obj.value = "<img src='/images_face/ecologyFace_1/ClickMenuIcon/CM_2.gif' border=0 align='absmiddle'> <%=SystemEnv.getHtmlLabelName(89,user.getLanguage())%>";
			//end
		}
	}
}

...
<TR><TD width=55px align=left><IMG src="images/hdSystem.gif" height=24px></TD><TD align=left><SPAN ID=BacoTitle style="font-size:medium; font-weight:bold">功能</SPAN></TD><TD align=right>&nbsp;</TD><TD width=5px></TD><TD align=center width="24px"><BUTTON class="btnFavorite" TITLE="Add to favorites" ID=BacoAddFavorite language=VBS ></BUTTON>
<SCRIPT LANGUAGE=VBS>
...
<DIV>
<BUTTON TYPE=SUBMIT CLASS=btnSave ACCESSKEY="S"><U>S</U>-保存</BUTTON> 
<BUTTON CLASS=btnNew ID=AddNew ACCESSKEY="N"><U>N</U>-新</BUTTON> 
<BUTTON CLASS=btnDelete ID=Delete ACCESSKEY="D"><U>D</U>-删除</BUTTON> </DIV>
<SCRIPT LANGUAGE=VBS>
   Sub AddNew_onclick
...
<TR class=DataLight><TD>11</A></TD><TD><A HREF=SystemRoleFunction.asp?Action=1&ID={2F8B6741-53B0-4303-A8C8-3281E00216CE}>HR Manager</A></TD><TD>公司</TD></TR>
</BODY>
</HTML>
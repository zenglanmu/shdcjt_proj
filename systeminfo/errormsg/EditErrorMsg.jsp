...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    ...
    <TD align=left><SPAN id=BacoTitle class=titlename>编辑: 错误信息</SPAN></TD>
    <TD align=right>&nbsp;</TD>
    <TD width=5></TD>
  <tr>
 <TBODY>
...
<%
String errIfoSql="select ErrorMsgInfo.*,syslanguage.language,syslanguage.id from ErrorMsgInfo inner join syslanguage on ErrorMsgInfo.languageid=syslanguage.id where indexid=" + id;
...
%>
          <TR> 
            ...
            <Td><INPUT class=FieldLong name="errormsgname<%=languageid%>" value="<%=msgname%>"></Td>
          </TR>
<%
}
%>
<input type="hidden" name="operation" value="editerrormsg">

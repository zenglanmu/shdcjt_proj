...
if(operationType.equals("addC")){
	...
	sql = " INSERT INTO LeftMenuInfo (id,labelId,iconUrl,linkAddress,menuLevel,parentId,defaultIndex,useCustomName,customName,relatedModuleId,isCustom) " +
		  " VALUES ("+currentID+",null,'/images/folder.png',null,1,null,"+customMenuCViewIndex+",'1','"+customMenuCName+"',12,'1')";
	rs.executeSql(sql);
...
//Add Menu
	...
	sql = " INSERT INTO LeftMenuInfo (id,labelId,iconUrl,linkAddress,menuLevel,parentId,defaultIndex,useCustomName,customName,relatedModuleId,isCustom,baseTarget) " +
		  " VALUES ("+currentID+",null,'/images_face/ecologyFace_2/LeftMenuIcon/level3.gif','"+customMenuLink+"',2,"+parentID+","+customMenuViewIndex+",'1','"+customMenuName+"',12,'1','"+targetframe+"')";
	rs.executeSql(sql);
...
//Clone Menu
	...
	sql = " INSERT INTO LeftMenuInfo (id,labelId,iconUrl,linkAddress,menuLevel,parentId,defaultIndex,useCustomName,customName,relatedModuleId,isCustom) " +
		  " VALUES ("+currentID+",null,'/images_face/ecologyFace_2/LeftMenuIcon/level3.gif','"+customMenuLink+"',2,"+parentID+","+customMenuViewIndex+",'1','"+customMenuName+"',12,'1')";
	rs.executeSql(sql);

...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
 ...
 <DIV class=HdrProps></DIV>
  ...
  <FORM style="MARGIN-TOP: 0px" name=frmView method=post action="ManageSystemModuleOperation.jsp">
   ...
   <input type="hidden" name="operation" value="addModule">

    <BUTTON class=btn id=btnSave accessKey=S name=btnSave onClick="addModule()"><U>S</U>-保存</BUTTON>
...
function addModule(){
    frmView.operation.value = "addModule";

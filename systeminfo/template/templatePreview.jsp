...
.folder{
	...
	<%if(leftbarBgImage.equals("")){%>
		background-image:url(/images/StyleGray/leftbarBgImage.jpg);
...
.folderMouseOver{
	...
	<%if(leftbarBgImageH.equals("")){%>
		background-image:url(/images/StyleGray/leftbarBgImageH.gif);
...
.handle{
	...
	<%if(menuInBoldBorderbg.equals("")||menuInBoldBorderbg.equals("0")){%>
		background-image:url(/images/StyleGray/leftmenuToggleHBg.jpg);
...
#thumbBox{
	...
	<%if(menuBottomCusbg.equals("")||menuBottomCusbg.equals("0")){%>
		background-image:url(/images/StyleGray/thumbBoxBg.jpg);
...
.menu-body .inner-border {
	...
	padding:		0 1px 0 1px;
	margin:			0;
	background:		#f9f8f7 url("/images/popup/bg_menu.gif") repeat-y;
}
	...
	<tr>
		...
		%>
			...
			<td width=23 align="center">
				<IMG id=LeftHideShow  title="<%=SystemEnv.getHtmlLabelName(16636,user.getLanguage())%>" style="CURSOR: hand" src="/images_face/ecologyFace_1/BP_Hide.gif" >
			</td>
			<td width=23 align="center">
				<IMG id=TopHideShow  title="<%=SystemEnv.getHtmlLabelName(16636,user.getLanguage())%>" style="CURSOR: hand" src="/images_face/ecologyFace_1/BP2_Hide.gif">
			</td>
			<td width=10 align="center">
				<img src="/images_face/ecologyFace_1/VLine_1.gif" border=0>
			</td>
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/LogOut.gif" title="<%=SystemEnv.getHtmlLabelName(1205,user.getLanguage())%>"></td></tr></table><!--退出-->
			</td>
			<td width=10 align="center">
				<img src="/images_face/ecologyFace_1/VLine_1.gif" border=0>
			</td>
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Back.gif" title="<%=SystemEnv.getHtmlLabelName(15122,user.getLanguage())%>"></td></tr></table><!--后退-->
			</td>
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Pre.gif" title="<%=SystemEnv.getHtmlLabelName(15123,user.getLanguage())%>"></td></tr></table><!---->
			</td>
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Refur.gif" title="<%=SystemEnv.getHtmlLabelName(354,user.getLanguage())%>"></td></tr></table><!--刷新-->
			</td>
		<!--<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Favourite.gif" title="<%=SystemEnv.getHtmlLabelName(2081,user.getLanguage())%>"></td></tr></table>收藏夹
			</td> -->
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Print.gif" title="<%=SystemEnv.getHtmlLabelName(257,user.getLanguage())%>"></td></tr></table><!--打印-->
			</td>
			<td width=10 align="center">
				<img src="/images_face/ecologyFace_1/VLine_1.gif" border=0>
			</td>
			...
			<td>
				...
				<tr>
					...
					<td nowrap>
					<img alt="<%=SystemEnv.getHtmlLabelName(16646,user.getLanguage())%>" src="/images_face/ecologyFace_1/search_dot.gif" border="0" style="CURSOR:HAND">
					</td>
				</tr>
				</table>
		</td>
		...
		<table height=100% border="0" cellspacing="0" cellpadding="0">
			<tr>
			<td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Home.gif"  title="<%=SystemEnv.getHtmlLabelName(1500,user.getLanguage())%>"></td></tr></table><!--首页-->
			</td>
			<td width=10 align="center">
				<img src="/images_face/ecologyFace_1/VLine_1.gif" border=0>
			</td>
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Plan.gif" title="<%=SystemEnv.getHtmlLabelName(2101,user.getLanguage())%>"></td></tr></table><!--我的计划-->
			</td>
			<td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Mail.gif" title="<%=SystemEnv.getHtmlLabelName(2029,user.getLanguage())%>"></td></tr></table><!--新建邮件-->
			</td>
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Doc.gif" title="<%=SystemEnv.getHtmlLabelName(1986,user.getLanguage())%>"></td></tr></table><!--新建文档-->
			</td>
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/WorkFlow.gif" title="<%=SystemEnv.getHtmlLabelName(16392,user.getLanguage())%>"></td></tr></table><!--新建流程-->
			</td>
            <%//if(software.equals("ALL") || software.equals("CRM")){%>
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/CRM.gif" title="<%=SystemEnv.getHtmlLabelName(15006,user.getLanguage())%>"></td></tr></table><!---->
			</td>
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/PRJ.gif"  title="<%=SystemEnv.getHtmlLabelName(15006,user.getLanguage())%>"></td></tr></table><!---->
			</td>
            <%//}%>
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Meeting.gif"  title="<%=SystemEnv.getHtmlLabelName(15008,user.getLanguage())%>"></td></tr></table><!---->
			</td>
			<td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Org.gif" title="<%=SystemEnv.getHtmlLabelName(16455,user.getLanguage())%>"></td></tr></table><!--组织结构-->
			</td>		
            <td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Version.gif" title="<%=SystemEnv.getHtmlLabelName(567,user.getLanguage())%>"></td></tr></table><!--版本-->
			</td>
			</tr>
		</table>
		</td>
	...
	<td>
		...
		<TR>
			...
			%>
				...
				<td style="height:100%;width:5px;padding:0px 0 0px 0px;background-image:url(<%=leftmenuToggleBg%>);text-align:center"><img src="/images/StyleGray/handleV.gif"/></td>
...
function getXML(){
	dom.async = false;
	dom.loadXML('<menu><menubar id="0" levelid="94" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(18027,user.getLanguage())%>"></menubar><menubar id="1" levelid="111" icon="/images_face/ecologyFace_2/LeftMenuIcon/InformationCenter.gif" name="<%=SystemEnv.getHtmlLabelName(18051,user.getLanguage())%>" extra="infoCenter"></menubar><menubar id="2" levelid="80" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(18032,user.getLanguage())%>"></menubar><menubar id="3" levelid="1" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(16391,user.getLanguage())%>"></menubar><menubar id="5" levelid="2" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(16394,user.getLanguage())%>"></menubar><menubar id="6" levelid="5" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(16414,user.getLanguage())%>"></menubar><menubar id="7" levelid="3" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(6059,user.getLanguage())%>"></menubar><menubar id="8" levelid="4" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(1211,user.getLanguage())%>"></menubar><menubar id="9" levelid="6" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(2102,user.getLanguage())%>"></menubar><menubar id="10" levelid="107" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(18033,user.getLanguage())%>"></menubar><menubar id="11" levelid="7" icon="/images_face/ecologyFace_2/LeftMenuIcon/MyMail.gif" name="<%=SystemEnv.getHtmlLabelName(1209,user.getLanguage())%>"></menubar></menu>');	
}
...
function createMenu(){
	...
	oTD.innerHTML = "<img src=\"/images/StyleGray/handleH.gif\" style=\"\"/>";
	...
	oTD = oTR.insertCell();
	oTD.id = "thumbBox";
	oTD.innerHTML = "<img id='rightArrow' src='/images/StyleGray/rArrow.gif'/>";

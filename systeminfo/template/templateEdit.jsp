...
<td class=Field>
	...
	<img src="/images/StyleGray/ecologyLogoA.jpg"/>
	<%}else{%>
...
<td class=Field>
	...
	<%if((logoBottom.equals("") || logoBottom.equals("0"))){
		if((logo.equals("")||logo.equals("0"))){
			%>
			<img src="/images/StyleGray/ecologyLogoB.jpg"/>
			<%
		}
	}else{%>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('topBgColor');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('toolbarBgColor');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<%if(toolbarBgImage.equals("")){%>
		<img src="/images/StyleGray/toolbarBg.jpg" width="100" height="28"/>
		<br/>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('leftbarBgColor');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<%if(leftbarBgImage.equals("")){%>
		<img src="/images/StyleGray/leftbarBgImage.jpg" width="100" height="22"/>
		<br/>
...
<td class=Field>
	...
	<%if(leftbarBgImageH.equals("")){%>
		<img src="/images/StyleGray/leftbarBgImageH.gif" width="100" height="22"/>
		<br/>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('leftbarFontColor');" class="colorPicker"></td>
	</tr>
...
<tr>
<td>左菜单背景色</td>
<td class=Field><input type="text" class="InputStyle" maxlength="50" id="leftMenuBgColor" name="leftMenuBgColor" value="<%//=leftMenuBgColor%>"/><img src="/images/ColorPicker.gif" onclick="javascript:getColor('leftMenuBgColor');" class="colorPicker"></td>
</tr>
<TR><TD class=Line colSpan=2></TD></TR>

<tr>
<td>左菜单字体颜色</td>
<td class=Field><input type="text" class="InputStyle" maxlength="50" id="leftMenuFontColor" name="leftMenuFontColor" value="<%//=leftMenuFontColor%>"/><img src="/images/ColorPicker.gif" onclick="javascript:getColor('leftMenuFontColor');" class="colorPicker"></td>
</tr>
<TR><TD class=Line colSpan=2></TD></TR>
-->
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubarBgColor');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubtnBgColor');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubtnBgColorActive');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubtnBgColorHover');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubtnBorderColorActive');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubtnBorderColorHover');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<tr>
		...
		<td><img src="/images/ColorPicker.gif" onclick="javascript:getColor('menubtnFontColor');" class="colorPicker"></td>
	</tr>
...
<td class=Field>
	...
	<%if(menuborderbg.equals("")){%>
		<img src="/images/StyleGray/leftmenuBoxBg.jpg" width="201" height="3"/>
		<br/>
...
<td class=Field>
	...
	<%if(menuInBoldBorderbg.equals("")){%>
		<img src="/images/StyleGray/leftmenuToggleHBg.jpg" width="6" height="1"/>
		<br/>
...
<td class=Field>
	...
	<%if(menuBottomCusbg.equals("")){%>
		<img src="/images/StyleGray/thumbBoxBg.jpg" width="405" height="6"/>
		<br/>

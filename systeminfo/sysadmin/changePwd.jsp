...
<td valign="top">
	...
	<table class="viewform">
		...
		<tr>
			...
			<td class=Field><INPUT type="password" class=Inputstyle maxLength=100 size=20 name="oldpassword" value="" onchange='checkinput("oldpassword","oldpasswordimage")'><SPAN id="oldpasswordimage"><IMG src="/images/BacoError.gif" align="absMiddle"><%if(result.equals("false")){%><div style="color:#FF0000 "><%=SystemEnv.getHtmlNoteName(17,user.getLanguage())%></div><%}%></SPAN></td>
		</tr>
		<TR style="height:1px;"><TD class="Line" colSpan="2"></TD></TR>	
        <%}%>
        <tr>
        	<td><%=SystemEnv.getHtmlLabelName(365,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(409,user.getLanguage())%></td>
			<td class=Field><INPUT type="password" class=Inputstyle maxLength=100 size=20 name="newpassword" value="" onchange='checkinput("newpassword","newpasswordimage")'><SPAN id="newpasswordimage"><IMG src="/images/BacoError.gif" align="absMiddle"></SPAN></td>
		</tr>
		<TR style="height:1px;"><TD class="Line" colSpan="2"></TD></TR>
		<tr>
			<td><%=SystemEnv.getHtmlLabelName(501,user.getLanguage())%></td>
			<td class=Field><INPUT type="password" class=Inputstyle maxLength=100 size=20 name="newpasswordagain" value="" onchange='checkinput("newpasswordagain","newpasswordagainimage")'><SPAN id="newpasswordagainimage"><IMG src="/images/BacoError.gif" align="absMiddle"></SPAN></td>
		</tr>
		<TR style="height:1px;"><TD class="Line" colSpan="2"></TD></TR>
		</tbody>
	</table>

    ...
    <TABLE class=ViewForm>
		...
		<TBODY>
			...
			<tr>
			  ...
			  <td class=Field>
				<input type="checkbox" name=isCoworkHead  value="1" <% if(isCoworkHead.equals("1")) {%>checked<%}%> disabled>
			  </td>
			</tr>
			<TR style="height:1px;"><TD class=Line colspan=2></TD></TR>
			<tr>
              <td>页面切换方式</td>
              <td class=Field>
                <select name="cutoverWay" value="<%=cutoverWay %>" disabled>
            ...
            <tr>
              <td>页面切换过渡时间（秒）</td>
              <td class=Field>
                <input type="text" name="TransitionTime" onkeypress="ItemNum_KeyPress()" value="<%=transitionTime %>" disabled>（不设置或者设置0则关闭效果）
              </td>
            </tr>
            ...
            <tr>
              <td>页面切换过渡方式</td>
              <td class=Field>
	               <select name="TransitionWay" value="<%=transitionWay %>" disabled>

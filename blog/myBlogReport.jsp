  ...
  <div style="margin-top: 3px;margin-bottom: 15px;">
    ...
    <div style="width:100%;overflow-x: auto;padding-bottom: 30px;">
		...
		<div style="text-align: left;margin-top: 8px">
	          <%=SystemEnv.getHtmlLabelName(85,user.getLanguage())%>：<span style="margin-right: 8px"><img src="images/submit-no.png" align="absmiddle" style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(15178,user.getLanguage())%></span><!-- 说明  未提交-->
	          <span  style="margin-right: 8px"><img src="images/submit-ok.png" align="absmiddle" style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(15176,user.getLanguage())%></span><!-- 已提交 -->
	          <%if(appDao.getAppVoByType("mood").isActive()){ %>
		          <span  style="margin-right: 8px"><img src="images/mood-unhappy.png" align="absmiddle" width="16px" style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(26918,user.getLanguage())%></span><!--不高兴-->
		          <span  style="margin-right: 8px"><img src="images/mood-happy.png" align="absmiddle" width="16px" style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(26917,user.getLanguage())%></span><!-- 高兴-->
	          <%}else{%>
	          <%}%>
		       <%if(isSignInOrSignOut.equals("1")){ %> 
			      <span style="margin-right: 8px;"><img src="images/sign-absent.png" width="18px" w align="absmiddle" style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(20085,user.getLanguage())%></span><!-- 旷工 -->
			      <span style="margin-right: 8px;"><img src="images/sign-no.png" align="absmiddle" width="18px"  style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(20081,user.getLanguage())%></span><!-- 迟到 -->
			      <span style="margin-right: 8px;"><img src="images/sign-ok.png" align="absmiddle" width="18px" style="margin-right: 5px" /><%=SystemEnv.getHtmlLabelName(225,user.getLanguage())%></span><!-- 正常 -->
		       <%} %>
	     </div>  
	</div>
</div>		

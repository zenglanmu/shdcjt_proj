			...
			<div class="sortInfo">
			  <span style="float: left;">
				...
				<span class="sortInfoRightBar" >
				  ...
				  <a href="javascript:void(0)" onclick="showReplySubmitBox(this,'<%=discessVo.getId() %>',{'uid':'<%=user.getUID() %>','level':'0'},1)">私评</a><!-- 私评 -->
				</span>
			</div>
			  ...
			  <div id="re_<%=replyVo.getId()%>">
				<div class="sortInfo replyTitle">
						...
						<span class="sortInfoRightBar">
						    ...
						    <a href="javascript:void(0)"  onclick="showReplySubmitBox(this,0,{'uid':'<%=replyVo.getUserid()%>','name':'<%=ResourceComInfo.getLastname(replyVo.getUserid())%>','level':'1','replyid':'<%=replyVo.getId() %>'},1)">私评</a><!-- 私评 -->
						</span>
					</div>
					<div class="clear reportContent">
						<%=replyVo.getContent()%>

  ...
  <div style="margin-top: 3px;margin-bottom: 15px">
	...
	<div align="left" style="margin-top: 8px">
	  ...
	  <!-- 报表类型 -->
		  ...
		  <a href="#" onclick="changeReport(this,'blog')" style="margin-right: 8px;" class="items"><%=SystemEnv.getHtmlLabelName(26467,user.getLanguage())+SystemEnv.getHtmlLabelName(15101,user.getLanguage())%></a><!-- 微博报表 -->
		  <%if(appDao.getAppVoByType("mood").isActive()){ %>
		  <a href="#" onclick="changeReport(this,'mood')" style="margin-right: 8px;"><%=SystemEnv.getHtmlLabelName(26769 ,user.getLanguage())+SystemEnv.getHtmlLabelName(15101,user.getLanguage())%></a><!-- 心情报表 -->
		  <%} %>
	  </div>
 ...
 function changeMonth(year,month,monthstr,title){
  ...
  function compareChart(reportdiv,title,charType){
   ...
   if(conditions.length==0){
      alert("<%=SystemEnv.getHtmlLabelName(25763 ,user.getLanguage())%>"); //对不起，请选择人员!
      return ;
   }

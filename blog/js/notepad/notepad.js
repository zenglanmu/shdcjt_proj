var notepad=function(objtag){
    	...
    	var init=function(){
	    	...
	    	if(eleShare.length==0){
			    ...
			    newNode.innerHTML ='<img id="imgSinaShare" class="img_sina_share"  style="display:none; position:absolute; cursor:pointer;" title="将选中内容发送到微博便签" src="/blog/images/blog_notes.png" width="24" />';
			   ...
			   eleShare.hover(function(){
			       jQuery(this).attr("src","/blog/images/blog_notes_over.png");
			   },function(){
			       jQuery(this).attr("src","/blog/images/blog_notes.png");
			   });
    		}
    	};

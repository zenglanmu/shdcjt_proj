...
<script>
 ...
 <div style="background:f0f5f8;color:#333;text-align: left;direction: ltr;height: 30px;padding-left: 8px;padding-top: 5px">
     <img src="images/request.gif" align="absmiddle"><span style="font-weight: bold;margin-left: 3px"><%=SystemEnv.getHtmlLabelName(25436,user.getLanguage())+SystemEnv.getHtmlLabelName(648,user.getLanguage())%></span><!-- 关注请求 --> 
 </div>
<%

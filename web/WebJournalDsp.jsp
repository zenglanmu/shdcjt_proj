        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" valign=top>
          <tr>
            <td width="100%" valign=top> 
				  ...
				  <tr> 
					<td height="1" colspan="2" background="/web/images/bg_hdotline.gif" class="p9grey"><img src="/web/images/spacer.gif" width="1" height="1"></td>
				  </tr>
				  </form>
				  </table><BR>
							...
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
							  <tr> 
								...
								<%}%>
								 ...
								 <%if(curimgid>0){%>&nbsp;&nbsp;[图文]<%}%>
								 <BR><img border="0" src="/web/images/icon_arrow.gif">&nbsp;<a href="<%=webServer%>/web/WebDetailDsp.jsp?id=<%=docid%>&languageid=<%=languageid%>&isTime=<%=isTime%>" target="_top">

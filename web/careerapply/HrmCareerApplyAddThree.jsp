...
-->      
   ...
   <TR class=Separator> 
      ...
      <TABLE width="100%" class=ListShort cols=7 id=eduTable>
          ...
          <TR class=Separator> 
            <TD height="1" background="/web/images/bg_hdotline.gif" colSpan=7></TD>
          </TR>	
		  <tr bgcolor="F3F3F3">
            <td></td>
      ...
      <TH colspan=2 align=left>工作简历</TH>       
        ...
        <TR class=separator>
        <TD height="1" background="/web/images/bg_hdotline.gif" colspan=7></TD></TR>
             <tr bgcolor="F3F3F3">
               <td width=10></td>
      ...
      <TABLE class=ListShort cellpadding=1  cols=6 id="trainTable">	  
       ...
       <Td colspan=3 align=right>
        ...
        <TR class=separator>
        <TD height="1" background="/web/images/bg_hdotline.gif" colspan=5></TD>
        </TR>
        	<tr bgcolor="F3F3F3">
               <td width=10></td>
      ...
      <TABLE class=ListShort cellpadding=1  cols=4 id="rewardTable">	  
       ...
       <TR class=separator >        
       <TD height="1" background="/web/images/bg_hdotline.gif" colspan=4></TD></TR>
       </TR>
        	<tr bgcolor="F3F3F3">
               <td width=10></td>

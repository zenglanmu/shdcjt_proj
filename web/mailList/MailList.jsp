...
<TABLE class=ViewForm>
  ...
  <TBODY>
          ...
          <TD>名称</TD>
          <TD class=Field>
              <input name=name class=inputstyle  onchange='checkinput("name","nameimage")' value="<%if(!name.equals("")){%><%=name%><%}%>"><SPAN id=nameimage><%if(name.equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN>
		  </TD>
        </TR>

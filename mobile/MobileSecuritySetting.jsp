...
<script type="text/javascript">
	...
	function addModuleConfig(){
		...
		if(table) {
			...
			oCell.innerHTML = "<BUTTON class=Browser id=SelectCaller_1 onclick=\"onShowHrmCaller('userspan_" + total + "','userid_" + total + "','1')\"></BUTTON><SPAN id=userspan_" + total + "> <IMG src='/images/BacoError.gif' align=absMiddle></SPAN><input type=\"hidden\" id=\"userid_" + total + "\" name=\"userid\">";
			oCell = oRow.insertCell();
			oCell.innerHTML = "<input type=\"text\" class=\"InputStyle styled input\" id=\"udid_"+ total + "\" name=\"udid\" class=\"InputStyle\" style=\"width:80%\" onChange=\"checkinput('udid_" + total + "','namespan_" + total + "')\"><span id=\"namespan_" + total + "\"><img src=\"/images/BacoError.gif\" align=absmiddle></span>";
			oCell = oRow.insertCell();

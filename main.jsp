	...
	<tr>
		...
		<td width="185" style="background-repeat: no-repeat;background-image: url('<%=templateLogoBottom%>')">
			...
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/LogOut.gif" onclick="javascript:toolBarLogOut()" title="<%=SystemEnv.getHtmlLabelName(1205,user.getLanguage())%>"></td></tr></table><!--退出-->
			</td>
			<td width=10 align="center">
				<img src="/images_face/ecologyFace_1/VLine_1.gif" border=0>
			</td>
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Back.gif" onclick="javascript:toolBarBack()" title="<%=SystemEnv.getHtmlLabelName(15122,user.getLanguage())%>"></td></tr></table><!--后退-->
			</td>
			<td style="width:23px;height:28px;" align="center" valign="middle">
			...
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Refur.gif" onclick="javascript:toolBarRefresh()" title="<%=SystemEnv.getHtmlLabelName(354,user.getLanguage())%>"></td></tr></table><!--刷新-->
			</td>
			<!-- <td style="width:23px;height:28px;" align="center" valign="middle">
			...
			<td style="width:23px;height:28px;" align="center" valign="middle">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Print.gif" onclick="javascript:toolBarPrint()" title="<%=SystemEnv.getHtmlLabelName(257,user.getLanguage())%>"></td></tr></table><!--打印-->
			</td>
...
<!--add by fanggsh 20081203 for TD9286 end-->
		...
		<table height=100% border="0" cellspacing="0" cellpadding="0">
			<tr>
			<td width=23 align="center">
				<table class="toolbarMenu"><tr><td onmouseover="this.className='toolbarMenuOver';" onmouseout="this.className='toolbarMenuOut';"><img src="/images_face/ecologyFace_1/toolBarIcon/Home.gif" onclick="javascript:goUrl('/homepage/HomepageRedirect.jsp')" title="<%=SystemEnv.getHtmlLabelName(1500,user.getLanguage())%>"></td></tr></table><!--首页-->
			</td>
            ...
            <td style="width:100;height:28px;display:none" align="left" valign="middle" id="templateSelect" >
				<select id="templateSelect" name="templateSelect" onchange="templatechange(this);" >
				 <option  value=/main.jsp align="center" selected>-界面切换-</option>
				 <%
				   while(rsExtend.next()){
				...
				<TABLE cellpadding="0" cellspacing="0" align="center" style="margin:0;" width="100%" style="background:url(/wui/theme/ecologyBasic/page/images/warmPrompt/warmPromptCenter.png) repeat-y;"">
					...
					<tr>
						<td colspan="2" style="padding-left:10px;padding-right:5px;color:#0b5367;">
							<span>
								<b>温馨提示</b>：如果您不习惯使用此主题，可以点击这里切换到其他主题哦！ 
								<span style="display:block;overflow:hidden;height:5px;"></span>
								<span style="display:block;float:left;">
								<input type="checkbox" name="warmPrompt" value="1"><span style="color:#2295aa;">下次不再提示</span>
								</span>	

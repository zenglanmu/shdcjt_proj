...
<FORM name=frmain action=HrmCareerInviteOperation.jsp? method=post>
  <DIV><BUTTON class=btnSave accessKey=S onclick='location.href="/pweb/careerapply/HrmCareerApplyAdd.jsp?careerid=<%=careerinviteid%>"'><U>S</U>-<%=SystemEnv.getHtmlLabelName(1863,7)%></BUTTON> 
<BUTTON class=btn  accessKey=R onclick='location.href="/pweb/careerapply/HrmCareerInviteWeb.jsp?"'><U>R</U>-<%=SystemEnv.getHtmlLabelName(1290,7)%></BUTTON>
</DIV>

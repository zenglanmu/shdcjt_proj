...
<DIV>
<BUTTON class=btn id=Edit accessKey=E onclick="location='HrmCareerApplyEditDo.jsp?applyid=<%=applyid%>'"><U>E</U>-编辑</BUTTON>
<BUTTON class=btn id=Delete accessKey=P onclick="location='HrmCareerApplyPerView.jsp?id=<%=applyid%>'"><U>P</U>-个人信息</BUTTON>
<BUTTON class=btn id=Delete accessKey=W onclick="location='HrmCareerApplyWorkView.jsp?id=<%=applyid%>'"><U>W</U>-工作信息</BUTTON>
</DIV>

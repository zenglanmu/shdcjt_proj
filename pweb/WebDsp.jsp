...
<%                       
				  ...
				  <table class=form valign=top>
					<tr>
						...
						<td>&nbsp <img alt="Search" src="/images_frame/search_dot.gif" border="0" onClick="form1.submit()" style="CURSOR:HAND"></td>
					</tr>
				  </table>
				  <!--搜索框:end-->
				<!--  //标题新闻显示开始 -->
			  ...
			  <td align=center>
					...
					%>
					<img border="0" src="/images/b0.gif" onClick="location='/pweb/WebDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart-titlesperpage%>'" style="CURSOR:HAND"><img border="0" src="/images/g0.gif"  onclick="location='/pweb/WebDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart+titlesperpage%>'" style="CURSOR:HAND">
					<%}
					else if(hstart>=titlesperpage && (hstart + titlesperpage) >= totalnews){
					%>
					<img border="0" src="/images/b0.gif" onClick="location='/pweb/WebDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart-titlesperpage%>'" style="CURSOR:HAND"><img border="0" src="/images/g1.gif">
					<%}
					else if(hstart==1 && (hstart + titlesperpage) < totalnews){
					%>
					<img border="0" src="/images/b1.gif"><img border="0" src="/images/g0.gif"  onclick="location='/pweb/WebDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart+titlesperpage%>'" style="CURSOR:HAND">
					<%}%>
			  </td>

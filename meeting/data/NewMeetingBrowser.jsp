...
%>
    ...
    <%if(isset==0){%>
      ...
      _url="/systeminfo/BrowserMain.jsp?url=/meeting/data/CallerBrowser.jsp?sqlwhere=<%=whereclause%>"
  ...
  <TR>
    ...
    <%}%>
        ...
        <TR>
          ...
          _url="/systeminfo/BrowserMain.jsp?url=/hrm/resource/ResourceBrowser.jsp?sqlwhere=<%=whereclause%>"
          _displayTemplate="<A href='/hrm/resource/HrmResource.jsp?id=#b{id}'>#b{name}</A>"></TD>
        </TR>
        <TR style="height:1px"><TD class=Line colSpan=6></TD></TR> 
		<%if(isgoveproj==0){%>
	  ...
	  <TABLE class=viewForm>
        ...
        <TR>
          ...
          <TD class=Field> <BUTTON class=Calendar type=button onclick="onShowDate(BeginDatespan,begindate)"></BUTTON> 
          	<SPAN id=BeginDatespan ><%if (null == startdate || startdate.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%><%=startdate%></SPAN>
        ...
        <TR>
          ...
          <TD class=Field><button class=Clock type=button onclick="onshowMeetingTime(BeginTimespan,begintime)"></button>
          	<span id="BeginTimespan"><%if (null == starttime || starttime.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%><%=starttime%></span>
		...
		<TR>
          ...
          <TD class=Field> <BUTTON class=Calendar type=button onclick="onShowDate(EndDatespan,enddate)"></BUTTON> 
          	<SPAN id=EndDatespan><%if (null == enddate || enddate.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%><%=enddate%></SPAN>
        ...
        <TR>
          ...
          <TD class=Field><button class=Clock type=button onclick="onshowMeetingTime(EndTimespan,endtime)"></button>
          	<span id="EndTimespan"><%if (null == endtime || endtime.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%><%=endtime%></span>
		...
		<TR>
			...
			<TD class=Field>
				...
				<span id="customizeAddressspan"><%if(roomid==null||"".equals(roomid)){ %><img src="/images/BacoError.gif" align=absmiddle><%} %></span>
			</TD>
		</TR>
        <TR style="height:1px"><TD class=Line colSpan=6></TD></TR> 
...
function countAttend()
{
	...
	if(hascheckhrm==true || hascheckcrm==true || ($G("hrmids02").value!="" && $G("hrmids02").value.length>0) || ($G("crmids02").value!="" && $G("crmids02").value.length>0)){
		...
		$G("hrmids02Span").innerHTML = "<IMG src='/images/BacoError.gif' align=absMiddle>";
	}
	...
	if(count<1)
		$G("totalmemberspan").innerHTML = "<IMG src='/images/BacoError.gif' align=absMiddle>";
	else

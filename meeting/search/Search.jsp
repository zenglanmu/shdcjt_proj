...
<TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
		<TR>
          ...
          <TD class=Field>
			...
			%>
						<A href='/hrm/resource/HrmResource.jsp?id=<%=""+arraycallers.get(i)%>'><%=ResourceComInfo.getResourcename(""+arraycallers.get(i))%></a>&nbsp
			<%}}%>				
			</span> 
		  </TD>
        </TR>
<TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
		<TR>
          ...
          <TD class=Field>
			...
			%>
						<A href='/hrm/resource/HrmResource.jsp?id=<%=""+arraycontacters.get(i)%>'><%=ResourceComInfo.getResourcename(""+arraycontacters.get(i))%></a>&nbsp
			<%}}%>			
			</span> 
		  </TD>
        </TR>
<TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
		<TR>
          ...
          <TD class=Field>
			...
			%>
						<A href='/hrm/resource/HrmResource.jsp?id=<%=""+arraycreaters.get(i)%>'><%=ResourceComInfo.getResourcename(""+arraycreaters.get(i))%></a>&nbsp
			<%}}%>				
			</span> 
		  </TD>
        </TR>
...
<TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
		...
		<TR>
          ...
          <TD class=Field>
			...
			_displayTemplate="<a href='/CRM/data/ViewCustomer.jsp?#b{id}'>#b{name}</a>&nbsp;">
			<span id="crmidsspan">
			<%if(!MeetingSearchComInfo.gethrmids().equals("")){
...
<span id=projectidspan><A href='/proj/data/ViewProject.jsp?ProjID=<%=MeetingSearchComInfo.getprojectid()%>'>          <%=Util.toScreen(ProjectInfoComInfo.getProjectInfoname(MeetingSearchComInfo.getprojectid()),user.getLanguage())%>
        	 ...
        	 _displayTemplate="<A href='/proj/data/ViewProject.jsp?#b{id}'>#b{name}</A>">  
		  </TD>
        </TR>
        <TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
		<%}%>

...
if(detachable==0){
    response.sendRedirect("MeetingType_left.jsp");
    return;
}
%>
<HTML><HEAD>
...
<IFRAME name=contentframe id=contentframe src="MeetingType_left.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
  </TBODY>

...
String titlename = Util.toScreen("召集人",user.getLanguage(),"0") ;
String needfav ="1";
String needhelp ="";
...
<BUTTON type=button  class=Browser style="display:none" onclick="onShowRole('showrelatedsharename','relatedshareid')" name=showrole></BUTTON>
 ...
 <span id=showrelatedsharename name=showrelatedsharename ><%if(!DepartmentComInfo.getDepartmentname(""+user.getUserDepartment()).equals("")){%><%=Util.toScreen(DepartmentComInfo.getDepartmentname(""+user.getUserDepartment()),user.getLanguage())%><%}else{%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>

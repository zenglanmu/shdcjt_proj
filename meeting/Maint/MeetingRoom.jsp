...
if(detachable==0){
    response.sendRedirect("MeetingRoom_left.jsp");
    return;
}
%>
<HTML><HEAD>
...
<IFRAME name=leftframe id=leftframe src="MeetingRoom_left2.jsp?rightStr=MeetingRoomAdd:Add" width="100%" height="100%" frameborder=no scrolling=no >
...
<IFRAME name=contentframe id=contentframe src="MeetingRoom_left.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
  </TBODY>

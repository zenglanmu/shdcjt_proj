...
<TABLE class=Viewform>
  ...
  <TR class=Spacing style="height:1px;">
          ...
          <TD class=Field>
              <input name=name class=inputstyle style="width=60%" onchange='checkinput("name","nameimage")'><SPAN id=nameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
		  </TD>
        </TR>
         <TR style="height:1px;"><TD class=Line colSpan=2></TD></TR> 
          ...
          <TD class=Field>
              ...
              <SPAN id=hrmidspan><IMG src='/images/BacoError.gif' align=absMiddle></SPAN> 
         ...
         <TR style="height:1px;"><TD class=Line colSpan=2></TD></TR> 
          ...
          <TD class=Field>
              <input name=desc maxlength="255" onblur="checkLength()" class=inputstyle style="width=60%" onchange='checkinput("desc","descimage")'><SPAN id=descimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> <%=SystemEnv.getHtmlLabelName(2158,user.getLanguage())%>
		  </TD>
        </TR>
    <TR style="height:1px;"><TD class=Line colSpan=2></TD></TR> 
  </TBODY>

...
%>
<div align ='right'>
	    <a id="searchAdviceHref"  href="#" onClick="showSearchAdvice('advicedSearchDiv')"><img name="searchAdviceImg" src="/images/down.png" align=absMiddle><%=SystemEnv.getHtmlLabelName(21995,user.getLanguage())%></a></div>
...
<script type="text/javascript" src="/js/doc/DocSearchView.js"></script>

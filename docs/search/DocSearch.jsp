...
<form name="frmmain" method="post" action="DocSearch.jsp">
...
if(HrmUserVarify.checkUserRight("DocFileBatchDownLoad:ALL", user)){
if(userightmenu_self==1||true){
	RCMenu += "{"+SystemEnv.getHtmlLabelName(27105,user.getLanguage())+",javascript:bacthDownloadImageFile(),_top}} " ;
	RCMenuHeight += RCMenuHeightStep ;
}else{
...
if(displayUsage==1||true){
	...
	<script language='javascript' type='text/javascript' src='/js/xmlextras.js'></script>
	<script language='javascript' type='text/javascript' src='/js/weaverTable.js'></script>
...
<script type="text/javascript">
    ...
    function showSearchAdvice(obj){
        ...
        if(jQuery("#advicedSearchDiv").is(":hidden")){
           ...
           jQuery("#searchAdviceImg").attr("src","/images/up.png");
        }else{
           jQuery("#advicedSearchDiv").hide();
           jQuery("#searchAdviceImg").attr("src","/images/down.png");
        }
    }
...
<script type='text/javascript' src='/js/doc/ComboBoxExt.js'></script>
<script type='text/javascript' src='/js/doc/DocSearch.js'></script>
<script type="text/javascript">
</script>

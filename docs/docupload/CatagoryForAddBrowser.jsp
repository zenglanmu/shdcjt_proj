...
<HTML>
  ...
  <div align="center">
	...
	&nbsp;
	<BUTTON type="button" class=btn accessKey=R onclick="onClear()"><U>R</U>-<%=SystemEnv.getHtmlLabelName(311,user.getLanguage())%></BUTTON><!--清除-->
  </div>
 </BODY>
 </HTML>
			 ...
			 Ext.BLANK_IMAGE_URL = '/js/extjs/resources/images/default/s.gif';
			  ...
			  // Define Tree.
				var Tree_Category_Loader = new Ext.tree.TreeLoader({
					...
					dataUrl   :"TreeData.jsp"
				});
				//lable 21409:具有创建权限的目录
				var Tree_Category = new Ext.tree.TreePanel({
					title            : '<%=SystemEnv.getHtmlLabelName(21409,user.getLanguage())%>', 
					collapsible      : false,
					animCollapse     : false,
					border           : true,
				...
				var Tree_Category_Root = new Ext.tree.AsyncTreeNode({
					text		: '<%=SystemEnv.getHtmlLabelName(1478,user.getLanguage())%>',

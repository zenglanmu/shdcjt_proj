...
.cycleTD{background-image:url(/images/tab2.png);cursor:pointer;text-align:center;border-bottom:1px solid #879293;}
.cycleTDCurrent{padding-top:2px;background-image:url(/images/tab.active2.png);cursor:pointer;text-align:center;}
...
<input type="hidden" name="id" value="<%=id%>">
	...
	<tr align=left height="22">
		<td class="cycleTDCurrent" name="oTDtype_0"  id="oTDtype_0" background="/images/tab.active2.png" width=79px  align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(0)" ><%=SystemEnv.getHtmlLabelName(1361,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_1" id="oTDtype_1" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(1)" ><%=SystemEnv.getHtmlLabelName(19174,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_2" id="oTDtype_2" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(2)" ><%=SystemEnv.getHtmlLabelName(19450,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_3" id="oTDtype_3" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(3)" ><%=SystemEnv.getHtmlLabelName(19381,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_4" id="oTDtype_4" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(4)" ><%=SystemEnv.getHtmlLabelName(16448,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_5" id="oTDtype_5" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(5)" ><%=SystemEnv.getHtmlLabelName(19451,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_6" id="oTDtype_6" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(6)" ><%=SystemEnv.getHtmlLabelName(15057,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_7" id="oTDtype_7" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='pointer'" onclick="resetbanner(7)" ><%=SystemEnv.getHtmlLabelName(20237,user.getLanguage())%></td>
...
function resetbanner(objid){
	...
	//jQuery("#oTDtype_"+objid).css("background","/images/tab.active2.png");

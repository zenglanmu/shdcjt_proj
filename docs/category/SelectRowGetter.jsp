...
function putRow(){
    ...
    if(isAdd){
	    jQuery(obj).parent().parent()[0].cells[3].innerHTML=selectitembuffer.innerHTML;
	    jQuery(obj).parent().parent()[0].cells[0].innerHTML=selectidbuffer.innerHTML;
    }else{
        alert("不能导入相同的选择框！");
    }
...
标签:<input  class=InputStyle name="fieldlable"><input  type="hidden" name="fieldid" value="">
</div>

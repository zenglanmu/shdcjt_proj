...
%>
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(83,user.getLanguage())+",javascript:location='/systeminfo/SysMaintenanceLog.jsp?secid=66&sqlwhere=where operateitem=4 and relatedid="+id+"',_top} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
<BUTTON type='button' class=BtnLog id=button2 accessKey=L name=button2 onclick="location='/systeminfo/SysMaintenanceLog.jsp?secid=66&sqlwhere=where operateitem=4 and relatedid=<%=id%>'"><U>L</U>-<%=SystemEnv.getHtmlLabelName(83,user.getLanguage())%></BUTTON> </DIV>
<%
}
%>
 </DIV>
...
<TR><TD class=Line colSpan=4></TD></TR>
    <TR> 
      ...
      <TD class=Field width="55%" height=19> 
        ...
        <span id=typenamespan><%if(typename.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span></td>

...
<TABLE class=ViewForm width=65%>
  ...
  <TR class=Title>
    ...
    <TD width="5%"><B><IMG src="/images/BacoCheck.gif"></B></TD>
    <TD width="15%"><%=SystemEnv.getHtmlLabelName(168,user.getLanguage())%></TD>
    <TD width="5%"><b><img src="/images/guide.gif" width="13" height="13"></b></TD>
    <TD width="15%"><%=SystemEnv.getHtmlLabelName(166,user.getLanguage())%></TD>
    <TD width="5%"><B><IMG src="/images/BacoCross.gif"></B></TD>
...
<TABLE class=ListStyle>
  ...
  <TR class=DataLight>
    ...
    <TD align=middle><%if(hasitems.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else if(hasitems.equals("1")){%> <img src="/images/guide.gif" width="13" height="13">
					<%} else {%><IMG src="/images/BacoCheck.gif"> <%}%>
	</TD>
	<TD align=middle><%if(hasitemmaincategory.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else if(hasitemmaincategory.equals("1")){%> <img src="/images/guide.gif" width="13" height="13">
					<%} else {%><IMG src="/images/BacoCheck.gif"> <%}%>
	</TD>
	<TD align=middle><%if(hashrmres.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else if(hashrmres.equals("1")){%> <img src="/images/guide.gif" width="13" height="13">
					<%} else {%><IMG src="/images/BacoCheck.gif"> <%}%>
	</TD>
	<TD align=middle><%if(hascrm.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else if(hascrm.equals("1")){%> <img src="/images/guide.gif" width="13" height="13">
					<%} else {%><IMG src="/images/BacoCheck.gif"> <%}%>
	</TD>
	<TD align=middle><%if(hasproject.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else if(hasproject.equals("1")){%> <img src="/images/guide.gif" width="13" height="13">
					<%} else {%><IMG src="/images/BacoCheck.gif"> <%}%>
	</TD>
	<TD align=middle><%if(hasfinance.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else if(hasfinance.equals("1")){%> <img src="/images/guide.gif" width="13" height="13">
					<%} else {%><IMG src="/images/BacoCheck.gif"> <%}%>
	</TD>
	<TD align=middle><%if(hasaccessory.equals("0")){%><IMG src="/images/BacoCross.gif">
					<%} else {%> <img src="/images/guide.gif" width="13" height="13"> <%}%>
	</TD></tr>

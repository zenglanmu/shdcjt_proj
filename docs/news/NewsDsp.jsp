...
<script LANGUAGE="JavaScript" SRC="/js/checkinput.js">
</script>
                                ...
                                %>
                                  <td width=50%  valign=top>
                                        <table valign=top width=97%>
                                          <tr>
                                            <td colspan=2  valign=top> <li><a href="/docs/docs/DocDsp.jsp?id=<%=tempdocids[i]%>"><%=importdocsubject%></a>&nbsp;&nbsp;[要闻]
                                            </td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            %>
                                              <td width=40%> <a href="/docs/docs/DocDsp.jsp?id=<%=tempdocids[i]%>">
                                            ...
                                            %>
                                            <td width=40% valign=top> <a href="/docs/docs/DocDsp.jsp?id=<%=tempdocids[i]%>">
                                            ...
                                            %>
                                            <td valign=top><%=importdoccreatedate%>&nbsp; <%=disptmp%><a href="/docs/docs/DocDsp.jsp?id=<%=tempdocids[i]%>">&nbsp<%=SystemEnv.getHtmlLabelName(361,user.getLanguage())%></a>
                                            </td>
                                        </table>
                                  </td>
<%                              if (needtr%2==0){
...
<%                        }                               
                    ...
                    <%}%>
					  <td width=50% valign=top>
						<table valign=top width=97%>
						  <tr>
							<td colspan=2  valign=top> <li><a href="/docs/docs/DocDsp.jsp?id=<%=docid%>"><%=docsubject%></a>
							</td>
						  </tr>
						  <tr class=Spacing style="height: 1px!important;">
							<td class=Line1 colspan=2></td>
						  ...
						  <tr>
							...
							%>
							<td width=40% valign=top> <a href="/docs/docs/DocDsp.jsp?id=<%=docid%>">
							  <img border=0 <%if(showimgwidth>-1){%>width="<%=showimgwidth%>"<%}%> src="/weaver/weaver.file.FileDownload?fileid=<%=tmppicid%>">
							  </a> </td>
								<%
								}
							...
							%>
							<td  valign=top><%=doccreatedate%>&nbsp;<%=disptmp%>&nbsp<a href="/docs/docs/DocDsp.jsp?id=<%=docid%>"><%=SystemEnv.getHtmlLabelName(361,user.getLanguage())%></a>
							</td>
						</table>
					  </td>
					  <%
	...
	-->
			<tr><td>&nbsp;</td></tr>
			   ...
			   <%
				...
				newslistclause1 = newslistclause1 + " and docpublishtype='3' and docstatus in('1','2') ";
...
String docsubject=DocManager.getDocsubject();
				 ...
				 <tr>
				 <td>
				 <li><a href="/docs/docs/DocDsp.jsp?id=<%=docid%>"><%=docsubject%></a>
				 </td></tr>
			  ...
			  <td align=center>
				...
				%>
				<img border="0" src="/images/b0.gif" onclick="location='/docs/news/NewsDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart-titlesperpage%>'" style="CURSOR:HAND"><img border="0" src="/images/g0.gif"  onclick="location='/docs/news/NewsDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart+titlesperpage%>'" style="CURSOR:HAND">
				<%}
				else if(hstart>=titlesperpage && (hstart + titlesperpage) >= totalnews){
				%>
				<img border="0" src="/images/b0.gif" onclick="location='/docs/news/NewsDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart-titlesperpage%>'" style="CURSOR:HAND"><img border="0" src="/images/g1.gif">
				<%}
				else if(hstart==1 && (hstart + titlesperpage) < totalnews){
				%>
				<img border="0" src="/images/b1.gif"><img border="0" src="/images/g0.gif"  onclick="location='/docs/news/NewsDsp.jsp?id=<%=id%>&start=<%=start%>&hstart=<%=hstart+titlesperpage%>'" style="CURSOR:HAND">
				<%}%>

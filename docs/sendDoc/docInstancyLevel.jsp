...
<%
RecordSet.executeSql("select * from DocInstancyLevel order by id desc");
...
<%		}%>
			...
			<td><a href="docInstancyLevel.jsp?id=<%=RecordSet.getString("id")%>"><%=RecordSet.getString("name")%></a></td>

...
<td valign="top">
    ...
    <tr>
      ...
      <%}%>
      <span id=path name=path><%=path.equals("")?"<IMG src='/images/BacoError.gif' align=absMiddle>":"<a href=/docs/category/DocSecCategoryEdit.jsp?id="+secid+">"+path+"</a>"%></span>
    ...
    <%}%>
    <span id=createrIdSpan><%if(createrId.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}else{%><%=ResourceComInfo.getResourcename(createrId)%><%}%></span>

...
<tr>
<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="docInstancyLevelBrowser.jsp" method=post>
...
<TD width=35% class=field><input class=inputstyle name=desc value="<%=desc%>"></TD>
</TR>
...
sqlwhere = "select * from DocInstancyLevel "+sqlwhere + "order by name";
//end

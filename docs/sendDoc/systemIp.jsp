...
<TABLE class=Viewform>
  ...
  <TR class=Spacing>
          ...
          <TD class=Field>
              <input name=name class=inputstyle style="width=60%" value="<%=name%>" onchange='checkinput("name","nameimage")'><SPAN id=nameimage><%if(name.equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN>
		  </TD>
        </TR>
        <TR><TD class=Line colSpan=2></TD></TR>
          ...
          <TD class=Field>
              <input class=inputstyle name=ip  style="width=60%" value="<%if(!ip.equals("")){%><%=ip%><%}%>" onchange='checkinput("ip","ipimage")'><SPAN id=ipimage><%if(ip.equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN>
		  </TD>
        </TR>
       <TR><TD class=Line colSpan=2></TD></TR>
  </TBODY>

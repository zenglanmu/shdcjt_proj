...
<%
RecordSet.executeSql("select * from DocSendDocKind order by id desc");
...
<%		}%>
			...
			<td><a href="docKind.jsp?id=<%=RecordSet.getString("id")%>"><%=Util.forHtml(Util.null2String(RecordSet.getString("name")).replaceAll("'","\\'"))%></a></td>

                      ...
                      <TABLE class=ViewForm>
                        ...
                        <TR>
                          ...
                          <select name=docNumber_1 size=1 style="width:125" onChange='checkinput("docNumber_1","docNumber_1Span")'>
						    ...
						    <%}%>
                          </select><SPAN id=docNumber_1Span ><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>&nbsp;[<input name=docNumberYear_1 class=inputstyle size=4 onchange='checkinput("docNumberYear_1","docNumberYear_1Span")'><SPAN id=docNumberYear_1Span ><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>]&nbsp;<%=SystemEnv.getHtmlLabelName(15323,user.getLanguage())%><input name=docNumberIssue_1 class=inputstyle size=4 onchange='checkinput("docNumberIssue_1","docNumberIssue_1Span")'><SPAN id=docNumberIssue_1Span ><IMG src="/images/BacoError.gif" align=absMiddle></SPAN><%=SystemEnv.getHtmlLabelName(16992,user.getLanguage())%>
                          <%}else{%>
                      ...
                      <TD class=Field colSpan=3>
                       ...
                       <%
                        ...
                        for(int i=0;i<docIdsList.size();i++)
                        {
                            ...
                            <span id="secSpan_<%=i%>" name="secSpan_<%=i%>"><IMG src="/images/BacoError.gif" align=absMiddle></span>
                            <%}%>
                            </td>
                            </TR>
                        <%

...
<script type="text/javascript">
 ...
 function getDocDetailLogPane(docid,width,height,hasTitle){
	  ...
	  var colsTableBaseParas=[
							...
							{"para_1":"column:operatetype","para_2":"7","para_3":"","hideable":true,"sortable":true,"width":0.1,"dataIndex":"operatetype","header":"<%=SystemEnv.getHtmlLabelName(63,user.getLanguage())%>","linkkey":"","linkvaluecolumn":"","column":"operatetype","target":"","transmethod":"weaver.docs.DocDetailLogTransMethod.getDocStatus","href":""},

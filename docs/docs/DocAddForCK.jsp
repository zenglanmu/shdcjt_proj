...
<div id="divContentTab" style="display:none;width:100%;">
	...
	<div id="divDocTile" style="width:100%; position: relative;" >
		<DIV style="WIDTH: 100%; MozUserSelect: none; KhtmlUserSelect: none" class="x-tab-panel-header " unselectable="on">
		...
		<div class=x-tab-strip-inner><div class="x-tab-strip-text " style="padding-top:3px;">
				...
				<tr>
					...
					<td>
						...
						<%if(!isPersonalDoc){%>
							...
							onMouseDown="docSubjectMouseDown"
			...
			<script type="text/javascript">
				...
				<%}%>
				function docSubjectMouseDown(e){
					e = (e)?e:window.event;
					obj = event.srcElement ? e.srcElement : e.target;
...
<div id="divPropTab" style="display:none;width: 100%">
	...
	<div id="divPropTile" style="width:100%;">
		<DIV style="MozUserSelect: none; KhtmlUserSelect: none" class="x-panel-header " unselectable="on">
...
function adjustContentHeight(type){
	...
	try{
		...
		var divContentHeight=pageHeight-propTabHeight-62;
		var divContentWidth=pageWidth;
		//alert(divContentHeight)
		if(type=="load"){
			...
			CkeditorExt.initEditor('weaver','doccontent','<%=user.getLanguage()%>','',divContentHeight-30)
			//jQuery("#cke_contents_"+"doccontent").css("height",divContentHeight-50);
			//jQuery("#cke_path_"+"doccontent").hide();
			//alert(2)
			//CKEDITOR.config.height = divContentHeight-60;	
		} else {			
			if(divContentHeight!=null && divContentHeight>0) {
				//alert(3)
				
				//FCKEditorExt.resize(divContentWidth,divContentHeight);		
				//CKEDITOR.config.height = divContentHeight;	
				//CKEDITOR.config.Width = divContentWidth;

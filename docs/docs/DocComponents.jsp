...
function loadExt() {
	if(!isLoadExt){
		...
		//loadFile("/js/extjs/adapter/ext/ext-base.js","js");

		//loadFile("/js/extjs/ext-all.js","js");

		loadFile("/js/TabCloseMenu.js","js");
		
		<%if(language==7) {%>
		loadFile("/js/extjs/build/locale/ext-lang-zh_CN_gbk.js","js");
		<%} else if(language==8) {%>
		loadFile("/js/extjs/build/locale/ext-lang-en.js","js");
		<%} else if(language==9) {%>
		loadFile("/js/extjs/build/locale/ext-lang-zh_TW.js","js");
		<%}%>

		loadFile("/js/ColumnNodeUI.js","js");

		//loadFile("/js/extjs/build/ux/miframe.js","js");

		loadFile("/js/Cookies.js","js");
		
		ExtonReady();
		
		loadFile("/js/doc/DocCommonExt.js","js");
...
function finalDo(mode){
	...
	//alert("params : "+params);
	divFavorite.innerHTML="<img src='/images/btnFavorite.gif' style='cursor:hand' onclick=\"openFavouriteBrowser();\" title="+wmsg.base.addToFavorite+">" +
			"&nbsp;<img src='/images/help2.gif'  style='cursor:hand' onclick='showHelp()' title="+wmsg.base.help+">"; 
...
function openFavouriteBrowser(){
	...
	window.showModalDialog('/favourite/FavouriteBrowser.jsp?fav_pagename='+favpagename+'&fav_uri='+favuri+'&fav_querystring='+favquerystring);
}
...
function resizedivAcc(){
	...
	Ext.getCmp("DocImgs").setHeight(195);
...
%>
	<script type="text/javascript" src="/js/doc/DocRelationable.js"></script>

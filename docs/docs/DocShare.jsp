                               ...
                               <TABLE CLASS=VIEWFORM CELLSPACING="1" >                                                              
                                ...
                                <TABLE CLASS=VIEWFORM CELLSPACING="1" >                                                              
                                     <TR>
                                        ...
                                        <TD width="30%">
                                            <div align="right">                                                
                                                <img src="\images\up.jpg" style="cursor:hand" onclick="onHiddenImgClick(divShareSetting,this)" title="<%=SystemEnv.getHtmlLabelName(16636,user.getLanguage())%>" objStatus="show">
                                            </div>
                                        </TD>
                                    </TR>
                             ...
                             <br>
                              <TABLE CLASS=VIEWFORM CELLSPACING="1" >                                                              
                                     <TR>
                                        ...
                                        <TD width="30%">
                                            <div align="right">                                              
                                                <img src="\images\up.jpg" style="cursor:hand" onclick="onHiddenImgClick(divShareSettingNoMR,this)" title="<%=SystemEnv.getHtmlLabelName(16636,user.getLanguage())%>" objStatus="show">
                                            </div>
                                        </TD>
                                    </TR>
                                    <TR><TD CLASS=LINE1 COLSPAN=5></TD></TR>

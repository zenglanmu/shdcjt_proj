...
<DIV class=HdrProps>
    ...
    <a href="PersonalDocRight.jsp?userCategory=0"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=SystemEnv.getHtmlLabelName(18476,user.getLanguage())%></a>
    <%
    ...
    while(tmppos != -1){
        ...
        if(!tmpstr.equals("0")){
    %>
    >&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=tmpstr%>"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=DocUserSelfUtil.getCatalogName(tmpstr)%></a>
...
if(userCategory>0){
    %>
    >&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=userCategory%>"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=DocUserSelfUtil.getCatalogName(""+userCategory)%></a>
    <%}if(userCategory < 0 ){
        
    %>
    >&nbsp<a href="PersonalDocRight.jsp?userCategory=-1"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=SystemEnv.getHtmlLabelName(18472,user.getLanguage())%></a>
    <%
    if(userCategory != -1 ){
    %>
    >&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=userCategory%>"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=ResourceComInfo.getResourcename(""+((-1)*userCategory))%></a>
    <%}
        ...
        while(tmppos != -1){
            ...
            if(!tmpstr.equals("0")){
    %>
    >&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=userCategory%>&shareparentid=<%=tmpstr%>"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=DocUserSelfUtil.getCatalogName(tmpstr)%></a>
    ...
    <%}
        ...
        if(shareparentid!=0){
    %>
    >&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=userCategory%>&shareparentid=<%=shareparentid%>"><img src="images/folder0.gif" width="18" height="18" align="absmiddle" border=0><%=DocUserSelfUtil.getCatalogName(""+shareparentid)%></a>
    <%}	
    }%>
</DIV>
...
<TABLE class=ListShort>
 ...
 <tr <%if(islight){%> class=datalight <%} else {%> class=datadark <%}%>>
     ...
     <td><img src="images/folder1.gif" width="18" height="18" align="absmiddle" border=0>&nbsp<a href="PersonalDocRight.jsp?userCategory=-1"><%=SystemEnv.getHtmlLabelName(18472,user.getLanguage())%></a></td>
     <td></td>
     <td></td>
 </tr>
<% islight=!islight;
  ...
  if(userCategory>=0){
	...
	%>
	 <tr <%if(islight){%> class=datalight <%} else {%> class=datadark <%}%>>
             ...
             <td><img <%if(sharefolders.indexOf(RecordSet.getString("id"))!=-1){%> src="images/folder2.gif" <%}else{%>src="images/folder1.gif" <%}%> width="18" height="18" align="absmiddle" border=0>&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=RecordSet.getString("id")%>"><%=RecordSet.getString("name")%></a></td>
             <td><%=RecordSet.getString("createdate")%>&nbsp<%=RecordSet.getString("createtime")%></td>

             <td align="left">
             <img src="images/ff_rename.gif" border=0  alt="<%=SystemEnv.getHtmlLabelName(18477,user.getLanguage())%>" onmouseover="this.style.cursor='hand';" onclick="window.location='PersonalDocRename.jsp?userCategory=<%=RecordSet.getString("id")%>&operation=folderRename'">	 
             <img src="images/ff_share2.gif" border=0 alt="<%=SystemEnv.getHtmlLabelName(119,user.getLanguage())%>" onmouseover="this.style.cursor='hand';"  onclick="window.location='PersonalDocShare.jsp?userCategory=<%=RecordSet.getString("id")%>'">
             </td>
	 </tr>
	<%
        islight=!islight;
        ...
        while(RecordSet.next()){
            String imgfilename = "ebdef.gif";
            int tmptype = RecordSet.getInt("doctype");
            if(tmptype ==1 )
                imgfilename = "ebhtml.gif";
            if(tmptype ==2 )
                imgfilename = "word.gif";//word
            if(tmptype ==3 )
                imgfilename = "excel.gif";
            if(tmptype ==4 )
                imgfilename = "ppt.gif";
	...
	%>
	 <tr <%if(islight){%> class=datalight <%} else {%> class=datadark <%}%>>
             ...
             <td align="left">
                 <img src="images/ff_rename.gif" border=0 alt="<%=SystemEnv.getHtmlLabelName(18477,user.getLanguage())%>" border=0 onmouseover="this.style.cursor='hand';" onclick="window.location='PersonalDocRename.jsp?docId=<%=RecordSet.getString("id")%>&userCategory=<%=userCategory%>&operation=docRename'">
                 <img src="images/ff_share2.gif" border=0 alt="<%=SystemEnv.getHtmlLabelName(119,user.getLanguage())%>" onmouseover="this.style.cursor='hand';"  onclick="window.location='PersonalDocShare.jsp?docId=<%=RecordSet.getString("id")%>'">
                 <img src="images/ff_move.gif" border=0 alt="<%=SystemEnv.getHtmlLabelName(78,user.getLanguage())%>" onmouseover="this.style.cursor='hand';"  onclick="window.location='PersonalMoveOut.jsp?docId=<%=RecordSet.getString("id")%>&userCategory=<%=userCategory%>'">
             </td>
	 </tr>
	<%
        islight=!islight;
	...
	%>
	 <tr <%if(islight){%> class=datalight <%} else {%> class=datadark <%}%>>
             ...
             <td><img src="images/folder1.gif" width="18" height="18" align="absmiddle" border=0>&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=(-1)*RecordSet.getInt("doccreaterid")%>"><%=ResourceComInfo.getResourcename(""+RecordSet.getString("doccreaterid"))%></a></td>
             <td></td>
             <td></td>
	 </tr>
	<%
	...
	%>	
		<tr <%if(islight){%> class=datalight <%} else {%> class=datadark <%}%>>
                    ...
                    <td><img src="images/folder1.gif" width="18" height="18" align="absmiddle" border=0>&nbsp<a href="PersonalDocRight.jsp?userCategory=<%=userCategory%>&shareparentid=<%=tmpsecid%>"><%=RecordSet.getString("name")%></a></td>
                    <td></td>
                    <td></td>

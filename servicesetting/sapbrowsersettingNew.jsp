	...
	for(var i = 0; i<ncol; i++){
		...
		switch(i){
			...
			case 1:
				...
				sHtml += "<span id='sapfieldname_importparamspan_"+rowindex_inputparam+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				break;
			case 2:
				...
				var sHtml = "<table class='ViewForm'>";
						sHtml += "<tr>";
							sHtml += "<td>";
								...
								sHtml += "<span id='inputstructnamespan_"+rowindex_inputstruct+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
							sHtml += "</td>";
						sHtml += "</tr>";
		...
		switch(j){
			...
			case 1:
				...
				var sHtml = "<%=SystemEnv.getHtmlLabelName(28247,user.getLanguage()) %> <input type='text' class='inputstyle' name='sapfieldname_importstructfield_"+i+"' id='sapfieldname_importstructfield_"+i+"_"+tmpfieldcount+"' onchange=\"checkinput('sapfieldname_importstructfield_"+i+"_"+tmpfieldcount+"','sapfieldname_importstructfieldspan_"+i+"_"+tmpfieldcount+"')\">";
					sHtml += "<span id='sapfieldname_importstructfieldspan_"+i+"_"+tmpfieldcount+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
			break;
			case 2:
	...
	for(var i = 0; i<ncol; i++){
		...
		switch(i){
			...
			case 1:
				...
				sHtml += "<span id='sapfieldname_exportparamspan_"+rowindex_outputparam+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				break;
			case 2:
				...
				sHtml += "<span id='desc_exportparamspan_"+rowindex_outputparam+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				break;
			case 3:
				...
				var sHtml = "<table class='ViewForm'>";
						sHtml += "<tr>";
							sHtml += "<td>";
								...
								sHtml += "<span id='outputstructnamespan_"+rowindex_outputstruct+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
							sHtml += "</td>";
						sHtml += "</tr>";
		...
		switch(j){
			...
			case 1:
				...
				var sHtml = "<%=SystemEnv.getHtmlLabelName(28247,user.getLanguage()) %> <input type='text' class='inputstyle' name='sapfieldname_exportstructfield_"+i+"_"+tmpfieldcount+"' id='sapfieldname_exportstructfield_"+i+"_"+tmpfieldcount+"' onchange=\"checkinput('sapfieldname_exportstructfield_"+i+"_"+tmpfieldcount+"','sapfieldname_exportstructfieldspan_"+i+"_"+tmpfieldcount+"')\">";
					sHtml += "<span id='sapfieldname_exportstructfieldspan_"+i+"_"+tmpfieldcount+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
			break;
			case 2:
				...
				var sHtml = "<%=SystemEnv.getHtmlLabelName(606,user.getLanguage()) %> <input type='text' class='inputstyle' name='desc_exportstructfield_"+i+"_"+tmpfieldcount+"' id='desc_exportstructfield_"+i+"_"+tmpfieldcount+"' onchange=\"checkinput('desc_exportstructfield_"+i+"_"+tmpfieldcount+"','desc_exportstructfieldspan_"+i+"_"+tmpfieldcount+"')\">";
					sHtml += "<span id='desc_exportstructfieldspan_"+i+"_"+tmpfieldcount+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
			break;
			case 3:
				...
				var sHtml = "<table class='ViewForm'>";
						sHtml += "<tr>";
							sHtml += "<td>";
								...
								sHtml += "<span id='outputtablenamespan_"+rowindex_outputtable+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
							sHtml += "</td>";
						sHtml += "</tr>";
		...
		switch(j){
			...
			case 1:
				...
				var sHtml = "<%=SystemEnv.getHtmlLabelName(28247,user.getLanguage()) %> <input type='text' class='inputstyle' name='sapfieldname_exporttablefield_"+i+"_"+tmpfieldcount+"' id='sapfieldname_exporttablefield_"+i+"_"+tmpfieldcount+"' onchange=\"checkinput('sapfieldname_exporttablefield_"+i+"_"+tmpfieldcount+"','sapfieldname_exporttablefieldspan_"+i+"_"+tmpfieldcount+"')\">";
					sHtml += "<span id='sapfieldname_exporttablefieldspan_"+i+"_"+tmpfieldcount+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
			break;
			case 2:
				...
				var sHtml = "<%=SystemEnv.getHtmlLabelName(606,user.getLanguage()) %> <input type='text' class='inputstyle' name='desc_exporttablefield_"+i+"_"+tmpfieldcount+"' id='desc_exporttablefield_"+i+"_"+tmpfieldcount+"' onchange=\"checkinput('desc_exporttablefield_"+i+"_"+tmpfieldcount+"','desc_exporttablefieldspan_"+i+"_"+tmpfieldcount+"')\">";
					sHtml += "<span id='desc_exporttablefieldspan_"+i+"_"+tmpfieldcount+"'><img src='/images/BacoError.gif' align=absmiddle></span>";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
			break;
			case 3:
	...
	for(var i = 0; i<ncol; i++){
		...
		switch(i){
			...
			case 1:
				...
				sHtml += "<span id='oafieldname_assignmentspan_"+rowindex_assignment+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				break;
			case 2:
				...
				sHtml += "<span id='sapfieldname_assignmentspan_"+rowindex_assignment+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
				oDiv.innerHTML = sHtml;
				oCell.appendChild(oDiv);
				break;
		}
...
function onSubmit(obj){
	...
	if(jQuery("img[src$='images/BacoError.gif']").length > 0){
...
function onShowWorkflow(inputename,showname){
	...
	if (id1){
        if (id1.id!="" && id1.id != 0) {
		  ...
		  $G(showname).innerHTML ="<IMG src='/images/BacoError.gif' align=absMiddle>";
          $G(inputename).value="";
       }
    }else{
    	//$G(showname).innerHTML ="<IMG src='/images/BacoError.gif' align=absMiddle>";
...
function changeAuthFlag(obj){
	if(obj.checked){
		...
		jQuery('#wfNamespan').html("<img src='/images/BacoError.gif' align=absmiddle>");
		jQuery('#wfid').val('');
	}else{

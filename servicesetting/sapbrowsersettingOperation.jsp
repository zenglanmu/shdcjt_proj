...
if(operation.equals("save")){
	...
	if(sapfieldname_importparam != null){
		for(int i = 0; i<sapfieldname_importparam.length; i++){
			...
			System.out.println(sapfield + "\t" + oafield + "\t" + constant);
		}
	}
	...
	for(int i = 0; i<inputstructcount; i++){
		...
		System.out.println("inputstructname_" + i + "=" + inputstructname);
	...
	for(int i = 0; i<outputparamcount; i++){
		...
		System.out.println(sapfield + "\t" + desc + "\t" + display);
	}
	...
	for(int i = 0; i<outputstructcount; i++){
		...
		System.out.println("outputstructname_" + i + "=" + outputstructname);
		...
		for(int j = 0; j<outputstructfieldcount; j++){
			...
			structFieldList.add(field);
			System.out.println(sapfield + "\t" + desc + "\t" + display + "\t" + search);
		}
		if(structFieldList.size() == 0){
			continue;
		}
	...
	for(int i = 0; i<outputtablecount; i++){
		...
		System.out.println("outputtablename_" + i + "=" + outputtablename);
		...
		for(int j = 0; j<outputtablefieldcount; j++){
			...
			System.out.println(sapfield + "\t" + desc + "\t" + display + "\t" + search + "\t" + identity);
		}
	...
	if(oafieldname_assignment != null){
		for(int i = 0; i<oafieldname_assignment.length; i++){
			...
			System.out.println(oafield + "\t" + sapfield);
		}
	}
	synchronized(this){
		try{

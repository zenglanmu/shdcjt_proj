...
<script language="javascript">
			...
			for(var i = 0; i<ncol; i++){
				...
				switch(i){
					...
					case 1:
						...
						sHtml += "<span id='sapbrowseridspan_"+rowindex+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
						...
						sHtml += "<span id='sourcespan_"+rowindex+"'><img src='/images/BacoError.gif' align=absmiddle></span>&nbsp;";
		...
		function checkname(obj){
			if(obj.value == ''){
				jQuery('#namespan').html("<img src='/images/BacoError.gif' align=absmiddle>");
			}else{
		...
		function browseridchange(rowindex,obj){
			...
			if(val != ''){
				...
				if(!exists){
					...
					jQuery('#sapbrowseridspan_'+rowindex).html("<img src='/images/BacoError.gif' align=absmiddle>");
		...
		function sourceschange(rowindex,obj){
			...
			if(val != ''){
				...
				jQuery('#sourcespan_'+rowindex).html("<img src='/images/BacoError.gif' align=absmiddle>");
				jQuery('#detailsetspan_'+rowindex).hide();
			}
		}

...
String titlename = "";
if (canedit)
	titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(15104,user.getLanguage());
else
	titlename = SystemEnv.getHtmlLabelName(367,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(15104,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
function doDel(){
	if(isdel()){location.href="/CRM/sellchance/CRMFactorOperation.jsp?method=delete&sign=f&id=<%=id%>"}
}
</script>

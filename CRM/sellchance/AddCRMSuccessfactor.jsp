...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(15103,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top">
<FORM name="weaver" action="/CRM/sellchance/CRMFactorOperation.jsp" method=post>

...
String titlename = "";
if (canedit)
	titlename = SystemEnv.getHtmlLabelName(93,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(15103,user.getLanguage());
else
	titlename = SystemEnv.getHtmlLabelName(367,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(15103,user.getLanguage());
...
<FORM id=weaver name="weaver" action="/CRM/sellchance/CRMFactorOperation.jsp" method=post onsubmit='return check_form(this,"type,desc")'>
...
function doDel(){
	if(isdel()){location.href="/CRM/sellchance/CRMFactorOperation.jsp?method=delete&sign=s&id=<%=id%>"}
}
</script>

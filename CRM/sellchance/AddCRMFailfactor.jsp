...
String titlename = SystemEnv.getHtmlLabelName(82,user.getLanguage())+":&nbsp;"+SystemEnv.getHtmlLabelName(15104,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<FORM name="weaver" action="/CRM/sellchance/CRMFactorOperation.jsp" method=post onsubmit='return check_form(this,"type,desc")'>
...
function doSave() {
	if (check_form(document.weaver, "type,desc"))

  ...
  <TR>
    <TD vAlign=top>
  	...
  	<COL width="80%">
        ...
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(576,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(195,user.getLanguage())%></TD>
        ...
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(576,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(433,user.getLanguage())%></TD>
...
function doDel(){
	if(isdel()){location.href="/CRM/Maint/CustomerSizeOperation.jsp?method=delete&id=<%=id%>"}
}
</script>

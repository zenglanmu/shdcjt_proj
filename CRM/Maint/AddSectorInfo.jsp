        ...
        <TR>
         ...
         while(!tmpsecid.equals("0")&&!tmpparid.equals("")){
          ...
          %>
              ...
              <INPUT class="wuiBrowser" type=hidden _displayText=" <%=seclist%>" _url="/systeminfo/BrowserMain.jsp?url=/CRM/Maint/SectorInfoBrowser.jsp" name=parentid value=<%=parentid%>>
		  </TD>
         </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>        
        </TBODY></TABLE></TD>
    </TR></TBODY></TABLE>

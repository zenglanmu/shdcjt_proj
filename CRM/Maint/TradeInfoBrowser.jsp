...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="TradeInfoBrowser.jsp" method=post>
...
<TD width=85% class=field><input class=InputStyle  name=fullname value="<%=fullname%>"></TD>
...
<TH width=25%><%=SystemEnv.getHtmlLabelName(1271,user.getLanguage())%></TH>
<TH width=25%><%=SystemEnv.getHtmlLabelName(1270,user.getLanguage())%></TH>
</tr><TR class=Line style="height: 1px"><TH colSpan=4></TH></TR>
<%
int i=0;
sqlwhere = "select * from CRM_TradeInfo "+sqlwhere+" order by id";

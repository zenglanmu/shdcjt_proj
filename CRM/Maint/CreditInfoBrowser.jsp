...
<tr>
	...
	<td valign="top">
		...
		<tr>
		<td valign="top">
<FORM NAME=SearchForm STYLE="margin-bottom:0" action="CreditInfoBrowser.jsp" method=post>
...
<TD width=35% class=field><input class=InputStyle  name=creditamount value="<%=creditamount%>"></TD>
...
<%
int i=0;
sqlwhere = "select * from CRM_CreditInfo "+sqlwhere+" order by id";

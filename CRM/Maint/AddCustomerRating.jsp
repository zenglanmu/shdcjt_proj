  	...
  	<COL width="80%">
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow11 onclick="onShowWorkflow11()"></BUTTON> 
              <SPAN id=workflow11span><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> 
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow12 onclick="onShowWorkflow12()"></BUTTON> 
              <SPAN id=workflow12span><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> 
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow21 onclick="onShowWorkflow21()"></BUTTON> 
              <SPAN id=workflow21span><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> 
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow22 onclick="onShowWorkflow22()"></BUTTON> 
              <SPAN id=workflow22span><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> 
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow31 onclick="onShowWorkflow31()"></BUTTON> 
              <SPAN id=workflow31span><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> 
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser id=SelectWorkflow32 onclick="onShowWorkflow32()"></BUTTON> 
              <SPAN id=workflow32span><IMG src="/images/BacoError.gif" align=absMiddle></SPAN> 
...
sub onShowWorkflow11()
	...
	workflow11span.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowWorkflow12()
	...
	workflow12span.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowWorkflow21()
	...
	workflow21span.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowWorkflow22()
	...
	workflow22span.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowWorkflow31()
	...
	workflow31span.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowWorkflow32()
	...
	workflow32span.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

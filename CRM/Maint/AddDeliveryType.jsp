    ...
    <TD vAlign=top>
  	...
  	<COL width="80%">
        ...
        <TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=150 size=50 name="send" onchange='checkinput("send","sendimage")'><SPAN id=sendimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
         </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>        
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(600,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(599,user.getLanguage())%></TD>
          <TD class=Field><INPUT class=InputStyle maxLength=150 size=50 name="move" onchange='checkinput("move","moveimage")'><SPAN id=moveimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
         </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>        
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(601,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(599,user.getLanguage())%></TD>
          <TD class=Field><INPUT class=InputStyle maxLength=150 size=50 name="get" onchange='checkinput("get","getimage")'><SPAN id=getimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
         </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>        
        </TBODY></TABLE></TD>
    </TR></TBODY></TABLE>
</FORM>

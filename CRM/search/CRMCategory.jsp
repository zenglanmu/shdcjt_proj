...
String sql_M="";
if(!user.getLogintype().equals("2")) {
	sql_M="select t2.* from crm_customerinfo t1,CRM_Sellchance t2 where t1.id=t2.customerid and t2.endtatusid=0 and t1.manager =" + userid +" and t2.predate <='"+currentdate0+"'";
}else{
	sql_M="select t2.* from crm_customerinfo t1,CRM_Sellchance t2 where t1.id=t2.customerid and t2.endtatusid=0 and t1.agent =" + userid +" and t2.predate <='"+currentdate0+"'";
}
rs.executeSql(sql_M);
if(rs.getCounts()>0){
%>

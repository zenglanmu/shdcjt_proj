...
<%
    ...
    String itemdsp = "" ;
    String year = Util.toScreen("Äê",user.getLanguage(),"0") ;
    String month = Util.toScreen("ÔÂ",user.getLanguage(),"0") ;
    String date = Util.toScreen("ÈÕ",user.getLanguage(),"0") ;
...
%>
<BODY>
<%@ include file="/systeminfo/TopTitle.jsp" %><BR>
...
<br><br>
<font color=red><%=SystemEnv.getHtmlLabelName(15168,user.getLanguage())%>£º</font><%=SystemEnv.getHtmlLabelName(15169,user.getLanguage())%>¡£
<br><br>
<%
    String tohtml = "" ;
    String toohtml = "" ;

...
String titlename =SystemEnv.getHtmlLabelName(365,user.getLanguage())+" £º"+SystemEnv.getHtmlLabelName(15187,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
...
<TABLE class=ViewForm>
  ...
  <TR>
        ...
        <TR>
          ...
          <SPAN id=inpreptablenameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>£¨<%=SystemEnv.getHtmlLabelName(15191,user.getLanguage())%>£º"T_"+"<%=SystemEnv.getHtmlLabelName(15186,user.getLanguage())%>"[<%=SystemEnv.getHtmlLabelName(642,user.getLanguage())%>]£¬<%=SystemEnv.getHtmlLabelName(15192,user.getLanguage())%>¡££©</TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          ...
          <SPAN id=urlnameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>     <%=SystemEnv.getHtmlLabelName(15194,user.getLanguage())%>£ºwww.e-cology.com.cn</TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <tr>

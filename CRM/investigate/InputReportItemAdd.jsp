...
String titlename = SystemEnv.getHtmlLabelName(365,user.getLanguage())+"£º"+SystemEnv.getHtmlLabelName(15213,user.getLanguage());
String needfav ="1";
String needhelp ="";
%>
<BODY>
  ...
  <TABLE class=ViewForm>
    ...
    <TR> 
      ...
      <TD class=Field> 
        ...
        <SPAN id=itemfieldnameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>£¨<%=SystemEnv.getHtmlLabelName(15191,user.getLanguage())%>£º"f_"+"<%=SystemEnv.getHtmlLabelName(685,user.getLanguage())%>"[<%=SystemEnv.getHtmlLabelName(642,user.getLanguage())%>]£¬<%=SystemEnv.getHtmlLabelName(15210,user.getLanguage())%>¡££©</TD>
    </TR><tr><td class=Line colspan=2></td></tr>

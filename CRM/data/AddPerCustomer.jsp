     ...
     --%>        
	   ...
	   <%--????--%>
		...
		<TR>
		  ...
		  <SPAN id=Nameimage><%if("".equals(name)) {%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></TD>
       ...
       <%--????--%>
        <TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=50 name="Phone" onKeyPress="ItemPhone_KeyPress()" onBlur='<%--checknumber("Phone");--%>checkinput("Phone","Phoneimage")' STYLE="width:45%"><SPAN id=Phoneimage STYLE="width:5%"><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
        </TR><tr style="height:1px"><td class=Line colspan=2></td></tr>  
	    <%--??--%>
		<TR>
	...
	<%-- xwj for td1552 on 2005-03-22
	  <TABLE class=ViewForm>
        ...
        <TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=50 name="Address1" onchange='checkinput("Address1","Address1image")' STYLE="width:95%"><SPAN id=Address1image><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
        </TR><tr><td class=Line colspan=2></td></tr>        
        <TR>
      ...
      <%-- xwj for td1552 on 2005-03-22
        <TR>
          ...
          <BUTTON class=Browser onclick="onShowSizeID()"></BUTTON> 
              <SPAN id=Sizespan><IMG src='/images/BacoError.gif' align=absMiddle></SPAN> 

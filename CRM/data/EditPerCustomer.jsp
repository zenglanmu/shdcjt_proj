    ...
    --%>
	   ...
	   <%--????--%>
		...
		<TR>
		  ...
		  <SPAN id=Nameimage><%if("".equals(Util.null2String(RecordSet.getString("Name")))) {%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></TD>
        </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>
		<%--??--%>
		<TR>
		...
		<TR>
		  ...
		  <TD class="Field">
			<INPUT maxLength=150 class=InputStyle name="IDCardNo" STYLE="width:95%" onKeyPress="ItemCount_KeyPress()" <%--onchange='checkinput("IDCardNo","IDCardNoimage")'--%> value="<%=Util.null2String(RecordSet.getString("IDCardNo"))%>">
			 <SPAN id=IDCardNoimage><%--if("".equals(Util.null2String(RecordSet.getString("IDCardNo")))) {%><IMG src="/images/BacoError.gif" align=absMiddle><%}--%> </SPAN>
		  </TD>
		</TR>
       ...
       <%--????--%>
		...
		<TR>
		  ...
		  <SPAN id=Emailimage> <%--if("".equals(Util.null2String(RecordSet.getString("Email")))) {%><IMG src="/images/BacoError.gif" align=absMiddle><%}--%> </SPAN>
		  </TD>
        </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>    

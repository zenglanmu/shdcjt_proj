	  ...
	  <TABLE class=ViewForm>
        ...
        <TR>
          ...
          <BUTTON class=Browser id=SelectResourceID onClick="onShowContacterID()"></BUTTON> <span 
            id=ContacterIDspan><IMG src='/images/BacoError.gif' align=absMiddle></span> 
...
<%}%>
        ...
        <TR>
          ...
          <TD class=Field><BUTTON class=Browser onclick="onShowSourceID()"></BUTTON> 
              <SPAN id=Sourcespan><IMG src='/images/BacoError.gif' align=absMiddle></SPAN> 
...
<%}%>
		<TR>
          ...
          <TD class=Field><INPUT class=InputStyle maxLength=100 size=30 name="Subject" onchange='checkinput("Subject","Subjectimage")'><SPAN id=Subjectimage><IMG src='/images/BacoError.gif' align=absMiddle></SPAN></TD>
        </TR><tr><td class=Line colspan=2></td></tr>
        <TR>
          ...
          <TD class=Field><BUTTON class=Calendar onclick="getContactDate()"></BUTTON> 
              <SPAN id=ContactDatespan ><IMG src='/images/BacoError.gif' align=absMiddle></SPAN> 

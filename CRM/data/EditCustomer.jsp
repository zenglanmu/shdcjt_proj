...
<%if(!isCustomerSelf){%>
		<TR>
          ...
          <TD class=Field>
            ...
            %>
              ...
              <INPUT type=hidden class="wuiBrowser" _required="yes" _displayText="<%=spanStr %>" _url="/systeminfo/BrowserMain.jsp?url=/CRM/Maint/CustomerTypeBrowser.jsp" name=Type value=<%=RecordSet.getString("type").equals("0")?"":RecordSet.getString("type")%>>  
               </TD>
        </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>
        <TR>
          ...
          <TD class=Field>
                ...
                %>
              <INPUT class="wuiBrowser" _displayText="<%=spanStr %>" _url="/systeminfo/BrowserMain.jsp?url=/CRM/Maint/CustomerDescBrowser.jsp" _required="yes" type=hidden name=Description value=<%=RecordSet.getString("description").equals("0")?"":RecordSet.getString("description")%>>        </TD>
              
         </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>        
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(576,user.getLanguage())%></TD>
          <TD class=Field>
          	<INPUT class="wuiBrowser" _displayText="<%=Util.toScreen(CustomerSizeComInfo.getCustomerSizedesc(RecordSet.getString("size_n")),user.getLanguage())%>" _url="/systeminfo/BrowserMain.jsp?url=/CRM/Maint/CustomerSizeBrowser.jsp" _required="yes" type=hidden name=Size value=<%=RecordSet.getString("size_n").equals("0")?"":RecordSet.getString("size_n")%>>    
          </TD>
        ...
        <TR>
          ...
          <TD class=Field>
              ...
              <INPUT class="wuiBrowser" _displayText="<%=Util.toScreen(ContactWayComInfo.getContactWayname(RecordSet.getString("source")),user.getLanguage())%>" _url="/systeminfo/BrowserMain.jsp?url=/CRM/Maint/ContactWayBrowser.jsp" _required="yes" type=hidden name=Source value=<%=RecordSet.getString("source")%>>
              </TD>
        </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr>        
        <TR>
          ...
          <TD class=Field>
                ...
                %>
              <INPUT class="wuiBrowser" _displayText=" <%=seclist %>" _url="/systeminfo/BrowserMain.jsp?url=/CRM/Maint/SectorInfoBrowser.jsp" _required="yes" type=hidden name=Sector value=<%=RecordSet.getString("sector").equals("0")?"":RecordSet.getString("sector")%>>
              </TD>
         </TR><tr  style="height: 1px"><td class=Line colspan=2></td></tr> 
<%}else{ %>
		<TR>

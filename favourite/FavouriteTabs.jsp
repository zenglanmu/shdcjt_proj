...
<HTML>
	<HEAD>
		...
		<script language="javascript" src="js/SessionProvider.js"></script>
...
{	
	...
	if(this.languageid==8)
        divContent.innerHTML="<img src=/images/loading2.gif> Excuting..."
    else
        divContent.innerHTML="<img src=/images/loading2.gif> 处理中..."
	Ext.Ajax.request({
...
function  GetContent(divObj,url,isAddElement,code)
{
	var tblInfo = document.getElementById('tblInfo');
	var tdInfo = document.getElementById('tdInfo');
	divObj.innerHTML="<img src=/images/loading2.gif> 处理中...";
	var xmlHttp;
	...
	xmlHttp.onreadystatechange = function () {
		switch (xmlHttp.readyState) {
           case 3 :
			    divObj.innerHTML="<img src=/images/loading2.gif> 传输中...";
		        break;
		   case 4 :
...
function transformJsonToHtml(data,favouriteid,favouritetabid)
{
	...
	headtd.innerHTML = "<IMG src='/images/homepage/style/style1/esymbol.gif' name=esymbol><div id='sysFavouriteTypeDiv_"+data.id+"' style='display:none;'>"+
    ...
    linetr.style.background = "url(/images/homepage/style/style1/esparatorimg.gif)";
										...
										<TR
											...
											<TD align=right>
												...
												<IMG
													...
													onmouseout="this.style.filter='progid:DXImageTransform.Microsoft.Alpha(opacity=30)'"
													src="/images/homepage/style/style1/setting1.gif">
												&nbsp;
												<IMG
													onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Alpha(opacity=70)'"
												...
												onmouseout="this.style.filter='progid:DXImageTransform.Microsoft.Alpha(opacity=30)'"
													src="/images/homepage/style/style1/close1.gif">
												&nbsp;
												<A onclick="javascript:openFavouriteTab('<%=favouriteid%>','<%=favouriteAlias %>');"
													href="javascript:void(0);"><IMG
														...
														style="FILTER:progid:DXImageTransform.Microsoft.Alpha(opacity =30); CURSOR:hand"
														onmouseout="this.style.filter='progid:DXImageTransform.Microsoft.Alpha(opacity=30)'"
														src="/images/homepage/style/style1/more1.gif" border=0>
												</A>&nbsp;
											</TD>
										</TR>
										<TR>
																...
																<TD width=*>
																	...
																	<TABLE width="100%" id="favouritetabdatatable_<%=favouriteid %>">
																			...
																			<TR height=18 id="sysFavouriteTr_<%=id %>">
																				<TD width=8>
																					<IMG
																						src="/images/homepage/style/style1/esymbol.gif"
																						name=esymbol>
																			...
																			<TR
																				style="BACKGROUND: url(/images/homepage/style/style1/esparatorimg.gif)"
																				height=1>
																				<TD colSpan=5></TD>
																			</TR>
																			<%

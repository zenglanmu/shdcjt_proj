...
Ext.extend(SysFavouritesGrid, Ext.grid.GridPanel, {
    ...
    formatType: function(value, p, record) 
    {
    	...
    	{
    		image = "<img src='/images_face/ecologyFace_2/LeftMenuIcon/MyDoc.gif' title='"+favourite.window.doc+"'>";
    	}
    	else if(record.data.favouritetype=="2")
    	{
    		image = "<img src='/images_face/ecologyFace_2/LeftMenuIcon/MyWorkflow.gif' title='"+favourite.window.workflow+"'>";
    	}
    	else if(record.data.favouritetype=="3")
    	{
    		image = "<img src='/images_face/ecologyFace_2/LeftMenuIcon/MyProject.gif' title='"+favourite.window.project+"'>";
    	}
    	else if(record.data.favouritetype=="4")
    	{
    		image = "<img src='/images_face/ecologyFace_2/LeftMenuIcon/MyCRM.gif' title='"+favourite.window.custom+"'>";
    	}
    	else
    	{
    		image = "<img src='/images/filetypeicons/html.gif' title='"+favourite.window.other+"'>";
    	}
    	return image;
    },

...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>e-cology文档全文检索_<c:out value="${key}"/></title>
    ...
    <script language="javascript">
	    ...
	    function initPage(){
			...
			if(page==1)s+=getUrl(2,'下一页');
			else s+=getPages()+"&nbsp;"+((isLastPage)?"":getUrl(page+1,'下一页'));
...
<div class="search">
	<div style="padding-left:80px;">文档&nbsp;&nbsp;<a href="#">项目</a>&nbsp;&nbsp;
	<a href="#">流程</a>&nbsp;&nbsp;<a href="#">客户</a></div>
	<form action="" method="get" name="frm1" id="frm1">
	关键词：
	  <input name="key" type="text" value="<c:out value="${key}"/>" size="40"/>
	<input type="submit" name="btn1" value="搜索" />
	</form>

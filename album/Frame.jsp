  ...
  <TBODY> 
	<tr> 
		<td  height=100% id=oTd1 name=oTd1 width="220px" style="padding:0px;">
			<IFRAME name=leftframe id=leftframe src="AlbumMenu.jsp" width="100%" height="100%" frameborder=no scrolling="no"></IFRAME>
		</td>
		...
		<td height=100% id=oTd2 name=oTd2 width="*" style="padding:0px;">
			<IFRAME name=contentframe id=contentframe src="AlbumList.jsp" width="100%" height="100%" frameborder=no scrolling=yes></IFRAME>
		</td>
	</tr>
  </TBODY>
</TABLE>

...
if(ids.length==0){
	...
	//End TD29472
	out.print("<tree text=\""+name+"\" action=\"AlbumList.jsp?id="+id+"\" icon=\"/images/treeimages/home16.gif\" openIcon=\"/images/treeimages/home16.gif\" src=\"AlbumFolderTree.jsp?id="+id+"\" /></tree>");
	return;
}
...
while(rs.next()){
	...
	//End TD29472
	str += "<tree text=\""+name+"\" action=\"AlbumList.jsp?id="+id+"\" icon=\"/images/treeimages/home16.gif\" openIcon=\"/images/treeimages/home16.gif\" ";
...
while(p.next()){
	...
	str += "<tree text=\""+name+"\" action=\"AlbumList.jsp?id="+id+"\" icon=\"/images/xp/folder.png\" openIcon=\"/images/xp/folder.png\" ";

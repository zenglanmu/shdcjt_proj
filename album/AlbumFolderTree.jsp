<%@ page language="java" contentType="text/xml; charset=gbk" %><%@page import="weaver.general.*,weaver.hrm.*"%><jsp:useBean id="rs" class="weaver.conn.RecordSet" scope="page" /><?xml version="1.0" encoding="gbk"?><tree><%

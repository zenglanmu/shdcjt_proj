...
<tbody>
	<tr bgcolor="#DDDDDD" height="100%">
		...
		<%if(layouttype == 0 || layouttype == 1){ %>
			...
			<tr><td class="Line2" colspan="2"></td></tr>
			<tr>  <%-- 启用HTML模板在非ie下对齐方案  --%>
			<td heigth="20" align="left" colspan="2">
				&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="checkbox" name="htmlParseScheme" <%=htmlParseScheme == 1 ? "checked" : "" %> id="htmlParseScheme" value="1">跨浏览器模式（<a href="/workflow/html/CrossBrowserDescription.jsp?languageid=<%=user.getLanguage()%>" target="_blank">请查看说明后选择</a>）
			</td>
			</tr>
		<%}%>

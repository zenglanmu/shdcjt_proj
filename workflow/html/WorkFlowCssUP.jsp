	...
	<td valign="top">
		...
		<COL width="85%" >
			...
			<tr>
				...
				<td class="field">
					 <div id="uploadDiv" class="uploadfield" mainId="0" subId="0" secId="0"  uploadType="wfcssup"  uploadLimit="1"  maxsize="<%=annexmaxUploadImageSize%>"></div><span id="cssfilespan" class="BacoError"><IMG src="/images/BacoError.gif" align="absMiddle"></span>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="field">
					<input type="text" id="cssname" name="cssname" maxlength="20" style="width:80%" value="" temptitle="CSS<%=SystemEnv.getHtmlLabelName(17517,user.getLanguage())%>" onchange="checkinput('cssname','cssnamespan')"><span id="cssnamespan"><IMG src="/images/BacoError.gif" align="absMiddle"></SPAN></span>
				</td>
			<tr>
			<tr><td class="Line2" colSpan="2"></td></tr>
		</table>
...
function afterChooseFile(uploaddiv,totalnumFiles){
	var field=jQuery(uploaddiv).attr("field");
	   if(totalnumFiles>0)
	      ...
	      jQuery(".BacoError").html("<IMG align=absMiddle src='/images/BacoError.gif'>");   

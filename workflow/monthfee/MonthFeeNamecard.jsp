...
<tr <%if(islight){%> class=datalight <%} else {%> class=datadark <%}%>>
    ...
    <span id="feeamountspan_<%=tmprequestid%>"><img src='/images/BacoError.gif' align=absmiddle></span>
    <% } %>
    </td>
    ...
    <span id="changeamountspan_<%=tmprequestid%>"><img src='/images/BacoError.gif' align=absmiddle></span></td>
</tr>
<%}%>
</table>
	</td>

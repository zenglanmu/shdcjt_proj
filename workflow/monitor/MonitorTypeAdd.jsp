									...
									<TABLE class="viewform">
										...
										<TBODY>
											...
											<TR>
												...
												<TD class=Field>
													<INPUT type=text size=30 class=Inputstyle name="typename"
														onchange='checkinput("typename","typenameimage")'>
											...
											<TR>
												...
												<TD class=Field>
													<INPUT type=text size=60 name="typedesc" class=Inputstyle>

...
<%
	...
	if (detachable == 0)
	{
		response.sendRedirect("/workflow/monitor/managemonitor_frm.jsp?rightSha=share");
		return;
	}
%>
<HTML>
	...
	<body scroll="no">
		<TABLE class=viewform height="100%" width=100% id=oTable1 style="height: expression(getParentHeight());"  cellpadding="0px" cellspacing="0px">
			<TBODY>
				<tr>
					...
					<td height=100% id=oTd2 name=oTd2 width="*" style=’padding:0px’>
						<IFRAME name=contentframe id=contentframe src="/workflow/monitor/managemonitor_frm.jsp?rightSha=share" width="100%" height="100%" frameborder=no scrolling=yes>
							浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。
						</IFRAME>
					</td>
				</tr>

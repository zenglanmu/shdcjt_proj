...
<%}%>
<link href="/css/wfdesign.css" type="text/css" rel="stylesheet">
...
<script type="text/javascript" src="/js/workflow/design/common.js"></script>
<script type="text/javascript" src="/js/workflow/design/dtree.js"></script>
<script type="text/javascript" src="/js/workflow/design/shape.js"></script>
<script type="text/javascript" src="/js/workflow/design/toppanel.js"></script>
<script type="text/javascript" src="/js/workflow/design/topflow.js"></script>
<script type="text/javascript" src="/js/workflow/design/topflowevent.js"></script>
<script type="text/javascript" src="/js/workflow/design/contextmenu.js"></script>
...
function grid(){
    ...
    if (obj == '') 
    	document.body.style.backgroundImage = 'url(/images/wfdesign/bg.jpg)';
    else 

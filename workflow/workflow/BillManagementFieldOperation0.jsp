...
<%
	...
	if(actionType.equals("add")){		
	    ...
	    if(addSuccess){
			sql="INSERT INTO workflow_billfield ( billid, fieldname, fieldlabel, fielddbtype, fieldhtmltype, type, dsporder, viewtype,fromUser,childfieldid,textheight,imgwidth,imgheight) VALUES ("+billId+",'"+fieldName+"',"+fieldLabelId+",'"+fieldDBType+"',"+fieldhtmltype+","+htmltype+","+orderNum+",0,'0',"+childfieldid+","+textheight+","+imgwidth+","+imgheight+")";
			addSuccess=RecordSet.execute(sql);				
		}
	    ...
	    <%//}
	    response.sendRedirect("/workflow/workflow/BillManagementDetail0.jsp?billId=" + billId) ;
		return;	  

...
<HTML>
  ...
  <div align="center">
	...
	&nbsp;
	<BUTTON class=btn accessKey=R onclick="btnclear_onclick()"><U>R</U>-<%=SystemEnv.getHtmlLabelName(311,user.getLanguage())%></BUTTON><!--清除-->
  </div>
 </BODY>
 </HTML>
			 ...
			 Ext.BLANK_IMAGE_URL = '/js/extjs/resources/images/default/s.gif';
			  ...
			  // Define Tree.
				var Tree_Category_Loader = new Ext.tree.TreeLoader({
					...
					dataUrl   :"TreeData.jsp?sqlwhere=<%=sqlwhere%>"
				});

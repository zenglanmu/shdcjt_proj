...
<tr>
 ...
 <table class="viewform" >
  	...
  	<TR class="Spacing">
    	...
    	<!-- <td class=field><input type=checkbox name="canview" value="1" checked ><%=SystemEnv.getHtmlLabelName(15547,user.getLanguage())%></td> -->
...
sub onShowBrowser4s(wfid,formid,isbill)
	...
	if NOT isempty(id) then
	        if id(0)<> "" then
            'document.all("conditions").innerHTML="<img src=\"/images/BacoCheck.gif\" width=\"16\" height=\"16\" border=\"0\">"

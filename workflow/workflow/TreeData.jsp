...
//	}
    ...
    String  tempWorkflowType=null;
 	rs.executeSql("select distinct workflowtype from workflow_base "+sqlwhere+" and (isvalid='1' or isvalid='2')");
	while(rs.next()){
...
//		}
		...
		if(sqlwhere.equals("")){
		rs.executeSql("select id,workflowname from workflow_base where (isvalid='1' or isvalid='2') and workflowtype="+nodeId+" order by workflowname");
		}else{
			...
			rs.executeSql("select id,workflowname from workflow_base "+sqlwhere+" and (isvalid='1' or isvalid='2') and workflowtype="+nodeId+" order by workflowname");
		}
		while(rs.next()){

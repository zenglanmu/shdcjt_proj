...
<BODY onload="initTree()">
    <FORM NAME=SearchForm STYLE="margin-bottom:0" action="WorkflowCodeSeqSet.jsp" method=post target="wfmainFrame">
...
CXLoadTreeItem("", "/workflow/workflow/WorkflowCodeSeq_lefttwoXML.jsp?&init=true&subCompanyId=<%=subCompanyId%>&operatelevel=<%=operatelevel%>&nodeid=<%=nodeid%>&sqlwhere=<%=sqlwhere%>");

...
%>
    document.SearchForm.action="managestruabbr_subcompany.jsp";
<%
}else{
%>
    document.SearchForm.action="managestruabbr_help.jsp";
<%
}
%>
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="managestruabbr_department.jsp";
    document.SearchForm.submit();
}

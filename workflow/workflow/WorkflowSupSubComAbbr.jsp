...
String titlename = SystemEnv.getHtmlLabelName(22216,user.getLanguage())+"£º"+SystemEnv.getHtmlLabelName(22753,user.getLanguage());
...
function onSaveSupSubComAbbr(obj) {
	obj.disabled = true;
	document.formSupSubComAbbr.action="WorkflowSupSubComAbbrOperation.jsp" ;
	document.formSupSubComAbbr.submit();
}

function onSearchSupSubComAbbr(obj) {
	obj.disabled = true;
	document.formSupSubComAbbr.action="WorkflowSupSubComAbbr.jsp" ;
	document.formSupSubComAbbr.submit();
}
</script>
<%}%>
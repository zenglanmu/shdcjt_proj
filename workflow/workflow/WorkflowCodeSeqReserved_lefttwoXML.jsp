<%@ page language="java" contentType="text/xml; charset=GBK" %><%@ page import="weaver.general.Util" %><%@ page import="weaver.common.util.xtree.TreeNode" %><%@ page import="java.util.*" %><%@ page import="weaver.hrm.*" %><%@ page import="weaver.systeminfo.SystemEnv"%><jsp:useBean id="WorkflowCodeSeqReservedTree" class="weaver.workflow.workflow.WorkflowCodeSeqReservedTree" scope="page" /><%
...
if(!init.equals("")&&id.equals("")){
    ...
    companyname= SystemEnv.getHtmlLabelName(16579,user.getLanguage());

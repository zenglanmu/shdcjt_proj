...
<IFRAME name=wfleftFrame id=wfleftFrame src="WorkflowCodeSeq_lefttwo.jsp?subCompanyId=<%=subCompanyId%>&sqlwhere=<%=sqlwhere%>" width="100%" height="100%" frameborder=no scrolling=no >

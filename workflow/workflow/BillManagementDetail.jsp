...
<%
	if(operatelevel>0){
	RCMenu += "{"+SystemEnv.getHtmlLabelName(17998,user.getLanguage())+",/workflow/workflow/BillManagementFieldAdd.jsp?src=addfield&srcType=mainfield&billId="+billId+",_self}" ;

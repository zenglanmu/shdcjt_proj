...
<%
	...
	RCMenuHeight += RCMenuHeightStep ;
	if(detachable==1){
		RCMenu += "{"+SystemEnv.getHtmlLabelName(18581,user.getLanguage())+",/workflow/workflow/BillRightManagent.jsp?detailno=0&billid="+billId+",_self}" ;
		RCMenuHeight += RCMenuHeightStep ;
	}
	}
	RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",/workflow/form/manageform.jsp,_self}" ;
	RCMenuHeight += RCMenuHeightStep ;
%>
                    ...
                    <tr>
                      <td valign="top">                                                                                    
                          <%      
                            ...
                            String tableString = "";  
                          	tableString =" <table instanceid=\"billManagementDetailTable\" tabletype=\"checkbox\" pagesize=\""+perpage+"\" >"+
                                                 ...
                                                 "			<head>"+                                          
                                                 "				<col width=\"10%\"  text=\""+SystemEnv.getHtmlLabelName(15456,user.getLanguage())+"\" column=\"fieldlabel\"  otherpara=\""+user.getLanguage()+"+column:id+column:fromUser+"+billId+"+0\" transmethod=\"weaver.workflow.workflow.WorkFlowFieldTransMethod.getLabelnameForBill\" />"+                                   

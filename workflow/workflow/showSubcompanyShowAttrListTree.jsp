<%@ page language="java" contentType="text/html; charset=GBK" %><%@ page import="weaver.systeminfo.*" %><%@ page import="weaver.general.*" %><%@ page import="weaver.hrm.*" %><jsp:useBean id="SubcompanyShowAttrManager" class="weaver.workflow.workflow.SubcompanyShowAttrManager" scope="page" /><tree><%

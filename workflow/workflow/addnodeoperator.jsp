	    ...
	    WFNodeOperatorManager.setNodeid(nodeid);
          ...
          %>
           <tr <%if(linecolor==0){%> class=datalight <%} else {%> class=datadark <%}%> > 
            ...
            <td><a href="editoperatorgroup.jsp?design=<%=design%>&nodeid=<%=nodeid%>&wfid=<%=wfid%>&formid=<%=formid%>&isbill=<%=isbill%>&iscust=<%=iscust%>&id=<%=WFNodeOperatorManager.getId()%>"><img src="/images/iedit.gif" width="16" height="16" border="0"></a> 
            </td>

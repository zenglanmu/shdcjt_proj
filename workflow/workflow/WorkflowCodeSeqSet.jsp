...
%>
  	        ...
  	        <tr class="Line"><td colspan="4" style="padding: 0!important;"> </td></tr>
<%
			}
		}else{
%>
...
%>
  	        ...
  	        <tr class="Line"><td colspan="2" style="padding: 0!important;"> </td></tr>
<%
			}else{
%>
...
%>
  	        ...
  	        <tr class="Line"><td colspan="2" style="padding: 0px!important;"> </td></tr>
<%
			}else{
%>
  	        <COL width="40%">
...
%>
  	        ...
  	        <tr class="Line"><td style="padding: 0px!important;"> </td></tr>
<%
			}else{
%>
  	        <COL width="50%">

      ...
      <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF">
        ...
        <tr> 
          ...
          <tr> 
            ...
            <td width="20%" align="center" bgcolor="#D2D1F1"><a href="request_operation.jsp?wfid=<%=WFInfo.getWfid()%>&src=addrequest&formid=<%=WFInfo.getFormid()%>"><img border="0" src="/images/ar.gif"></td>            
          </tr>
          <%}

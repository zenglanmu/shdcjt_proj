		...
		switch(j) {
			...
			case 1: 
				...
				if(edittypes.indexOf("1_1")!=-1){
					sHtml = "<button class=Browser onClick='onShowCptType(node_"+rowindex+"_cpttypespan,node_"+rowindex+"_cpttypeid,"
			...
			case 3: 
				...
				if(edittypes.indexOf("3_1")!=-1){
					sHtml = "<button class=Browser onClick='onShowCptCapital(node_"+rowindex+"_cptcapitalspan,node_"+rowindex+"_cptcapitalid,";
			...
			case 7: 
				...
				if(edittypes.indexOf("7_1")!=-1){
					sHtml = "<button class=Browser onClick='onBillCPTShowDate(node_"+rowindex+"_needdatespan,node_"+rowindex+"_needdate,"+mandtypes.indexOf("7_1")+")')'></button> " + 

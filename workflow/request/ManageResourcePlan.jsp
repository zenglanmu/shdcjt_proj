...
if("".equals(field_accepterid)){
	...
	if("".equals(accepterid_tmp)){
		accepteridStr = "<IMG src='/images/BacoError.gif' align=absMiddle>";
	}
}
...
if("".equals(field_begindate)){
	...
	if("".equals(begindate_tmp)){
		begindateStr = "<IMG src='/images/BacoError.gif' align=absMiddle>";
	}
}
    ...
    <table class="viewform">
        ...
        <tr>
          ...
          <td class=field colspan=5>
            ...
            <span id="namespan_<%=rowindex%>"><%if(name.equals("")){%><img src="/images/BacoError.gif" align=absmiddle><%}%></span>
        ...
        <tr>
          ...
          <%}%>
          <%if(accepterid.equals("")){%><img src="/images/BacoError.gif" align=absmiddle><%}%>
          </span>
        ...
        <tr>
          ...
          <span id="begindatespan_<%=rowindex%>"><%=begindate%><%if(begindate.equals("")){%><img src="/images/BacoError.gif" align=absmiddle><%}%></span>
        ...
        <tr>
          ...
          <span id="enddatespan_<%=rowindex%>"><%=enddate%><%if(enddate.equals("")){%><img src="/images/BacoError.gif" align=absmiddle><%}%></span>
        ...
        <tr>
            ...
            <span id="summaryspan_<%=rowindex%>"><%if(summary.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
            </td>
        </tr>
        <TR><TD class=Line2 colSpan=6></TD></TR>
        <tr>
...
function addRow()
{
	...
	var sHtml = "<table class=viewform><COLGROUP><COL width='20%'><COL width='15%'><COL width='20%'>"+
                ...
                "<span id='namespan_"+rowindex+"'><img src='/images/BacoError.gif' align=absmiddle></span>"+
                ...
                "<span id='enddatespan_"+rowindex+"'><IMG src='/images/BacoError.gif' align=absMiddle></span>"+
                ...
                "<span id='summaryspan_"+rowindex+"'><IMG src='/images/BacoError.gif' align=absMiddle></span>"+
                "</td></tr><TR><TD class=Line2 colSpan=6></TD></TR> "+
                "<tr>"+
                "<td><%=SystemEnv.getHtmlLabelName(782,user.getLanguage())%></td>"+

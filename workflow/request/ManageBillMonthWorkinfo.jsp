...
%>
		  ...
		  <td><button class=Calendar onClick='onShowDate(type2_<%=rowindex2%>_datespan,type2_<%=rowindex2%>_date)'></button>
...
{	rowColor = getRowBg();
	...
	for(j=0; j<ncol; j++) {
		...
		switch(j) {
			...
			case 3: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Calendar onClick='onShowDate(type2_"+rowindex2+"_datespan,type2_"+rowindex2+"_date)'></button> " + 

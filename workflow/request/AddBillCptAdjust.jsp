...
<TR class="Title">
  ...
  <div>
  	...
  	<BUTTON Class=BtnFlow type=button accessKey=E onclick="deleteRow1();"><U>E</U>-<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></BUTTON></div>
  	<%}%>
   <tr class=header> 
		...
		switch(j) {
			...
			case 1: 
				...
				if(edittypes.indexOf("1_1")!=-1){
					sHtml = "<button class=Browser onClick='onShowCptType(node_"+rowindex+"_cptspan,node_"+rowindex+"_cptid)'></button> " + 
			...
			case 2: 
				...
				if(edittypes.indexOf("2_1")!=-1){
					sHtml = "<button class=Browser onClick='onShowCptCapital(node_"+rowindex+"_capitalidspan,node_"+rowindex+"_capitalid)'></button> " + 

...
%>                  
                      ...
                      <%
                       ...
                       %>
                        <button class=Browser onclick="onShowBrowser('<%=fieldid%>_<%=recorderindex%>','<%=url%>','<%=linkurl%>','<%=fieldtype%>','<%=ismand%>')" title="选择"></button> 
                       <%       } else {                         // 如果是多文档字段,加入新建文档按钮
                       %>
                        <button class=AddDocFlow onclick="onShowBrowser('<%=fieldid%>_<%=recorderindex%>','<%=url%>','<%=linkurl%>','<%=fieldtype%>','<%=ismand%>')" > 添加</button>&nbsp;&nbsp;<button class=AddDocFlow onclick="onNewDoc(<%=fieldid%>_<%=recorderindex%>)" title="新建">新建</button>
                       <%       }
                            }
                       %>

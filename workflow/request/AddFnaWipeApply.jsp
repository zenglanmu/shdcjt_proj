...
<input type="hidden" name="needwfback" id="needwfback" value="1" />
    ...
    <table  class=form border=1 bordercolor='black'>
      ...
      <TR class=Section>
          ...
          <tr class="Spacing" style="height:1px;"> <td class="Line2" ></td></tr>
      <%
            ...
            if( isedit != 1 ) {
                ...
                switch (dsporder)  {
                    ...
                    case 11 :
                        ...
                        var sHtml = "<nobr><input type='text' class=inputstyle style=width:85%  title='说明' id='description_"+insertindex+"' name='description_"+insertindex+"'  onBlur='" ;
...
function clearSpan(index) {
    ...
    $GetEle("organizationspan_"+index).parentElement.parentElement.style.background=$GetEle("organizationtype_"+index).parentElement.parentElement.style.background;
...
function onShowHR(spanname, inputname, ismand, index) {
    ...
    if (jsid != null) {
        if (jsid[0] != "0"&&jsid[0] != "") {
            ...
            if(jsid[0]!=<%=uid%>)
            jQuery(spanname).parent().parent().css("background", "#ff9999");
            else

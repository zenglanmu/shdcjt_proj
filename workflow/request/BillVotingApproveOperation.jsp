...
if("1".equals(viewvoting) && !"".equals(votingid)) {//从网上调查触发进来
	String sql = "select t2.id, t2.formid, t2.workflowtype, t2.messageType, t3.nodeid "
	...
	if(rs.next()) {
		requestname = "网上调查审批-"+rs.getString(1);
	}
...
if("1".equals(viewvoting) && !"".equals(votingid)) {
    ...
    out.print("<script>wfforward('/voting/VotingView.jsp?isfromworkflow=1&votingid="+votingid+"');</script>");
	return;
}

...
sub dspfna(objval)
    if objval = 1 then
        alldetail.style.display=""
        distd.innerHtml = "<a href='#' onclick='dspfna(0);'><%=SystemEnv.getHtmlLabelName(16309,user.getLanguage())%></a>"
    else
        alldetail.style.display="none"
        distd.innerHtml = "<a href='#this' onclick='dspfna(1);'><%=SystemEnv.getHtmlLabelName(16285,user.getLanguage())%></a>"
    end if
end sub

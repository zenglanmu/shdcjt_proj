...
%>
		  ...
		  <td><button class=Calendar onClick='onShowDate(type3_<%=rowindex3%>_datespan,type3_<%=rowindex3%>_date)'></button>
...
{	
	...
	for(j=0; j<ncol; j++) {
		...
		switch(j) {
			...
			case 2: 
				var oDiv = document.createElement("div"); 
				var sHtml = "<button class=Calendar onClick='onShowDate(type3_"+rowindex3+"_datespan,type3_"+rowindex3+"_date)'></button> " + 

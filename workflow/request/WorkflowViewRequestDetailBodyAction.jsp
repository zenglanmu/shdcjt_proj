                ...
                <table class=form style="LEFT: 0px; WIDTH: 100%;WORD-WRAP: break-word" <%if(intervenorright==1){%>style="display:none"<%}%>>
                        ...
                        <tr>
                            ...
                            <table Class=ListStyle id="oTable<%=detailno%>" >
                              ...
                              <TBODY>
                              <tr class=header>
                                <td width="3%"><%=SystemEnv.getHtmlLabelName(15486,languageidfromrequest)%></td>
                   <%
                    ...
                    %>
                        ...
                        <%                                      
                                     if(defieldhtmltype.equals("1")){                          // 单行文本框
										...
										<%}%>
                                            <input type=hidden id="field<%=defieldid%>_<%=derecorderindex%>" name="field<%=defieldid%>_<%=derecorderindex%>" value="<%=Util.toScreen(defieldvalue,languageidfromrequest)%>">
                                          <%
                                    }                                                       // 单行文本框条件结束
...
<table class=form style="LEFT: 0px; WIDTH: 100%;WORD-WRAP: break-word" <%if(intervenorright==1){%>style="display:none"<%}%>>
        ...
        <tr>
            ...
            <table Class=ListStyle id="oTable<%=detailno%>" >
              ...
              <TBODY>
              <tr class=header>
                <td width="3%" style="background:#E7E7E7"><%=SystemEnv.getHtmlLabelName(15486,languageidfromrequest)%></td>
   <%
       ArrayList viewfieldnames = new ArrayList();
...
function toPrecision(aNumber,precision){
	...
	var val = isNaN(Math.round(temp1*temp2) /temp1)?0:Math.round(temp1*temp2) /temp1;
	return  val;
}
/**

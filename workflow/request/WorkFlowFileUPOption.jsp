...
function imgshoworhideopener(nowrow,nowcol){
    ...
    if(showtype==2){
        ...
        if(cellvalue!=null && cellvalue!=""){
           ...
           opener.document.all("ChinaExcel").ReadHttpImageFile("/images/BacoBrowser_b.gif",nowrow,nowcol,true,true);
        }
		if(isProtect){
        ...
        if(cellvalue!=null && cellvalue!=""){
           ...
           opener.document.all("ChinaExcel").ReadHttpImageFile("/images/BacoBrowser.gif",nowrow,nowcol,true,true);
        }
		if(isProtect){
			opener.document.all("ChinaExcel").SetCellProtect(nowrow,nowcol,nowrow,nowcol,true);
		}

  ...
  <table class=form>
    ...
    <TR>
       ...
       <TD class=Field>
          ...
          <span id=namespan>
          <%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span> 
        </TD>
        ...
        <TD class=Field>
          ...
          <%if(hrmid.equals("")){%><%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%>
    ...
    <tr>
        ...
        <TD class=Field>
          ...
          <span id=projectspan>
          <%if(prjid.equals("")){%>
          <%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%>
        ...
        <TD class=Field>
          ...
          <span id=subprojectspan><%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
    ...
    <TR>
	    ...
	    %>
          ...
          <span id=plantypespan><%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
          ...
          <span id=plansortspan><%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
      ...
      <%}%>
	    ...
	    %>
         <td>预算金额</td>
           ...
           <span id=budgetspan><%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
           </TD>
    </tr>
    <tr>
      ...
      <td colspan=3 class=field>
        ...
        <span id=summaryspan><%if(ismand.equals("1")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
      </td>
    </tr>
    <tr class="Title">
...
sub onShowProjID(ismand)
	...
	frmmain.projectid.value=id(0)
		...
		if ismand=1 then 
			projectspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
		else
...
sub onShowSubProjID(ismand)
	...
	frmmain.subprojectid.value=id(0)
		...
		if ismand=1 then 
			subprojectspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
		else
...
sub onShowPlanType(ismand)
	...
	frmmain.plantype.value=id(0)
		...
		if ismand=1 then 
			plantypespan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
		else
...
sub onShowPlanSort(ismand)
	...
	frmmain.plansort.value=id(0)
		...
		if ismand=1 then 
			plansortspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
		else
...
sub showDoc(ismand)
	...
	frmmain.docid.value=id(0)
		...
		if ismand=1 then 
			docidname.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
		else
			docidname.innerHtml = ""
		end if

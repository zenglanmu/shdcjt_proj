...
%>
	  ...
	  <%}
	  	  if (approvetype.equals("10")) 	{%>			  
		  <span id="approveSpan" name="approveSpan" ><A href="/CRM/data/ViewCustomer.jsp?CustomerID=<%=approveid%>"  target='_new'><%=CustomerInfoComInfo.getCustomerInfoname(approveid)%></A></span>
	  <%}
		  if (approvetype.equals("11")) 	{%>			  
		  <span id="approveSpan" name="approveSpan" ><A href="/proj/data/ViewProject.jsp?ProjID=<%=approveid%>"  target='_new'><%=ProjectInfoComInfo.getProjectInfoname(approveid)%></A></span>
	  <%}%>
	  </td>
	  </tr>

...
<input type="hidden" name="needwfback" id="needwfback" value="1" />
  ...
  <table class="ViewForm" >
  	...
  	<tr>
  		...
  		<td class=field>
  			<%if(defaultName==1){%>
  			<input type=text class=Inputstyle  temptitle="<%=SystemEnv.getHtmlLabelName(21192,user.getLanguage())%>" name=requestname onChange="checkinput('requestname','requestnamespan')" size=60  maxlength=100  value = "<%=Util.toScreenToEdit( workflowname+"-"+username+"-"+currentdate,user.getLanguage() )%>" >

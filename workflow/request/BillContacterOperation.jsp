...
if(src.equals("reject")&&iscreate.equals("0")){
	...
	String body = "尊敬的 "+tmpname+" 您好！ " + "<br>" +
				  "Mr.(Mrs) "+tmpname+" , " + "<br>" +
				  "欢迎使用"+companyname+"内网系统，我们的系统暂时只面向总监及以上部门主管开放。敬请谅解！" + "<br>" +
				  "Welcome to use our intranet system, What a pity that our intranet open to who’s position upon director (manager) now." + "<br>" +
				  "谢谢！" + "<br>" +
				  "Thank you!" + "<br>" +
				  "                                               " + companyname + "<br>" +
				  "                                               " + companydesc;
...
if( RequestManager.getNextNodetype().equals("3")) {
	...
	String body = "尊敬的 "+tmpname+" 您好！ " + "<br>" +
				  "Mr.(Mrs) "+tmpname+" , " + "<br>" +
				  "欢迎使用"+companyname+"内网系统，愿我们的工作能为您提供更多的服务。" + "<br>" +
				  "Welcome to use our intranet system, we always concentrate on your recognition." + "<br>" +
				  "您的帐号(user name)：" + tmpLoginId + "<br>" +
				  "密码：  (Password):  " + tmpPassword + "<br>" +
				  "感谢您对我们工作的支持。" + "<br>" +
				  "Thank you!" + "<br>" +
				  "                                               " + companyname + "<br>" +
				  "                                               " + companydesc;

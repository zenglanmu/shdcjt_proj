...
if( !savestatus ) {
    if( requestid != 0 ) {
        ...
        if(!"".equals(message)){
            ...
            out.print("<script>wfforward('/workflow/request/ViewRequest.jsp?requestid="+requestid+"&message="+message+"&isintervenor="+isintervenor+"');</script>");
            return ;
        }
...
String capitalid =RecordSet.getString("lendCpt"); 
...
<%}%>
			...
			if (fromPDA.equals("1")){
				...
				out.print("<script>wfforward('/workflow/request/ViewRequest.jsp?requestid="+requestid+"&fromoperation=1&updatePoppupFlag=1&isShowPrompt="+isShowPrompt+"&src="+src+"&isovertime="+isovertime+"&urger="+urger+"&isintervenor="+isintervenor+"');</script>");
			}	
            //TD4262 增加提示信息  结束
             }
            }

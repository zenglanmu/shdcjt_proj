 ...
 */
	function resetbannerByCancel() {
 		for(i=0;i<=1;i++){
  		document.getElementById("oTDtype_"+i).background="/images/tab2.png";
  		document.getElementById("oTDtype_"+i).className="cycleTD";
  	}
  	document.getElementById("oTDtype_"+1).background="/images/tab.active2.png";
...
<input type="hidden" name="requestIdDoc">
 <table style="width:100%;height:100%" border=0 cellspacing=0 cellpadding=0  scrolling=no id="tabPane">
  ...
  <TBODY>
	  ...
	  <td class="cycleTD" nowrap name="oTDtype_1"  id="oTDtype_1" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='hand'" onclick='if (	document.getElementById("oTDtype_1").className=="cycleTD")  resetbanner(1,1)'>

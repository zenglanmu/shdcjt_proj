...
function addRow(obj){
	...
	//参数名
	oDiv = document.createElement("div");
	sHtml = "<input type='text' class='InputStyle' id='paraname"+obj+"_"+rowindex+"' name='paraname"+obj+"_"+rowindex+"' temptitle='<%=SystemEnv.getHtmlLabelName(23481,user.getLanguage())%>' style='width:90%' onchange='checkinput(\"paraname"+obj+"_"+rowindex+"\",\"paraname"+obj+"_"+rowindex+"span\")' value=''><span id='paraname"+obj+"_"+rowindex+"span'><img src=\"/images/BacoError.gif\" align=absmiddle></sapn>";
	oCell = oRow.insertCell();
	oCell.style.background= "#E7E7E7";
	oCell.style.wordWrap= "break-word";
	oCell.style.wordBreak= "break-all";
	...
	oDiv = document.createElement("div");
	sHtml = "<textarea class='InputStyle' id='paratext"+obj+"_"+rowindex+"' name='paratext"+obj+"_"+rowindex+"' "+pttitle+" rows='4' onchange='checkinput(\"paratext"+obj+"_"+rowindex+"\",\"paratext"+obj+"_"+rowindex+"span\")' style='width:90%' onfocus=\"dosetfocus('paratext"+obj+"_"+rowindex+"')\"></textarea><span id='paratext"+obj+"_"+rowindex+"span'><img src=\"/images/BacoError.gif\" align=absmiddle></sapn>";
	oCell = oRow.insertCell();
	oCell.style.background= "#E7E7E7";
	oCell.style.wordWrap= "break-word";
	oCell.style.wordBreak= "break-all";

...
<%
    ...
    if(src.equalsIgnoreCase("colcalrole")){
        ...
        //}
        //else {
            response.sendRedirect("/workflow/form/addformcolcal0.jsp?formid="+formid+"&ajax="+ajax);
        //}
        return;
        ...
        //if(createtype.equals("2")) {
            response.sendRedirect("/workflow/form/addformrowcal0.jsp?formid="+formid+"&ajax=1");
        //}
        // else {

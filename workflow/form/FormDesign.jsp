...
if(!type.equals("addform")){
	...
	while(rs.next()){
		...
		if(objval.equals("1")){
			...
			piecesShow +="<move:piece SNAPABLE =1 style='left:"+rs.getString("ptx")+"px;top:"+rs.getString("pty")+"px;width="+rs.getString("width")+"px;height="+rs.getString("height")+"px;"+_color+"'  id='sPiece_"+objval+"_"+objid+"' ><span  id='sTitle_"+objval+"_"+nElementNum+"'>"+fieldlabel+"</span><img id='sItem_"+objval+"_"+nElementNum+"' src='/images/formdesign/browser.gif' border=0 ><span  id='sItem_"+objval+"_"+nElementNum+"_div'>"+fieldname+"</span></move:piece>";
		}
...
function onDown(){
	...
	if(objval == "1"){
		...
		var sHtml = "<move:piece SNAPABLE =1 style='left:"+ptx+"px;top:"+pty+"px;width=240px;height=30px'  id='sPiece_"+objval+"_"+nElementNum+"'  ><div  id='sItem_"+objval+"_"+nElementNum+"' >文字</div></move:piece>"; 
		...
		nElementNum ++;
		var oDiv = document.createElement("div");
		var sHtml = "<move:piece  SNAPABLE =1 style='left:"+ptx+"px;top:"+pty+"px;width=240px;height=30px' id='sPiece_"+objval+"_"+nElementNum+"'  ><span  id='sTitle_"+objval+"_"+nElementNum+"'>标题</span><input id='sItem_"+objval+"_"+nElementNum+"' value='<%=strInputMainInitField%>' style='width:80%;'></move:piece>"; 
		oDiv.innerHTML = sHtml;
		oDivbound.appendChild(oDiv);	
	}else if(objval == "4"){
		nElementNum ++;
		var oDiv = document.createElement("div");
		var sHtml = "<move:piece  SNAPABLE =1 style='left:"+ptx+"px;top:"+pty+"px;width=240px;height=30px' id='sPiece_"+objval+"_"+nElementNum+"'  ><span  id='sTitle_"+objval+"_"+nElementNum+"'>标题</span><textarea id='sItem_"+objval+"_"+nElementNum+"'  style='width:80%;height:80%'><%=strTextareaMainInitField%></textarea></move:piece>"; 
		oDiv.innerHTML = sHtml;
		oDivbound.appendChild(oDiv);
	}else if(objval == "5"){
		nElementNum ++;
		var oDiv = document.createElement("div");
		var sHtml = "<move:piece  SNAPABLE =1 style='left:"+ptx+"px;top:"+pty+"px;width=240px;height=30px' id='sPiece_"+objval+"_"+nElementNum+"'  ><span  id='sTitle_"+objval+"_"+nElementNum+"'>标题</span><select id='sItem_"+objval+"_"+nElementNum+"' style='width:80%;'><option><%=strSelectMainInitField%></option></select></move:piece>"; 
		oDiv.innerHTML = sHtml;
		oDivbound.appendChild(oDiv);
	}else if(objval == "6"){
		nElementNum ++;
		var oDiv = document.createElement("div");
		var sHtml = "<move:piece  SNAPABLE =1 style='left:"+ptx+"px;top:"+pty+"px;width=240px;height=30px' id='sPiece_"+objval+"_"+nElementNum+"'  ><span  id='sTitle_"+objval+"_"+nElementNum+"'>标题</span><input type=checkbox id='sItem_"+objval+"_"+nElementNum+"' value='1' checked ><span  id='sItem_"+objval+"_"+nElementNum+"_div'><%=strCheckMainInitField%></span></move:piece>"; 
		oDiv.innerHTML = sHtml;
		oDivbound.appendChild(oDiv);
	}else if(objval == "9"){
		nElementNum ++;
		var oDiv = document.createElement("div");
		var sHtml = "<move:piece  SNAPABLE =1 style='left:"+ptx+"px;top:"+pty+"px;width=240px;height=30px' id='sPiece_"+objval+"_"+nElementNum+"'  ><span  id='sTitle_"+objval+"_"+nElementNum+"'>标题</span><img id='sItem_"+objval+"_"+nElementNum+"' src='/images/formdesign/browser.gif' border=0 ><span  id='sItem_"+objval+"_"+nElementNum+"_div'><%=strBrowserMainInitField%></span></move:piece>"; 
		oDiv.innerHTML = sHtml;
		oDivbound.appendChild(oDiv);
	}else if(objval == "7"){
		nElementNum ++;
	...
	objDocument.all("img_1").src = "/images/formdesign/1-down.gif";
...
function setPropertyDefault(objval,objid){
	...
	var iFormsOption="";
	iFormsOption += "<option value='0'>主表单</option>";
	iFormsOption += "<option value='1'>子表单</option>";
	...
	if(objval == "1"){
		itemList.options[len] = new Option("文字_"+objid,objval+"_"+objid); 
		...
		oCell = oRow.insertCell(); 
		var oDiv = objDocument.createElement("div");
		var sHtml = "<textarea name='prop_"+objval+"_"+objid+"_1' class=Inputstyle rows=6 cols=23 onchange='changeProp(this,"+objval+","+objid+",1);'>文字</textarea>"; 
		oDiv.innerHTML = sHtml;
		oCell.appendChild(oDiv);		
		...
		itemList.options[len] = new Option("图片_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
		...
		itemList.options[len] = new Option("单行文本_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
		...
		oCell = oRow.insertCell(); 
		var oDiv = objDocument.createElement("div");
		var sHtml = "<input type='text' class=Inputstyle name='prop_"+objval+"_"+objid+"_1' value='标题' size=18 onchange='changeProp(this,"+objval+","+objid+",1);'>"; 
		oDiv.innerHTML = sHtml;
		oCell.appendChild(oDiv);
		...
		itemList.options[len] = new Option("多行文本_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
		...
		itemList.options[len] = new Option("选择框_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
	...
	//	var sHtml = "<select style='width:100%;' name='prop_"+objval+"_"+objid+"_3' onchange='changeProp(this,"+objval+","+objid+",3);'><option value='0'>不默认</option><option value='1' selected >默认</option></select>";
		...
		itemList.options[len] = new Option("单选框_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
		...
		itemList.options[len] = new Option("浏览框_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
	...
	//	var sHtml = "<input type='text' class=Inputstyle name='prop_"+objval+"_"+objid+"_3' size=18 onchange='changeProp(this,"+objval+","+objid+",3);'>"; 
		...
		itemList.options[len] = new Option("线条_"+objid,objval+"_"+objid); 
		itemList.options[len].selected = true;
	}			
...
<BODY background="/images/formdesign/pix.gif" >

<%@ include file="/systeminfo/RightClickMenuConent.jsp" %>
<%
        RCMenu += "{删除,javascript:deleteObj1(),_self}" ;

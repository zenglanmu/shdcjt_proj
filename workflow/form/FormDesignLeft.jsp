...
if(!type.equals("addform")){
	...
	while(rs.next()){
		...
		thisFormOptions += ">主表单</option>";
		thisFormOptions += "<option value='1' ";
			if(isdetail.equals("1"))
				thisFormOptions +=" selected ";
		thisFormOptions += ">子表单</option>";
		...
		if(objval.equals("1")){
			...
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_1' style='display:none;'><td>"+"内容"+"</td><td><textarea name='prop_"+objval+"_"+objid+"_1'  class=Inputstyle rows=6 cols=23  onchange='changeProp(this,"+objval+","+objid+",1);'>"+rs.getString("defvalue")+"</textarea></td></tr>";
			...
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_2' style='display:none;'><td>"+"字号"+"</td><td><select name='prop_"+objval+"_"+objid+"_2' style='width:100%;' onchange='changeProp(this,"+objval+","+objid+",2);'>";
			...
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_3' style='display:none;'><td>"+"颜色"+"</td><td><BUTTON type='button' CLASS=Browser onclick='SelectColor(this,"+objval+","+objid+",3);'>&nbsp;</BUTTON><span name='prop_"+objval+"_"+objid+"_3_span' id='prop_"+objval+"_"+objid+"_3_span' style='width:20;height:20;background-color:"+_color+";'>&nbsp;</span><input type='hidden' class=Inputstyle name='prop_"+objval+"_"+objid+"_3' size=18 value='"+_color+"' onchange='changeProp(this,"+objval+","+objid+",3);'></td></tr>";

			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_4' style='display:none;'><td>"+"加粗"+"</td><td><input type='checkbox'  class=Inputstyle name='prop_"+objval+"_"+objid+"_4' size=18  value='1' onchange='changeProp(this,"+objval+","+objid+",4);' "+isbold+"></td></tr>";

		}else if(objval.equals("2")){
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_1' style='display:none;'><td>"+"来源"+"</td><td><input type='hidden' class=Inputstyle  name='prop_"+objval+"_"+objid+"_1' size=18 onchange='changeProp(this,"+objval+","+objid+",1);' value=\""+rs.getString("defvalue")+"\"><img src=\""+rs.getString("defvalue")+"\" border=0 height=30></td></tr>";

			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_2' style='display:none;'><td>"+"边框"+"</td><td><input type='text' class=Inputstyle  name='prop_"+objval+"_"+objid+"_2' size=18 onchange='changeProp(this,"+objval+","+objid+",2);' value='"+rs.getString("attribute1")+"'></td></tr>";
		}else if(objval.equals("3")){
			...
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_10' style='display:none;'><td>"+"表单"+"</td><td><select style='width:100%;' name='prop_"+objval+"_"+objid+"_10' onchange='changeProp(this,"+objval+","+objid+",10);'>"+thisFormOptions+"</select></td></tr>";
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_1' style='display:none;'><td>"+"标题"+"</td><td><input type='text'  class=Inputstyle name='prop_"+objval+"_"+objid+"_1' size=18 onchange='changeProp(this,"+objval+","+objid+",1);' value='"+fieldlabel+"'></td></tr>";

			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_2' style='display:none;'><td>"+"字段"+"</td><td><select style='width:100%;' name='prop_"+objval+"_"+objid+"_2' onchange='changeProp(this,"+objval+","+objid+",2);'>"+_strFieldOption+"</select></td></tr>";

			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_3' style='display:none;'><td>"+"默认值"+"</td><td><input type='text'  class=Inputstyle name='prop_"+objval+"_"+objid+"_3' size=18 onchange='changeProp(this,"+objval+","+objid+",3);' value='"+rs.getString("defvalue")+"'></td></tr>";
			String _color = rs.getString("attribute2");
			if(!_color.equals(""))
				_color=" background-color:"+_color;
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_11' style='display:none;'><td>"+"颜色"+"</td><td><BUTTON type='button' CLASS=Browser onclick='SelectColor(this,"+objval+","+objid+",11);'>&nbsp;</BUTTON><span name='prop_"+objval+"_"+objid+"_11_span' id='prop_"+objval+"_"+objid+"_11_span' style='width:20;height:20;"+_color+"'>&nbsp;</span><input type='hidden' class=Inputstyle name='prop_"+objval+"_"+objid+"_11' size=18 value='"+rs.getString("attribute2")+"' onchange='changeProp(this,"+objval+","+objid+",11);'></td></tr>";
			...
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_1' style='display:none;'><td>"+"标题"+"</td><td><input type='text'  class=Inputstyle name='prop_"+objval+"_"+objid+"_1' size=18 onchange='changeProp(this,"+objval+","+objid+",1);' value='"+fieldlabel+"'></td></tr>";
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_2' style='display:none;'><td>"+"字段"+"</td><td><select style='width:100%;' name='prop_"+objval+"_"+objid+"_2' onchange='changeProp(this,"+objval+","+objid+",2);'>"+_strFieldOption+"</select></td></tr>";
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_3' style='display:none;'><td>"+"默认值"+"</td><td><select style='width:100%;' name='prop_"+objval+"_"+objid+"_3' onchange='changeProp(this,"+objval+","+objid+",3);'><option value='0' "+bslected1[0]+" >"+"不选中"+"</option><option value='1' "+bslected1[1]+" >"+"选中"+"</option></select></td></tr>";
			String _color = rs.getString("attribute2");
			if(!_color.equals(""))
				_color=" background-color:"+_color;
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_11' style='display:none;'><td>"+"颜色"+"</td><td><BUTTON type='button' CLASS=Browser onclick='SelectColor(this,"+objval+","+objid+",11);'>&nbsp;</BUTTON><span name='prop_"+objval+"_"+objid+"_11_span' id='prop_"+objval+"_"+objid+"_11_span' style='width:20;height:20;"+_color+"'>&nbsp;</span><input type='hidden' class=Inputstyle name='prop_"+objval+"_"+objid+"_11' size=18 value='"+rs.getString("attribute2")+"' onchange='changeProp(this,"+objval+","+objid+",11);'></td></tr>";
			...
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_1' style='display:none;'><td>"+"标题"+"</td><td><input type='text'  class=Inputstyle name='prop_"+objval+"_"+objid+"_1' size=18 onchange='changeProp(this,"+objval+","+objid+",1);' value='"+fieldlabel+"'></td></tr>";
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_2' style='display:none;'><td>"+"字段"+"</td><td><select style='width:100%;' name='prop_"+objval+"_"+objid+"_2' onchange='changeProp(this,"+objval+","+objid+",2);'>"+_strFieldOption+"</select></td></tr>";
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_3' style='display:none;'><td>"+"默认值"+"</td><td><select style='width:100%;' name='prop_"+objval+"_"+objid+"_3' onchange='changeProp(this,"+objval+","+objid+",3);'><option value='' "+bslected1[0]+" >"+"不默认"+"</option><option value='1' "+bslected1[1]+" >"+"默认"+"</option></select></td></tr>";
			String _color = rs.getString("attribute2");
			if(!_color.equals(""))
				_color=" background-color:"+_color;
			itemProps += "<tr id='oTr_"+objval+"_"+objid+"_11' style='display:none;'><td>"+"颜色"+"</td><td><BUTTON type='button' CLASS=Browser onclick='SelectColor(this,"+objval+","+objid+",11);'>&nbsp;</BUTTON><span name='prop_"+objval+"_"+objid+"_11_span' id='prop_"+objval+"_"+objid+"_11_span' style='width:20;height:20;"+_color+"'>&nbsp;</span><input type='hidden' class=Inputstyle name='prop_"+objval+"_"+objid+"_11' size=18 value='"+rs.getString("attribute2")+"' onchange='changeProp(this,"+objval+","+objid+",11);'></td></tr>";
...
function addItem(objid){
	...
	var imgid = objid*1+1;
	document.all("img_"+imgid).src = "/images/formdesign/"+imgid+"-down.gif";
}

function imgOver(imgid){
	var objid =formDocument.all("objtype").value;
	if((objid*1+1)!=imgid)
		document.all("img_"+imgid).src = "/images/formdesign/"+imgid+"-over.gif";
}
...
<%
    if(operatelevel>0){
        ...
        RCMenu += "{预览,javascript:onView(),_self}" ;
        RCMenuHeight += RCMenuHeightStep ;
        RCMenu += "{退出,javascript:onExit(),_self}" ;
        RCMenuHeight += RCMenuHeightStep ;
    }
    if(type.equals("editform")&&operatelevel>0){


        RCMenu += "{行字段规则,addformrowcal.jsp?createtype=2&formid="+formid+",_parent}" ;
        RCMenuHeight += RCMenuHeightStep ;

        RCMenu += "{列字段规则,addformcolcal.jsp?createtype=2&formid="+formid+",_parent}" ;
        RCMenuHeight += RCMenuHeightStep ;
    }
...
<br>
  <img id="img_1" name="img_1" onclick="addItem(0);"  onmouseover="imgOver(1);" onmouseout="imgOut(1);" style="CURSOR: hand" src="/images/formdesign/1-down.gif" border=0 title="移动">
       <img id="img_2" name="img_2" onclick="addItem(1);"  onmouseover="imgOver(2);" onmouseout="imgOut(2);" style="CURSOR: hand" src="/images/formdesign/2.gif" border=0 title="文字">
       <img id="img_3" name="img_3" onclick="addItem(2);"  onmouseover="imgOver(3);" onmouseout="imgOut(3);" style="CURSOR: hand" src="/images/formdesign/3.gif" border=0 title="图片">
    <img id="img_8" name="img_8" onclick="addItem(7);"  onmouseover="imgOver(8);" onmouseout="imgOut(8);" style="CURSOR: hand" src="/images/formdesign/8.gif" border=0 title="线条">
       <img id="img_4" name="img_4" onclick="addItem(3);"  onmouseover="imgOver(4);" onmouseout="imgOut(4);" style="CURSOR: hand" src="/images/formdesign/4.gif" border=0 title="单行文本">
        <img id="img_5" name="img_5" onclick="addItem(4);"  onmouseover="imgOver(5);" onmouseout="imgOut(5);" style="CURSOR: hand" src="/images/formdesign/5.gif" border=0 title="多行文本">
       <img id="img_6" name="img_6" onclick="addItem(5);"  onmouseover="imgOver(6);" onmouseout="imgOut(6);" style="CURSOR: hand" src="/images/formdesign/6.gif" border=0 title="选择框">
       <img id="img_7" name="img_7" onclick="addItem(6);"  onmouseover="imgOver(7);" onmouseout="imgOut(7);" style="CURSOR: hand" src="/images/formdesign/7.gif" border=0 title="Check框">
       <img id="img_10" name="img_10" onclick="addItem(9);"  onmouseover="imgOver(10);" onmouseout="imgOut(10);" style="CURSOR: hand" src="/images/formdesign/10.gif" border=0 title="浏览框">
...
function onCreate(){
	...
	if(document.all("prop_0_1").value==""){
		var _tmpval = document.all("info").innerHTML;
		 document.all("info").innerHTML="[ERROR]请输入表单名称!<br>"+_tmpval;
		return;
	}
		...
		if(_tmpObj != ""){
			...
			if(_tmpStr.indexOf(","+tmptype+",")!=-1){
				...
				if(document.all("prop_"+_tmpObj+"_1").value == ""){
					...
					document.all("info").innerHTML="[ERROR]请输入对象{"+_tmpText+"}的标题!<br>"+_tmpval;
						return;
				}
				if(document.all("prop_"+_tmpObj+"_10").value == "1"){
					if(minpty != 0 && ((_curpty-minpty) > 30 ||(_curpty-minpty) < -30 )) {
						document.all("info").innerHTML="[ERROR]对象{"+_tmpText+"}与其他子表单对象不在同一行上或者同一行上不全是子表单对象!<br>"+_tmpval;
						return;
					}
					minpty = _curpty ;
				}

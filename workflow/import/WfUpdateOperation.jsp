...
String checkresult = WorkflowDataService.checkWorkflowXml(xmlfilepath,selectworkflowid);
...
<BODY onload="displayExcel();">
	...
	out.println("<TABLE class=liststyle><COLGROUP><COL width='25%'><COL width='25%'><COL width='30%'><COL width='15%'><COL width='5%'><TR class=Title><TH colSpan=5>导入结果</TH></TR><TR class=Spacing><TD class=Line1 colSpan=5></TD></TR>");
   	...
   	out.println("<tr>");
    out.println("<td><a href='/system/basedata/basedata_workflow.jsp?wfid="+selectworkflowid+"' target='_blank'>查看工作流程基础数据</a></td>");
    out.println("<td></td>");
    out.println("<td></td>");
    out.println("<td></td>");
    out.println("<td></td>");

        ...
        if type1= 2 or type1 = 19 then
            ...
            if type1 = 171 or type1 = 152 or type1 = 142 or type1 = 135 or type1 = 17 or type1 = 18 or type1=27 or type1=37 or type1=56 or type1=57 or type1=65 or type1=166 or type1=168 or type1=170 then
               ...
               if  id1(0)<>""   and id1(0)<> "0"  then
                    ...
                    rname = id1(1)
                    if type1 <> 161 then
	                    rid = Mid(rid,2,len(rid))   
	                    rname = Mid(rname,2,len(rname))
                    end if
		...
		while InStr(shareTypeValues,"~") <> 0
	        ...
	        if shareTypeValue= "1" then
			    sHtml = sHtml&"，"&shareTypeText&"("&relatedShareNames&")"
			             ...
			             sHtml = sHtml&"，"&shareTypeText&"("&relatedShareNames&")"&label_683&">="&secLevelValue&label_18941
			        else   if shareTypeValue= "3" then
			                   sHtml = sHtml&"，"&shareTypeText&"("&relatedShareNames&")"&label_683&">="&secLevelValue&label_18942
					       else  if shareTypeValue= "4" then
			                         sHtml = sHtml&"，"&shareTypeText&"("&relatedShareNames&")"&label_3005&"="&rolelevelText&label_683&">="&secLevelValue&label_18945
						         else
		...
		wend
	        ...
	        if shareTypeValues= "1" then
			    sHtml = sHtml&"，"&shareTypeTexts&"("&relatedShareNameses&")"
			             ...
			             sHtml = sHtml&"，"&shareTypeTexts&"("&relatedShareNameses&")"&label_683&">="&secLevelValues&label_18941
			        else   if shareTypeValues= "3" then
			                   sHtml = sHtml&"，"&shareTypeTexts&"("&relatedShareNameses&")"&label_683&">="&secLevelValues&label_18942
					       else  if shareTypeValues= "4" then
			                         sHtml = sHtml&"，"&shareTypeTexts&"("&relatedShareNameses&")"&label_3005&"="&rolelevelTexts&label_683&">="&secLevelValues&label_18945
						         else
...
sub onShowResourceRole(url,fieldid,type1,ismand,nowrow,nowcol,roleid)
    tmpids = document.all(fieldid).value

...
<script type="text/javascript" language="javascript" src="/workflow/request/jquery/jquery.js"></script>
<script type='text/javascript' language="javascript" src="/workflow/request/jquery/jquery.autocomplete.js"></script>
<link rel="stylesheet" type="text/css" href="/workflow/request/jquery/jquery.autocomplete.css" />
<%
		...
		<form>
			<table class=ViewForm>
				...
				<tr>
					...
					<td class=Field>
						<a href="#" onclick="clearResult()">清除结果</a>
					</td>
					<td class=Field>
						<a href="#" onclick="onConfirm()">确定</a>
					</td>
				</tr>
				<tr>

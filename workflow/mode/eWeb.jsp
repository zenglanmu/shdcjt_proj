    ...
    if(currentver>systemver){
        if(language==8){
            alert("Warning:Your machine's Report editor edition is higher than the server edition, can't Save the works!");
             ...
             alert("警告：本機插件版本高於服務器版本，不能對模版進行保存！"); 
        }
        else{
            alert("警告：本机插件版本高于服务器版本，不能对模版进行保存！");
        }
        return;
    }
    if(currentver<systemver){
        if(language==8){
            alert("Warning:Your machine's Report editor edition is lower than the server edition, can't Save the works!");
             ...
             alert("警告：本機插件版本低於服務器版本，不能對模版進行保存！"); 
        }
        else{
            alert("警告：本机插件版本低于服务器版本，不能对模版进行保存！");
        }
        return;
    }
...
<TABLE class="cbToolbar" id="idTBGeneral" cellpadding='0' cellspacing='0' width="100%">
	<TR>
	<TD NOWRAP><A class=tbButton id=cmdFileNew <%if(languageid==8){%>title=New<%}else{%>title=新建<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/new.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdFileOpen <%if(languageid==8){%>title="Open File"<%}else{%>title=打开文档<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/open.gif" width="16" height="16"></A></TD>
    <TD NOWRAP><A class=tbButton id=StyleCheck <%if(languageid==8){%>title="Format Check"<%}else{%>title=模版格式检查<%}%> href="#" onclick="mnuStyleCheck_click()"><IMG align=absMiddle src="/images/icon_balancelist.gif" width="16" height="16"></A></TD>
    <TD NOWRAP><A class=tbButton id=CMDFILESAVEAS <%if(languageid==8){%>title="Save As"<%}else{%>title=保存到本地<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/savexml.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A  id=testsave href="#" <%if(languageid==8){%>title="Save"<%}else{%>title="保存到服务器"<%}%> onclick="testSave()" ><IMG align=absMiddle src="images/save.gif" width="16" height="16"></A></TD>
	<!--TD NOWRAP><A class=tbButton id=cmdFilePrintPaperSet title=打印页设置 href="#" name=cbButton><IMG align=absMiddle src="images/printpapaerset.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdFilePrintSetup title=打印设置 href="#" name=cbButton><IMG align=absMiddle src="images/printsetup.gif" width="16" height="16"></A></TD-->
	<TD NOWRAP><A class=tbButton id=cmdFilePrint <%if(languageid==8){%>title=Print<%}else{%>title=打印<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/print.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdFilePrintPreview <%if(languageid==8){%>title="Print View"<%}else{%>title=打印预览<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/printpreview.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdEditCut <%if(languageid==8){%>title=Cut<%}else{%>title=剪切<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/cut.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdEditCopy <%if(languageid==8){%>title=Copy<%}else{%>title=复制<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/copy.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdEditPaste <%if(languageid==8){%>title=Paste<%}else{%>title=粘贴<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/paste.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdEditFind <%if(languageid==8){%>title=Find<%}else{%>title=查找<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/find.gif" width="16" height="16"></A></TD>
	<!--TD NOWRAP><A class=tbButton id=cmdEditUndo title=撤消 href="#" name=cbButton><IMG align=absMiddle src="images/undo.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdEditRedo title=重做 href="#" name=cbButton  sticky="true"><IMG align=absMiddle src="images/redo.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdStatWizard title=报表统计向导 href="#" name=cbButton><IMG align=absMiddle src="images/databasewizard.gif" width="16" height="16"></A></TD>
	...
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdUserFunctionGuide title=自定义函数向导 href="#" name=cbButton><IMG align=absMiddle src="images/formulaS.gif" width="16" height="16"></A></TD-->
	
	<!--TD NOWRAP><A class=tbButton id=cmdChartWzd title=图表向导 href="#" name=cbButton><IMG align=absMiddle src="images/chartw.gif" width="16" height="16"></A></TD-->
	<TD NOWRAP><A class=tbButton id=cmdInsertPic <%if(languageid==8){%>title="Insert Floating Pic"<%}else{%>title=插入浮动图片<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/insertpic.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdInsertCellPic <%if(languageid==8){%>title="Insert Cell Pic"<%}else{%>title=插入单元图片<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/insertcellpic.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdHyperlink <%if(languageid==8){%>title="URL"<%}else{%>title=超级链接<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/hyperlink.gif" width="16" height="16"></A></TD>
    <TD NOWRAP id="cmdBoderType" <%if(languageid==8){%>title="Border Type"<%}else{%>Title="边框类型"<%}%>>
    ...
    <TD NOWRAP id="cmdDrawColor" <%if(languageid==8){%>title="Border Color"<%}else{%>Title="框线颜色"<%}%>>
    ...
    <TD NOWRAP id="cmdDrawType" <%if(languageid==8){%>title="Draw Border Type"<%}else{%>Title="画边框类型"<%}%>>
    ...
    <TD NOWRAP><A class=tbButton id=cmdDrawBorder <%if(languageid==8){%>title="Draw Border"<%}else{%>title=画边框线<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/border.gif" width="16" height="16"></A></TD>
    <TD NOWRAP id="cmdEraseType" <%if(languageid==8){%>title="Erase Border Type"<%}else{%>Title="抹边框类型"<%}%>>
	...
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdEraseBorder <%if(languageid==8){%>title="Erase Border"<%}else{%>title=抹边框线<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/erase.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="100%"></TD>
	</TR>
</TABLE>
<TABLE class="cbToolbar" id="idTBFormat" cellpadding='0' cellspacing='0' width="100%">
	<TR>
	<TD NOWRAP id="cmdFontName" <%if(languageid==8){%>title="Font"<%}else{%>Title="字体"<%}%>>
		<SELECT name="FontNameSelect" style="WIDTH: 225px; HEIGHT: 23px" onChange="changeFontName(FontNameSelect.value)" ACCESSKEY="v" size="1">
        &nbsp; </SELECT>
	</TD>
	<TD NOWRAP class="tbDivider" id="cmdFontSize" <%if(languageid==8){%>title="Font Size"<%}else{%>Title="字号"<%}%>>
	...
	<TD NOWRAP><A class=tbButton id=cmdBold <%if(languageid==8){%>title="Bold"<%}else{%>title=粗体<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/bold.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdItalic <%if(languageid==8){%>title="Italic"<%}else{%>title=斜体<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/italic.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdUnderline <%if(languageid==8){%>title="Underline"<%}else{%>title=下划线<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/underline.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdBackColor <%if(languageid==8){%>title="Background Color"<%}else{%>title=背景色<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/backcolor.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdForeColor <%if(languageid==8){%>title="Font Color"<%}else{%>title=前景色<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/forecolor.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdWordWrap <%if(languageid==8){%>title="Auto Wrap"<%}else{%>title=自动折行<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/wordwrap.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdAlignLeft <%if(languageid==8){%>title="Flush Left"<%}else{%>title=居左对齐<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/alignleft.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdAlignCenter <%if(languageid==8){%>title="Flush Center"<%}else{%>title=居中对齐<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/aligncenter.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdAlignRight <%if(languageid==8){%>title="Flush Right"<%}else{%>title=居右对齐<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/alignright.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdAlignTop <%if(languageid==8){%>title="Flush Top"<%}else{%>title=居上对齐<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/aligntop.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdAlignMiddle <%if(languageid==8){%>title="Flush Middle"<%}else{%>title=垂直居中<%}%> href="#" name=cbButton  sticky="true"><IMG align=absMiddle src="images/alignmiddle.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdAlignBottom <%if(languageid==8){%>title="Flush Bootom"<%}else{%>title=居下对齐<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/alignbottom.gif" width="16" height="16"></A></TD>
    <TD NOWRAP><A class=tbButton id=cmdFinanceType <%if(languageid==8){%>title="Finance Show"<%}else{%>title=财务表览<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/finance.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdFinanceHeaderType <%if(languageid==8){%>title="Finance Header"<%}else{%>title=财务表头<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/financeheader.gif" width="16" height="16"></A></TD>
    <TD class="tbDivider" NOWRAP width="100%"></TD>
	</TR>
</TABLE>
<TABLE class="cbToolbar" id="idTBDesign" cellpadding='0' cellspacing='0' width="100%">
	<TR>    
	<TD NOWRAP width="21"><A class=tbButton id=cmdInsertCol <%if(languageid==8){%>title="Insert Col"<%}else{%>title=插入列<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/insertcol.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdInsertRow <%if(languageid==8){%>title="Insert Row"<%}else{%>title=插入行<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/insertrow.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdInsertCell <%if(languageid==8){%>title="Insert Cell"<%}else{%>title=插入单元<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/insertcell.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP width="21"><A class=tbButton id=cmdDeleteCell <%if(languageid==8){%>title="Del Cell"<%}else{%>title=删除单元<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/deletecell.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdDeleteCol <%if(languageid==8){%>title="Del Col"<%}else{%>title=删除列<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/deletecol.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdDeleteRow <%if(languageid==8){%>title="Del Row"<%}else{%>title=删除行<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/deleterow.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP width="21"><A class=tbButton id=cmdMaxRowCol <%if(languageid==8){%>title="Max Col"<%}else{%>title=设置表格行列数<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/sheetsize.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdMergeCell <%if(languageid==8){%>title="Merge Cell"<%}else{%>title=组合单元格<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/mergecell.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP width="21"><A class=tbButton id=cmdUnMergeCell <%if(languageid==8){%>title="UnMerge Cell"<%}else{%>title=取消单元格组合<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/unmergecell.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdReCalcAll <%if(languageid==8){%>title="Recalculation"<%}else{%>title=重算计算全表<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/calculateall.gif" width="16" height="16"></A></TD>
	<TD NOWRAP width="21"><A class=tbButton id=cmdFormProtect <%if(languageid==8){%>title="Form Protect"<%}else{%>title=设置/取消整表保护<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/formprotect.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP width="21"><A class=tbButton id=cmdReadOnly <%if(languageid==8){%>title="Read Only"<%}else{%>title=单元格只读<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/readonly.gif" width="16" height="16"></A></TD>
    <TD NOWRAP><A class=tbButton id=cmdFormulaSumH <%if(languageid==8){%>title="SumH"<%}else{%>title=水平求和<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/sumh.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdFormulaSumV <%if(languageid==8){%>title="SumV"<%}else{%>title=垂直求和<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/sumv.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdFormulaSumHV <%if(languageid==8){%>title="SumHV"<%}else{%>title=双向求和<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/sum.gif" width="16" height="16"></A></TD>
    <TD class="tbDivider" NOWRAP><A class=tbButton id=SETCCINCELLS <%if(languageid==8){%>title="no-main cell of combined cell attend calculate"<%}else{%>title=组合单元中的非主单元参于计算<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/sumcell.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdCurrency <%if(languageid==8){%>title="￥"<%}else{%>title=货币符号<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/currency.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdPercent <%if(languageid==8){%>title="％"<%}else{%>title=百分号<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/percent.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdThousand <%if(languageid==8){%>title="，"<%}else{%>title=千分位<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/thousand.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdShowGridline <%if(languageid==8){%>title="Grid Line"<%}else{%>title=显示/隐藏背景表格线<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/gridline.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdShowHeader <%if(languageid==8){%>title="Form Header"<%}else{%>title=显示/隐藏系统表头<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/header.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdShape3D <%if(languageid==8){%>title="Shape 3D"<%}else{%>title=设置/取消单元3维显示<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/shape3D.gif" width="16" height="16"></A></TD>
	<TD NOWRAP><A class=tbButton id=cmdRowLabel <%if(languageid==8){%>title="Row Label"<%}else{%>title=设置/取消行表头<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/rowlabel.gif" width="16" height="16"></A></TD>
	<TD class="tbDivider" NOWRAP><A class=tbButton id=cmdColLabel <%if(languageid==8){%>title="Col Label"<%}else{%>title=设置/取消列表头<%}%> href="#" name=cbButton><IMG align=absMiddle src="images/collabel.gif" width="16" height="16"></A></TD>
	
    <TD class="tbDivider" NOWRAP><A class=tbButton id=delaxtive href="#" <%if(languageid==8){%>title="Del Fields"<%}else{%>title="删除字段"<%}%> onclick="deleteA()" ><IMG align=absMiddle src="/images/BacoCross.gif" width="13" height="13"></A></TD>
	<TD NOWRAP width="100%"></TD>
	</TR>
</TABLE>
</div>

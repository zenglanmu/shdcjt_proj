...
String needfav = "1" ;
String needhelp = "" ; 
String userRights=shareRights.getUserRights("-5",user);//得到用户查看范围
...
<%
    ...
    String maxTime=Util.null2String(request.getParameter("maxTime"));//得到搜索条件
...
<!--详细内容在此-->
  ...
  <TD><%=SystemEnv.getHtmlLabelName(1335,user.getLanguage())%></TD><!--当前状况-->
  <TD><%=SystemEnv.getHtmlLabelName(16354,user.getLanguage())%></TD><!--未操作者-->

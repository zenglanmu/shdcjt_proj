...
String sqlWhere = sqlwhere+" and exists (select 1 from workflow_base where workflow_base.id=a.workflowid and isvalid='1')";
//out.print("select "+backfields + "from "+fromSql+" where "+sqlWhere);
String para4=user.getLanguage()+"+"+user.getUID();
tableString =   " <table instanceid=\"workflowRequestListTable\" tabletype=\""+gridTabletype+"\" pagesize=\""+perpage+"\" >"+

...
function actionit(id){
    ...
    if(xmlHttp.readyState == 4){
        ...
        // ...processing statements go here...
            if(showstr && ob.src.match("notimportent.gif")){
                ob.src="/cowork/images/importent.gif";
                ob2.title = "<%=SystemEnv.getHtmlLabelName(19781,user.getLanguage())%>";
            }else if(showstr && ob.src.match("importent.gif")){
                ob.src="/cowork/images/notimportent.gif";

                    ...
                    <tr>
                      <td valign="top">
				                    ...
				                    <tr>
				                      ...
				                      <td class="field">
											...
											<select name="intervalType" id="intervalType">
												<option value="d" <%if("d".equals(intervalType)||"".equals(intervalType)) out.println(" selected "); %>>日</option>
												<option value="m" <%if("m".equals(intervalType)) out.println(" selected "); %>>月</option>
												<option value="y" <%if("y".equals(intervalType)) out.println(" selected "); %>>年</option>
											</select>
									  </td>
				                     </tr>
				                     <TR style="height: 1px"><TD class=Line colspan=2></TD></TR> 
				                      ...
				                      <td>未更新类型</td>
				                      	<td class="field">
											<select name="jointype" id="jointype"> 
												<option value="principal" <%if("principal".equals(jointype)||"".equals(jointype)) out.println(" selected "); %>>负责人未更新</option>
												<option value="part" <%if("part".equals(jointype)) out.println(" selected "); %>>参与人未更新</option>
											 </select>											
										</td>
				                     </tr>
                            ...
                            String tableString =" <table tabletype=\"none\" pagesize=\"15\" >"+
                                                 ...
                                                 "			<head>"+
                                                 "				<col width=\"15%\"  text=\"分部\" column=\"principal\" transmethod=\"weaver.splitepage.transform.SptmForCowork.getSubCompanyName\"/>"+
                                                 "				<col width=\"15%\"  text=\"部门\" column=\"principal\" transmethod=\"weaver.splitepage.transform.SptmForCowork.getDepateName\"/>"+
                                                 "				<col width=\"10%\"  text=\"负责人\" column=\"principal\" href =\"/hrm/resource/HrmResource.jsp?\" linkkey=\"id\" linkvaluecolumn=\"principal\"  transmethod=\"weaver.hrm.resource.ResourceComInfo.getLastnames\"/>"+
                                                 "				<col width=\"25%\" text=\"协作名称\" column=\"name\" href =\"/cowork/ViewCoWork.jsp?view=yes\"  linkkey=\"id\" linkvaluecolumn=\"id\" target=\"_fullwindow\"/>"+
                                                 "				<col width=\"15%\" text=\"协作类型\" column=\"typeid\" transmethod=\"weaver.cowork.CoTypeComInfo.getCoTypename\"/>"+
                                                 "				<col width=\"20%\"  text=\"最后更新时间\" orderkey=\"c2.createdate\"  column=\"createdate\" />"+
                                                 "			</head>"+    			
                                                 "</table>"; 
                          %> 

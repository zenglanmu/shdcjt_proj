...
<TABLE class=viewform width=100% id=oTable1 height=32px border=1>
  ...
  <tr>
	  ...
	  if(firsttype==0){
	  %>
	  <td nowrap name="oTDtype_<%=typetotal%>"  id="oTDtype_<%=typetotal%>" background="/cowork/images/bglight.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,0)" ><b><%=SystemEnv.getHtmlLabelName(332,user.getLanguage())%></b></td>
	 <%}else{%>
	 <td nowrap name="oTDtype_<%=typetotal%>" id="oTDtype_<%=typetotal%>"  background="/cowork/images/bgdark.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,0)"><b><%=SystemEnv.getHtmlLabelName(332,user.getLanguage())%></b></td>
	 <%}
	  ...
	  if(isworkflow==1){
	  %>
	  <td nowrap name="oTDtype_<%=typetotal%>"  id="oTDtype_<%=typetotal%>" background="/cowork/images/bglight.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,-2)" ><b><%=SystemEnv.getHtmlLabelName(2118,user.getLanguage())%></b></td>
	 <%}else{%>
	 <td nowrap name="oTDtype_<%=typetotal%>" id="oTDtype_<%=typetotal%>"  background="/cowork/images/bgdark.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,-2)"><b><%=SystemEnv.getHtmlLabelName(2118,user.getLanguage())%></b></td>
	 <%}
	  //typetotal++;
	  ...
	  %>
	  <td nowrap name="oTDtype_<%=typetotal%>"  id="oTDtype_<%=typetotal%>" background="/cowork/images/bglight.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,<%=RecordSet.getString("id")%>)" ><b><%=RecordSet.getString("typename")%></b></td>
	  <%
	  isfirst=1;
	  }else{
	  %> <td nowrap name="oTDtype_<%=typetotal%>" id="oTDtype_<%=typetotal%>"  background="/cowork/images/bgdark.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,<%=RecordSet.getString("id")%>)"><b><%=RecordSet.getString("typename")%></b></td>
	...
	<%if(hasexact==1){
	   ...
	   typetotal++;
	   %>
	 <td nowrap name="oTDtype_<%=typetotal%>" id="oTDtype_<%=typetotal%>"  background="/cowork/images/bgdark.gif" width=70px height=100% align=center onmouseover="style.cursor='hand'" onclick="resetbanner(<%=typetotal%>,-1)"><b><%=SystemEnv.getHtmlLabelName(17693,user.getLanguage())%></b></td>
	 <%}%>

...
$(document).ready(function(){//DOM的onload事件
    ...
    $.post("CoworkListInit.jsp?"+paramStr,{total:<%=total%>,index:index,pagesize:index,disdirect:disdirect,disattention:disattention},function(data){//利用jquery的get方法得到table.html内容

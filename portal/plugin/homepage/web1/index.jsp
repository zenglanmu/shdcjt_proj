 ...
 Date newdate = new Date() ;
	...
	if(rsExtend.next()){
		...
		if(!"".equals(flash1)) {
			...
			flashList.add("/portal/plugin/homepage/web1/images/flash.jpg");
			out.println("arrayFlash.push('/portal/plugin/homepage/web1/images/flash.jpg');");
		}
		if(!"".equals(flash2)) {
	...
	if ("".equals(logo))	logo="images/logo.jpg";
	if ("".equals(navimg))	navimg="images/nav.jpg";
...
<HTML>
 <HEAD>
  <TITLE><%=templateTitle%></TITLE>
	<link href="/portal/plugin/homepage/web1/main.css" type=text/css rel=stylesheet>
						...
						if(isMultilanguageOK){
							...
							if(user.getLanguage()==8){
								if(twlanguage.equals("1")){
									out.println("<a href=\"index.jsp?lang=tw&leftmenuid="+leftid+"&from="+from+"&userSubcompanyId="+userSubcompanyId+"\">繁体中文</a>");
								}else {
									out.println("<a href=\"index.jsp?lang=cn&leftmenuid="+leftid+"&from="+from+"&userSubcompanyId="+userSubcompanyId+"\">简体中文</a>");
								}
...
<!--签退 -->
				...
				<% }%>
					...
					<img src="images/search.jpg" style="cursor:hand" align="absmiddle" border=0 onclick="frmSearch.submit();">				
			...
			<div style="border-top: 1px solid #CACACA;">				
				<table width="100%">
					...
					<tr style="background:#EFEFEF;">
						<td width=80%>
							&nbsp;&nbsp;<a href="#">在线帮助</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">联系我们</a>&nbsp;&nbsp;|&nbsp;&nbsp; <a href="#">隐私保障</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#">链接</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="#">酒店管理</a>&nbsp;&nbsp;|&nbsp;&nbsp;
						</td>
						<td width=20%>
							<img align=absmiddle width=25px src="http://www.jinjianghotels.com/portal/cn/images/link01.gif">&nbsp;&nbsp; <img align=absmiddle width=25px src="http://www.jinjianghotels.com/portal/cn/images/link02.gif">&nbsp;&nbsp; <img align=absmiddle width=25px src="http://www.jinjianghotels.com/portal/cn/images/link03.gif">&nbsp;&nbsp; <img align=absmiddle width=25px src="http://www.jinjianghotels.com/portal/cn/images/link04.gif">
						</td>
					</tr>
...
img.src="/login/images/welcome.gif"; 
} 
function oe() 
{ 
} 

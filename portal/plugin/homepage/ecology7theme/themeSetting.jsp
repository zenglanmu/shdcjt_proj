							...
							<tr>
								<td valign="top">
									...
									.getHtmlLabelName(91, user.getLanguage())%></button>
														...
														<tr>
															<td valign="top">
																左侧菜单（图片需要保存后，方能看到效果，保存后会替换原有图片，请提前备份）
															</td>
																		...
																		<td valign="top">
																			<TABLE class=ViewForm>
																				...
																				<tr>
																					...
																					<td class=Field valign="top">
																						左：<input type="text" name="drillcrumb_border_left" value="<%=drillcrumb_border_left %>" size="6" onchange="leftPriview(this.value, '#drillcrumb', 'border-left');">
																						<br>
																						上：<input type="text" name="drillcrumb_border_top" value="<%=drillcrumb_border_top %>" size="6" onchange="leftPriview(this.value, '#drillcrumb', 'border-top');">
																						<br>
																						右：<input type="text" name="drillcrumb_border_right" value="<%=drillcrumb_border_right %>" size="6" onchange="leftPriview(this.value, '#drillcrumb', 'border-right');">
																						<br>
																						下：<input type="text" name="drillcrumb_border_bottom" value="<%=drillcrumb_border_bottom %>" size="6" onchange="leftPriview(this.value, '#drillcrumb', 'border-bottom');">
																					</td>
																				</tr>
																				...
																				<tr>
																					...
																					<td class=Field valign="top">
																						左：<input type="text" name="leftMenuBottomNavTbl_left" value="<%=leftMenuBottomNavTbl_left %>" size="6" onchange="leftPriview(this.value, '.leftmenubottomnavtbl', 'border-left');">
																						<br>
																						上：<input type="text" name="leftMenuBottomNavTbl_top" value="<%=leftMenuBottomNavTbl_top %>" size="6" onchange="leftPriview(this.value, '.leftmenubottomnavtbl', 'border-top');">
																						<br>
																						右：<input type="text" name="leftMenuBottomNavTbl_right" value="<%=leftMenuBottomNavTbl_right %>" size="6" onchange="leftPriview(this.value, '.leftmenubottomnavtbl', 'border-right');">
																						<br>
																						下：<input type="text" name="leftMenuBottomNavTbl_bottom" value="<%=leftMenuBottomNavTbl_bottom %>" size="6" onchange="leftPriview(this.value, '.leftmenubottomnavtbl', 'border-bottom');">
																					</td>
																				</tr>

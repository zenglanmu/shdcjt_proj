...
<%
	...
	if ("ecology7".equals(theme)) {
		...
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftBlockTopBgLeft"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftBlockTopBgLeft.jpg");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftBlockTopBgCenter"))),    "/wui/theme/ecology7/skins/" + skin + "/page/left/leftBlockTopBgCenter.jpg");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftBlockTopBgRight"))),      "/wui/theme/ecology7/skins/" + skin + "/page/left/leftBlockTopBgRight.jpg");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftBlockHrmInfoBgLeft"))),  "/wui/theme/ecology7/skins/" + skin + "/page/left/leftBlockHrmInfoBgLeft.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftBlockHrmInfoBgCenter"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftBlockHrmInfoBgCenter.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftBlockHrmInfoBgRight"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftBlockHrmInfoBgRight.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuBottomLeft"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuBottomLeft.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuBottomCenter"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuBottomCenter.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuBottomRight"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuBottomRight.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuItemLeft"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuItemLeft.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuItemCenter"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuItemCenter.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuItemRight"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuItemRight.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuItemNavLeft"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuItemNavLeft.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuItemNavCenter"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuItemNavCenter.png");
		copyFile(getBgImageRealAddr(hpsu, Util.null2String(fu.uploadFiles("leftMenuItemNavRight"))), "/wui/theme/ecology7/skins/" + skin + "/page/left/leftMenuNavRight.png");
		...
		writerCss(projectPath + "wui/theme/ecology7/skins/" + skin + "/page/left.css", cssString);
	}
...
*/
		...
		*/
		...
		String sql="update extandHpThemeItem set " + fieldname + "='' where extandHpThemeId=(select id from extandHpTheme where templateId=" +templateId+" and subCompanyId="+subCompanyId + ") and theme='" + theme + "' and skin='" + skin + "'";	

...
function fontDetecion(what) {
  	...
  	if(!isExistOTF(fontName)) {
  		if(confirm(fontName + "不存在，是否下载安装?")){
  			alert("下载完毕！");
  		}
  	}
}
						...
						<%
							...
							<input type="hidden" name="extendHpSoft2Id"  value="<%=extendHpSoft2Id%>"/>
									...
									<tr>
										...
										<TR><TD class=Line colSpan=2></TD></TR>
										<tr>
											<td valign="top">左侧菜单外(上)(200*10)</td>
											<td class=Field>	
												<%if(ostimg.equals("")){%>
										...
										<TR><TD class=Line colSpan=2></TD></TR>
										<tr>
											<td valign="top">左侧菜单外(下)(200*1)</td>
											<td class=Field>	
												<%if(osdimg.equals("")){%>
										...
										<TR><TD class=Line colSpan=2></TD></TR>
										<tr>
											<td valign="top">左侧菜单内(上)(180*6)</td>
											<td class=Field>	
												<%if(istimg.equals("")){%>
										...
										<TR><TD class=Line colSpan=2></TD></TR>
										<tr>
											<td valign="top">左侧菜单内(中)1(180*1)</td>
											<td class=Field>	
												<%if(iscimg1.equals("")){%>
													<img src="images/left-menu-bottom.png"/>
												<%}else{%>
										...
										<TR><TD class=Line colSpan=2></TD></TR>
										<tr>
											<td valign="top">左侧菜单内(中)2(180*1)</td>
											<td class=Field>	
												<%if(iscimg2.equals("")){%>
													<img src="images/left-menu-bottom.png"/>
												<%}else{%>
										...
										<TR><TD class=Line colSpan=2></TD></TR>
										<tr>
											<td valign="top">左侧菜单内(下)(180*6)</td>
											<td class=Field>	
												<%if(isdimg.equals("")){%>
													<img src="images/left-menu-bottom.png"/>
												<%}else{%>
										...
										<tr>
										    ...
										    <td class=Field>
												<select name="fontFamily" value="<%=fontFamily %>" size="1" onchange="fontDetecion(this)">
								                	<option value="微软雅黑" <%="微软雅黑".equals(fontFamily) ? " selected" : "" %> >微软雅黑</option>
													<option value="宋体"    <%="宋体".equals(fontFamily) ? " selected" : "" %>>宋体</option>
													<option value="方正" <%="方正".equals(fontFamily) ? " selected" : "" %>>方正</option>
								     			</select>
										  	</td>
										</tr>

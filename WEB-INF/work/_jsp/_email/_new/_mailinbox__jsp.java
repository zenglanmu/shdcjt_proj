...
if(userLayout==1){
 ...
 if(!mailid.equals("")){
	 url = "/email/new/MailView.jsp?mailid="+mailid;
      ...
      out.print((SystemEnv.getHtmlLabelName(19851,user.getLanguage()) ));
      out.write(_jsp_string48, 0, _jsp_string48.length);
      out.print((SystemEnv.getHtmlLabelName(20825,user.getLanguage()) ));
      out.write(_jsp_string49, 0, _jsp_string49.length);
      out.print((SystemEnv.getHtmlLabelName(19852,user.getLanguage()) ));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("email/new/MailInBox.jsp"), 2798550516934274012L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  ...
  static {
    ...
    _jsp_string59 = "\r\n			addTab(\"1\",\"/email/new/MailAdd.jsp?isInternal=".toCharArray();
    _jsp_string5 = "\");\r\nwindow.top.location=\"/login/Login.jsp\";\r\n</script>\r\n".toCharArray();
    _jsp_string49 = "\" style=\"width:28px;height:22px;\">\r\n		</div>\r\n		<div class=\"left hand layout\" type=\"pp\" value=\"3\" title=\"".toCharArray();
    _jsp_string21 = "\uff01\");\r\n						return false;\r\n					}\r\n				}\r\n			}\r\n		}\r\n	}\r\n	return true;\r\n}\r\n\r\nfunction isdel(){\r\n	var str = \"".toCharArray();
    ...
    _jsp_string57 = "',title:'".toCharArray();
    _jsp_string13 = "';\r\n	   \r\n	    			return false;\r\n	    		}\r\n	    		flag_msg += '\\r\\n\\r\\n".toCharArray();
    _jsp_string24 = "\";\r\n  var str1 = \"".toCharArray();
    _jsp_string50 = "\" style=\"width:28px;height:22px;\">\r\n		</div>\r\n	</div>\r\n	\r\n".toCharArray();
    _jsp_string27 = ";\r\nusbusercode0 = ".toCharArray();
    _jsp_string60 = "\",\"".toCharArray();
    _jsp_string58 = "',html:jcTabs[0],closable: false}\r\n        ]\r\n    }); \r\n    \r\n	".toCharArray();
    _jsp_string61 = "\");\r\n			\r\n	".toCharArray();
    ...
    _jsp_string22 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();
    _jsp_string9 = "&time=\"+new Date();\r\n	    xmlhttp.open(\"GET\",URL, false);\r\n	    xmlhttp.send(null);\r\n	    var result = xmlhttp.status;\r\n	    if(result==200) {\r\n		    isconn = true;\r\n	    	var response_flag = xmlhttp.responseText;\r\n	    	if(response_flag!='0') {\r\n	    		var flag_msg = '';\r\n	    		if(response_flag=='1') {\r\n	    			var diag = new Dialog();\r\n					diag.Width = 300;\r\n					diag.Height = 180;\r\n					diag.ShowCloseButton=false;\r\n					diag.Title = \"".toCharArray();
    _jsp_string10 = "\";\r\n					//diag.InvokeElementId=\"pageOverlay\"\r\n					diag.URL = \"/wui/theme/ecology7/page/loginSmall.jsp?username=".toCharArray();
    _jsp_string48 = "\" style=\"width:28px;height:22px;\">\r\n		</div>\r\n		<div class=\"left hand layout\" type=\"zy\" value=\"2\" title=\"".toCharArray();
    _jsp_string17 = "')) {\r\n				    lenck = false;\r\n				    break;\r\n			    }\r\n		    }\r\n		    if(lenck==false) return false;\r\n	    }\r\n	    catch(e) {}\r\n	    ".toCharArray();
    _jsp_string40 = ",transition=".toCharArray();
    _jsp_string39 = "\" content=\"revealTrans(duration=".toCharArray();

...
if(rtxClient.isValidOfRTX() && rtxOnload){
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("wui/common/page/mainPlugins.jsp"), 5503874797540642723L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    ...
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("systeminfo/template/templateCss.jsp"), -7924568173384323303L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    ...
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("favourite/FavouriteShortCut.jsp"), 4102938065892929606L, false);
    com.caucho.jsp.JavaPage.addDepend(_caucho_depends, depend);
  }
  ...
  static {
    _jsp_string80 = "\", \"\", \"toolbar,resizable,scrollbars,dependent,height=600,width=800,top=0,left=100\") ; \r\n   if(voteids == \"\"){\r\n      voteids = '".toCharArray();
    _jsp_string103 = "\";\r\nvar password = \"".toCharArray();
    _jsp_string117 = "\",null);\r\n				mItem.target = \"\";\r\n				menu_".toCharArray();
    _jsp_string42 = "\";\r\n//\u5f53\u524d\u4e3b\u9898\u4f7f\u7528\u7684\u76ae\u80a4\r\nvar GLOBAL_SKINS_FOLDER = \"".toCharArray();
    _jsp_string79 = " \r\n<script language=javascript> \r\n    //window.open(\"/voting/VotingPoll.jsp?votingid=".toCharArray();
    ...
    _jsp_string136 = "\" style=\"display:none\"></iframe>\r\n".toCharArray();
    ...
    _jsp_string108 = "\",\"/favourite/ManageFavourite.jsp\");\r\nmItem.target = \"mainFrame\";\r\nmenu.add(mItem);\r\nmenu.add( new MenuSeparator() );\r\n".toCharArray();
    ...
    _jsp_string29 = "\r\n\r\n<!--WUI -->\r\n".toCharArray();
    _jsp_string114 = "\",\"\",\"/images/folder.small.png\",menu_".toCharArray();
    _jsp_string20 = "\";\r\n   if(!confirm(str)){\r\n       return false;\r\n   }\r\n       return true;\r\n } \r\n\r\nfunction issubmit(){\r\n	var str = \"".toCharArray();

...
var B = "ÈÕÒ»¶þÈýËÄÎåÁùÆß°Ë¾ÅÊ®";
var O = "ÊóÅ£»¢ÍÃÁúÉßÂíÑòºï¼¦¹·Öí";
var K = "¼×ÒÒ±û¶¡Îì¼º¸ýÐÁÈÉ¹ï";
var J = "×Ó³óÒúÃ®³½ËÈÎçÎ´ÉêÓÏÐçº¥";
...
function U(Y) {
        ...
        this.solarWeekDayInChinese = "ÐÇÆÚ" + B.charAt(this.solarWeekDay);
        var X = new C(Y);

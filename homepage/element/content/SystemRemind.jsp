	 ...
	 <TD width='*' valign="top">
		...
		<TABLE width="100%">   	
		 ...
		 %>
		  <TR  height=18px>
			...
			<TD  width="80px" ><%=hpu.getLinkStr("/homepage/element/more/wfCenterMore.jsp?eid="+eidData+"&viewtype=0","未读（"+spu1.getRecordCount()+"）个",linkmode)%></TD>
			<TD  width="80px" align="right"><%=hpu.getLinkStr("/homepage/element/more/wfCenterMore.jsp?eid="+eidData+"","共（"+spu.getRecordCount()+"）个",linkmode)%></TD>
		  </TR>         
		...
		<%}%>
		  <TR  height=18px>
 			<TD width="8px"><%=imgSymbol%></TD>
			<TD width="*">在线人数</TD>
			<TD  width="80px" ><%=hpu.getLinkStr("/hrm/resource/OnlineUser.jsp","共("+onlineuserids.size()+")人",linkmode)%></TD>

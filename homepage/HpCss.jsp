...
<style type="text/css" id="styleMenu">
		.navigate{
			...
			if("".equals(backgroundImg)){
				out.println("background:"+backgroudColor+";       /*±³¾°É«*/");
			} else {
				out.println("background:url('"+backgroundImg+"');");
				//out.println("background:"+navbgcolor+";       /*±³¾°É«*/");
			}				
			%>
		...
		.divMenu {   		
			...
			border-right-color:<%=navbordercolor%>;/*±ß¿òÑÕÉ«*/
			position:		relative;
			height:16;
			_height:28;
			<%
		...
		.divMenuSelected {
			...
			if("".equals(navselectedbackgroudimg)){
				out.println("background:"+navselectedbgcolor+";       /*±³¾°É«*/");
			} else {
		...
		.divSubMenu {   
			...
			if("".equals(subnavbackgroudimg)){
				out.println("background:"+subnavbgcolor+";       /*±³¾°É«*/");
			} else {
		...
		.divSubMenuSelected {
			...
			if("".equals(subnavselectedbackgroudimg)){
				out.println("background:"+subnavselectedbgcolor+";       /*±³¾°É«*/");
			} else {

...
<HTML>
	<HEAD>
		...
		<LINK REL=stylesheet type="text/css" HREF="/js/jquery/plugins/weavertabs/weavertabs.css">
		<SCRIPT language="javascript" src="../../js/weaver.js"></script>
		<SCRIPT language="javascript" src="/js/jquery/jquery.js"></script>
		<SCRIPT type="text/javascript"
			src="/js/jquery/plugins/weavertabs/jquery.weavertabs.js"></script>
		<script type="text/javascript">
			function weaverTabsData(id)
			{
				...
				if(content=="")
				{
					$("#"+id).html("<img src=/images/loading2.gif>&nbsp;<%=SystemEnv.getHtmlLabelName(19819, user.getLanguage())%>...");
										...
										<tr>
											...
											<td class=Field>
												<input type="radio" name="customModule" value="1"
													onClick="onChangeModule(this);" checked><%=SystemEnv.getHtmlLabelName(58, user.getLanguage())%>
												<input type="radio" name="customModule" value="2"
													onClick="onChangeModule(this);"><%=SystemEnv.getHtmlLabelName(18015, user.getLanguage())%>
												<input type="radio" name="customModule" value="3"
													onClick="onChangeModule(this);"><%=SystemEnv.getHtmlLabelName(136, user.getLanguage())%>
												<input type="radio" name="customModule" value="4"
													onClick="onChangeModule(this);"><%=SystemEnv.getHtmlLabelName(101, user.getLanguage())%>
											</td>
										</tr>
										<TR style="height:1px;">
						...
						<tr>
							<td valign="top">
								<table width=100% class=ViewForm>
									...
									<TR>
										<TD width=25%><%=SystemEnv.getHtmlLabelName(23034, user.getLanguage())%></TD>
										<TD width=25%></TD>
										<TD width=15%></TD>
										<TD width=35%></TD>
									</TR>
		...
		if(li&&li.tagName=="LI")
		{
			...
			if(ul)
			{
				...
				if(style=="block"||style=="")
				{
					...
					image.src = "/images/messageimages/plus.gif";
				}
				else
				{
					ul.style.display = "block";
					image.src = "/images/messageimages/minus.gif";
				}
			}
		}
	}

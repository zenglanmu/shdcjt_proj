...
%>
			...
			<TR>
				...
				<%if(!"list".equals(from)){out.println("<IMG src='/images/BacoError.gif' align=absMiddle>");}%>
				</span>
				</TD>
			</TR>
						...
						<td width="90%" height="50px" style="border:1px solid #DBDBDB" valign=top>
							 <table>
                              <tr>
                                ...
                                <td><img src="/images/homepage/imgmode1.gif"><br><input type=radio value="1" <%=selected1%> name="mimgshowmode"><%=SystemEnv.getHtmlLabelName(599,user.getLanguage())%>1</td>
                                <td><img src="/images/homepage/imgmode2.gif"><br><input type=radio value="2" <%=selected2%> name="mimgshowmode"><%=SystemEnv.getHtmlLabelName(599,user.getLanguage())%>2</td>
                              </tr>
                              </table>
						</td>
						<td width="2%" rowspan="3">&nbsp;</td>

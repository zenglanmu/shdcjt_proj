...
<html>
	...
	<body>
		...
		<form name="frmmain" method="post" action="/formmode/interfaces/dmlaction/DMLActionSettingOperation.jsp" target="_self">
													...
													<table width="100%" class='ViewForm'>
														...
														<tbody>
															...
															<tr class="Title">
																...
																<th><%=SystemEnv.getHtmlLabelName(81345, user.getLanguage())%></th><!-- 模块主表字段 -->

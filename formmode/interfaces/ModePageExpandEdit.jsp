...
<%
	...
	String titlename = SystemEnv.getHtmlLabelName(30090,user.getLanguage()) + ":" + SystemEnv.getHtmlLabelName(93,user.getLanguage());
	String needfav ="1";
	String needhelp ="";
	...
	//if(!showcondition.equals("")){
		//showconditionspan = "<img src=\"/images/BacoCheck.gif\" border=\"0\" complete=\"complete\"/>";
	//}
		...
		<table class="ViewForm">
			...
			<tr>
				...
				<td class=Field>
					...
					%>
							...
							<!-- 
							<input class="inputstyle" type="checkbox" id="moniterpage" name="moniterpage" value="1" <%if(moniterpage==1)out.println("checked"); %>>监控页面
							 -->
					<%
						}
					%>
			...
			<tr>
				...
				<td class=Field>
					...
					<!-- 
					<br>
					填写对应的sql条件，如：当主字段a(数据库字段名)的值为3时，显示该按钮，那么写入a=3就可以
					<br>
					如果多个条件，则按照该方式填写 a=3 and b=4 and c=5
					 -->
				</td>
			</tr>
			<tr style="height:1px"><td colspan=4 class=Line></td></tr>
...
<script type="text/javascript">
    ...
    function onShowCondition(spanName){
    	...
    	if (typeof(datas)!="undefined"){
    	    if(datas!=""){
   		    	//$(spanName).html("<img src=\"/images/BacoCheck.gif\" border=\"0\" complete=\"complete\"/>");
    	    	$(spanName).html(datas);
    	    }else{
    			$(spanName).html("");
    		}

...
String titlename = SystemEnv.getHtmlLabelName(15101,user.getLanguage()) + ":" + SystemEnv.getHtmlLabelName(82,user.getLanguage());
String needfav ="1";
String needhelp ="";
				...
				<TBODY>
					...
					<TR>
		          		...
		          		<TD class=Field>
		        			<INPUT type=text class=Inputstyle size=30 maxlength="50" name="reportname" onchange='checkinput("reportname","reportnameimage")' value="">
		          			<SPAN id=reportnameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
		          		</TD>
		        	</TR>
		        	<TR style="height: 1px">
		    			<TD class="Line" colSpan=2 ></TD>
					...
					<TR>
						...
						<td class="Field">
					  		 ...
					  		 <SPAN id=reportnumperpageimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
						</td>
			        </TR>
			        <TR class="Spacing" style="height: 1px">
			    		<TD class="Line" colSpan=2 ></TD>

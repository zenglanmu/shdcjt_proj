...
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",/formmode/report/ReportEdit.jsp?id="+id+",_top} " ;
RCMenuHeight += RCMenuHeightStep;
%>
...
<tr>
  ...
  <TR>
      <TD>
      <%=SystemEnv.getHtmlLabelName(722,user.getLanguage())%>(modedatacreatedate)
    ...
    //System.out.println("select * from Workflow_ReportDspField where reportid="+id+" and fieldid=-2");
  ...
  <TR> 
      <TD>
      <%=SystemEnv.getHtmlLabelName(882,user.getLanguage())%>(modedatacreater)

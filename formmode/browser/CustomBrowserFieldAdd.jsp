...
String titlename = SystemEnv.getHtmlLabelName(30542,user.getLanguage()) + ":" + SystemEnv.getHtmlLabelName(30545,user.getLanguage());
String needfav ="1";
String needhelp ="";
...
<tr>
  ...
  <TABLE class="viewform">
    ...
    <TR class="Title"> 
      <TH colSpan=6><%=SystemEnv.getHtmlLabelName(20773,user.getLanguage())%><%=SystemEnv.getHtmlLabelName(261,user.getLanguage())%></TH>
    </TR>
...
function checkSame(){
	...
	if(!havetitle){
		alert("<%=SystemEnv.getHtmlLabelName(28501,user.getLanguage())%>!");
		return false;
	}

...
<%	
	...
	if(method.equals("clone")){
		String sInfoid = request.getParameter("sInfoid");
		...
		String sInfoid = request.getParameter("sInfoid");
		String tInfoid = request.getParameter("tInfoid");
		String subCompanyId = request.getParameter("subCompanyId");
		...
		rsMenu.executeSql(sql1);
		if(rsMenu.next()) parentId=Util.null2String(rsMenu.getString("parentid"));

...
<%
	...
	if(method.equalsIgnoreCase("maintenance")){		
		...
		response.sendRedirect("/formmode/menu/MenuMaintenanceList.jsp?menuflag="+menuflag+"&isCustom="+isCustom+"&type="+type+"&resourceType="+resourceType+"&resourceId="+resourceId);

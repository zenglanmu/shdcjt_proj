...
<%
	...
	else if("weavertabs-cus".equals(id))
	{
		...
		while(MenuCenterCominfo.next())
		{
			...
			sb.append("<li style=\"list-style-type: none;\"><img src=/images/messageimages/minus.gif><a style=\"color: #000;text-decoration: none;\" href=\"javascript:void(null);\" onclick=\"openNextUl(this);\">"+menuname+"</a>");

<%
    ...
    int type = weaver.general.Util.getIntValue(request.getParameter("type"),1);
    ...
    if(option.equals("selfield")){ 
    	...
    	System.out.println("selfield="+returnvalues);
    }
    if(option.equals("selfieldvalue")&&fieldId.indexOf("_")>-1){
    	...
    	System.out.println("selfieldvalue="+returnvalues);
    }

...
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(30215,user.getLanguage())+",javaScript:AddTreeNode(),_self} " ;
...
RCMenuHeight += RCMenuHeightStep;
RCMenu += "{"+SystemEnv.getHtmlLabelName(221,user.getLanguage())+",javaScript:doPreview(),_self} " ;
RCMenuHeight += RCMenuHeightStep;

				...
				<tr valign="top">
					...
					<td align="left" valign="top">
						<table cellpadding="0" cellspacing="2" border="0" width="100%">
							...
							<tr valign="top">
								<td width="100%">
									<button id="wfcreater" name="wfcreater" title="<%=SystemEnv.getHtmlLabelName(28597,user.getLanguage())%>" class="btn" onclick="insertMark(' $wfcreater$ ')" ><%=SystemEnv.getHtmlLabelName(28597,user.getLanguage())%></button>
								</td>
							</tr>
							<tr valign="top">
								<td width="100%">
...
function showEscPara(type){
	...
	if(type == 1){//sql
		...
		document.getElementById("sqloperationspan").innerHTML = "<img src=\"/images/BacoCheck.gif\" width=\"16\" height=\"16\" border=\"0\">";
	}else if(type == 2){//sum
		$("#currentuser").attr("disabled", true);
		$("#currentdept").attr("disabled", true);
		$("#wfcreater").attr("disabled", true);
		...
		document.getElementById("sumoperationspan").innerHTML = "<img src=\"/images/BacoCheck.gif\" width=\"16\" height=\"16\" border=\"0\">";
	}else if(type == 3){//date
		$("#currentuser").attr("disabled", true);
		$("#currentdept").attr("disabled", true);
		$("#wfcreater").attr("disabled", true);
		...
		$("#currentdate").attr("disabled", false);
		$("#id").attr("disabled", true);
		document.getElementById("dateoperationspan").innerHTML = "<img src=\"/images/BacoCheck.gif\" width=\"16\" height=\"16\" border=\"0\">";
	}

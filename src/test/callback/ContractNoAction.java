...
public class ContractNoAction implements Action
{
	...
	public ContractNoAction(String requestName)
	{
		super();
		this.requestName = requestName;
	}

	public ContractNoAction()
	{
		super();
	...
	public String execute(RequestInfo request)
	{
		...
		logBean.writeLog("调用"+requestName+"的formid = " + requestManager.getFormid() + "||RequestId = "
				+ requestid);

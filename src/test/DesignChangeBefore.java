 ...
 * 
 */
public class DesignChangeBefore
{
	...
	public void execute()
	{
		...
		{
			System.out.println("==========设计变更（事前）=============");
			System.out.println("======connection success======");
			JCO.Repository myRepository = new JCO.Repository("Repository", myConnection); // 活动的连接
			IFunctionTemplate ft = myRepository.getFunctionTemplate("ZDC_CO_REV_S"); // 获取设计变更模板
			...
			List<Column> basicContractColLs = Arrays.asList(new Column[] { new Column(DB_KEY, ""),
					new Column("REVISIONNO", ""), new Column("EXREVINNO", ""), new Column("POST1", ""),
					new Column("SUBPROJ", ""), new Column("ESTCURR", ""), new Column("REVICURR", ""),
			...
			List<Column> tb1DetailColLs = Arrays.asList(new Column[] { new Column(DB_KEY, ""),
					...
					new Column("ESTCURR_NT", ""), new Column("WAERS", "") });
			...
			List<Column> tb2DetailColLs = Arrays
					.asList(new Column[] { new Column(DB_KEY, ""), new Column("CONTRACTNO", ""),
							new Column("ACONTNO", ""), new Column("CONTRACTNAME", ""), new Column("NAME1", ""),
							new Column("PSNAM", ""), new Column("DEDAMT", ""), new Column("WAERS", "") });

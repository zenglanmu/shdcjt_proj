...
<TABLE class=Form width="40%" border=0>
  ...
  <TABLE class=Form width="100%">
    <TBODY>
    <TR class=Section><TH>知识管理</TH></TR>
...
<%if((user.getLogintype().equals("1")&&(userseclevel>=20))){%>
    ...
    <TR><TD><A href="/docs/report/DocRpDocSum.jsp"><%=SystemEnv.getHtmlLabelName(151,user.getLanguage())%> 50: 被阅读</A></TD></TR>
...
<%if(software.equals("ALL") || software.equals("CRM")){%>
  <TABLE class=Form width="100%">
    <TBODY>
    <TR class=Section><TH>客户管理</TH></TR>
    <TR class=separator><TD class=Sep1></TD></TR>    
...
<br>
  <TABLE class=Form width="100%">
    <TBODY>
    <TR class=Section><TH>项目管理</TH></TR>
    <TR class=separator><TD class=Sep1></TD></TR>
<%if(user.getLogintype().equals("1")){%> 
...
<%}%>
  ...
  <TABLE class=Form width="100%">
    ...
    <TR class=separator><TD class=Sep1></TD></TR>
    <tr><td><a href="/org/OrgChartDoc.jsp">文档</a></td></tr>  

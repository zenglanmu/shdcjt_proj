...
<tr>    
	...
	%>
       </select><SPAN id="rptFlagimage"><%if(rptFlag.equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN>
    </td>
    ...
    гн<BUTTON class=calendar id=SelectDate onclick=getDate(enddatespan,enddate)></BUTTON>&nbsp;

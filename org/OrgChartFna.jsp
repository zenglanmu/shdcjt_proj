		...
		<td valign="top">
			...
			%>
				<TABLE onclick="oc_ShowMenu(<%=curnum%>,oc_divMenuGroup)" cellpadding=1 cellspacing=1
					STYLE="POSITION:absolute;Z-INDEX:100;FONT-SIZE:8pt;LETTER-SPACING:-1pt;TOP:<%=depart.y%>;LEFT:<%=depart.x%>;height:<%=depart.getWidthHeight().y%>;width:<%=depart.getWidthHeight().x%>;background-image:url('/org/OrgSubCompanyBg1.png');background-repeat:no-repeat;cursor:hand;">
			...
			%>
				<TABLE onclick="oc_ShowMenu(<%=curnum%>,oc_divMenuDivision)" cellpadding=1 cellspacing=1 STYLE="POSITION:absolute;Z-INDEX:100;FONT-SIZE:8pt;LETTER-SPACING:-1pt;TOP:<%=depart.y%>;LEFT:<%=depart.x%>;height:<%=depart.getWidthHeight().y%>;width:<%=depart.getWidthHeight().x%>;background-image:url('/org/OrgDepartmentBg1.png');background-repeat:no-repeat;cursor:hand;">
				  ...
				  <td align=left width=20%> <img src="/images/PeriodOpen.gif" border=0></td>
					<%
					tmpnum = "";
                    tmpnum1 = 0d;
                    tmpnum2 = 0d;
			...
			//        out.print( sqltmp ) ;
					...
					<TR height=14px>
					<td align=left width=20%> <img src="/images/ArrowEqual.gif" border=0></td>
					<%
                    tmpnum = "";
                    tmpnum1 = 0d;
                    tmpnum2 = 0d;
	...
	return {X:leftX,Y:topY};
			...
			function oc_CurrentMenuOnClick(){
				...
				<TR><TD class="NoHand" style=text-align:center;color:white id=t>Title</TD></TR>
					 ...
					 <TR id=D1><TD class=MenuPopup>部门收支报表</TD></TR>

											...
											<div style="margin-top:5px;">
												<span style="margin-left:3px;cursor:pointer;padding-right:30px;" onclick="setTrackType1(this);">
													<%if("1".equals(trackType) || trackType==null){ %>
														<img src="images/radio_true.png" class="imgTxt"/>&nbsp;只跟踪断点类
													<%}else{%>
														<img src="images/radio_false.png"class="imgTxt"/>&nbsp;只跟踪断点类
													<%}%>
												</span>
												<span style="cursor:pointer;padding-right:30px;" onclick="setTrackType2(this);">
													<%if("2".equals(trackType) || trackType==null){ %>
														<img src="images/radio_true.png"class="imgTxt"/>&nbsp;跟踪所有类
													<%}else{%>
														<img src="images/radio_false.png"class="imgTxt"/>&nbsp;跟踪所有类
													<%}%>
												</span>
												<span style="cursor:pointer;" onclick="setTrackSeq(this);">
													<%if("true".equals(isTrackSeq) || isTrackSeq==null){ %>
														<img src="images/checkbox_true.png"class="imgTxt"/>&nbsp;跟踪执行过程
													<%}else{%>
														<img src="images/checkbox_false.png"class="imgTxt"/>&nbsp;跟踪执行过程
													<%}%>
												</span>
											</div>

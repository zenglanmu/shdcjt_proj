    ...
    <TD class=Sep1 colSpan=2 ></TD>
        ...
        <TR>
          ...
          <TD class=Field>
             <BUTTON class=Browser onclick="onShowResourceID()"></BUTTON> 
              <SPAN id=idspan><%if(!id.equals("")){%><%=ResourceComInfo.getResourcename(id)%><%}else{%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></SPAN> 
        ...
        <tr>
          ...
          <td class=Field>            
            ...
            <span id=loginidspan><IMG src='/images/BacoError.gif' align=absMiddle></span>
          </td>
        </tr>              
        <tr>
          ...
          <td class=Field>            
            ...
            <span id=passwordspan><IMG src='/images/BacoError.gif' align=absMiddle></span>
          </td>
        </tr>              
 </TBODY>
 </TABLE>
...
sub onShowResourceID()
	...
	if id(0)<> "" then
	idspan.innerHtml = "<A href='HrmResource.jsp?id="&id(0)&"'>"&id(1)&"</A>"	

...
<table class=form>
  <colgroup>
	...
	<td>
	<INPUT TYPE="radio" NAME="picid" value="1" <%if(picid.equals("1")){%>checked<%}%>><IMG src="../../images/sun.gif" align=absMiddle>
	<INPUT TYPE="radio" NAME="picid" value="2" <%if(picid.equals("2")){%>checked<%}%>><IMG src="../../images/yun.gif" align=absMiddle>
	<INPUT TYPE="radio" NAME="picid" value="3" <%if(picid.equals("3")){%>checked<%}%>><IMG src="../../images/yin.gif" align=absMiddle>
	<INPUT TYPE="radio" NAME="picid" value="4" <%if(picid.equals("4")){%>checked<%}%>><IMG src="../../images/yu.gif" align=absMiddle>
	</td>
   </tr>
   <tr>
      ...
      <%if(thedesc.equals("")){ %><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></td>
   </tr>
   <tr>

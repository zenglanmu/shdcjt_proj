...
CLASS_MSN_MESSAGE.prototype.show = function(){  
  try{
    ...
    str += "<SPAN  style='FONT-WEIGHT: bold; FONT-SIZE: 12px; CURSOR: hand; COLOR: red; MARGIN-RIGHT: 4px' id='btSysClose' ><img src='/images/PopupClose.gif' alt='关闭' border='0'>&nbsp;&nbsp;&nbsp;</SPAN></TD>"  

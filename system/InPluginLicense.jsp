...
<tr>
    ...
    <tr>
        <td>验证码:</td>
        <td class=Field><input class="InputStyle" type=password  id=code name=code maxlength=16 size=16 onchange='checkinput("code","codeimage")'><SPAN id=codeimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN><a href="\system\ModifyCode.jsp">更改验证码</a></td>
    </tr>
...
<link type='text/css' rel='stylesheet'  href='/wui/theme/ecology7/skins/<%=curskin %>/wui.css'/>

	...
	<td valign="top">
		...
		<td valign="top">
			...
			<%}%>
				...
				<br><br>
					<img src="/images/arrow_l.gif" title="<%=SystemEnv.getHtmlLabelName(456,user.getLanguage())%>" onClick="javascript:addSrcToDestList()">
				<br><br>
				<img src="/images/arrow_r.gif"  title="<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%>" onclick="javascript:deleteFromDestList();">
				<br><br>

		...
		<td valign="top">
			...
			String whereclause = "";
					...
					if(!logintype.equals("2")) {
							...
							whereclause=" where t1.id=t2.sourceid  and t1.docstatus in('1','2','5') and ( t1.doccreaterid != "+userid+" or t1.usertype !='1') and t1.id not in (select docid from docReadTag where userid="+userid+" and usertype=1)";
					}
					else {
							whereclause=" where t1.id=t2.sourceid  and t1.docstatus in('1','2','5') and ( t1.doccreaterid != "+userid+" or t1.usertype !='2') and t1.id not in (select docid from docReadTag where userid="+userid+" and usertype=2)";
					}
			...
			<%=SystemEnv.getHtmlLabelName(15011,user.getLanguage())%>&nbsp;<IMG src="/images_face/ecologyFace_1/new.gif" align="middle">:&nbsp;&nbsp;<%=SystemEnv.getHtmlLabelName(15012,user.getLanguage())%><a href="/docs/search/DocSearchTemp.jsp?list=all">(<%=doccount%>)</a><%=SystemEnv.getHtmlLabelName(15013,user.getLanguage())%>,

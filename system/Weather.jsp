...
//			if((j==4||j==6||j==9||j==11)&&i==31) { bgcolor="darkblue"; canlink=0;}
			...
			<% if(picid.equals("1")){%><IMG src="../../images/sun.gif" align=absMiddle border=0><%}%>
			<% if(picid.equals("2")){%><IMG src="../../images/yun.gif" align=absMiddle border=0><%}%>
			<% if(picid.equals("3")){%><IMG src="../../images/yin.gif" align=absMiddle border=0><%}%>
			<% if(picid.equals("4")){%><IMG src="../../images/yu.gif" align=absMiddle border=0><%}%>

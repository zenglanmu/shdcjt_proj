...
{
	sql = "select t1.id,t1.lastname,t2.rolesname,t3.rolelevel,t3.roleid,t7.workflowid,t6.nodename "+
			"from hrmresource t1,hrmroles t2,hrmrolemembers t3,workflow_groupdetail t4,"+
			"workflow_nodegroup t5,workflow_nodebase t6,workflow_flownode t7,workflow_base t8 "+
			"where t1.id=t3.resourceid and t2.id=t3.roleid and t3.roleid=t4.objid and "+
			"t4.type=2 and t4.groupid=t5.id and (t6.IsFreeNode is null or t6.IsFreeNode!='1') and t5.nodeid=t6.id "+
...
{
	sql = "select top "+currentpageend+" t1.id as id,t1.dsporder,t1.lastname,t2.id as t2id ,t2.rolesname,t3.rolelevel,t3.roleid,t7.workflowid,t6.id as t6id,t6.nodename "+
			"from hrmresource t1,hrmroles t2,hrmrolemembers t3,workflow_groupdetail t4,"+
			"workflow_nodegroup t5,workflow_nodebase t6,workflow_flownode t7,workflow_base t8 "+
			"where t1.id=t3.resourceid and t2.id=t3.roleid and t3.roleid=t4.objid and "+
			"t4.type=2 and t4.groupid=t5.id and (t6.IsFreeNode is null or t6.IsFreeNode!='1') and t5.nodeid=t6.id "+
...
while(RecordSet.next()){
    ...
    String rolesname=RecordSet.getString("rolesname");
...
function exportXSL()
{
	document.getElementById("iframeExcel").src = "/system/basedata/basedata_hrmroleexcel.jsp?pagepos=<%=pagepos%>&resourceid=<%=resourceid%>&roleid=<%=roleid%>";
}

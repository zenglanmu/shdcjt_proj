			...
			<td valign="top">
				...
				%>
				  ...
				  <TR class=Header>
				    ...
				    <TD><b><%=DocMouldComInfo.getDocMouldname(docmouldid)%>&nbsp;</b></TD>
				    <TD><%=SystemEnv.getHtmlLabelName(15058,user.getLanguage())%></TD><!-- 审批流程 -->
				    <TD><b><%=WorkflowComInfo.getWorkflowname(approvewfid)%>&nbsp;</b></TD>

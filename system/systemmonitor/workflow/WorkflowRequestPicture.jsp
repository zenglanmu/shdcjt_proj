...
onclick="return oc_CurrentMenuOnClick(<%=icount%>)" onmouseout="return oc_CurrentMenuonmouseout(<%=icount%>)" >
    ...
    %>
        <%if(curnodetype==0){%>
	<img src="/images/iconemp.gif" title="已操作者">
		<%
    ...
    %>
	<img src="/images/imgPersonHead.gif" title="未操作者">
	<%
    ...
    <%
         if(curnodetype==0){
    %>
	 <TR id=D3><TD class=MenuPopup><img src="/images/iconemp.gif" title="已操作者">
	<%
	        for(int i=0;i<operaternode.size();i++){
                String tmp = ""+operaternode.get(i);
                if((tmp).startsWith(""+rs.getString("nodeid")+"_"))
    ...
    %>
	<TR id=D1><TD class=MenuPopup><img src="/images/imgPersonHead.gif" title="未操作者">
	<%
            for(int i=0;i<canoperaternode.size();i++){
                String tmp = ""+canoperaternode.get(i);
                String tmptype = tmp.substring(tmp.lastIndexOf("_")+1);
	...
	<TR id=D2><TD class=MenuPopup><img src="/images/icon_resource_flat.gif" title="查看者">
	<%

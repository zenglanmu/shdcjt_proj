                    ...
                    <tr>
                      <td COLSPAN=4>
                        ...
                        //else  if(RecordSet.getString("id").equals("-7")) //-7
                                    ...
                                    tableString+="			    <col   text=\""+SystemEnv.getHtmlLabelName(16354,user.getLanguage())+"\" column=\"requestid\" otherpara=\""+user.getLanguage()+"+"+user.getLanguage()+"+"+user.getUID()+"\" transmethod=\"weaver.general.WorkFlowTransMethod.getUnOperators\"/>";
                          else
						  {String tempfield=RecordSet.getString("id");
						   ...
						   String type = RecordSet.getString("type");
						   String id = RecordSet.getString("id");
						   String para3="column:requestid+"+id+"+"+htmltype+"+"+type+"+"+user.getLanguage()+"+"+isbill;
							if(isbill.equals("1"))
								label = SystemEnv.getHtmlLabelName(Util.getIntValue(label),user.getLanguage());
						 ...
						 tableString+="			    <col  text=\""+label+"\"  column=\""+name+"\"  otherpara=\""+para3+"\"  transmethod=\"weaver.general.WorkFlowTransMethod.getOthers\"/>";
                          ...
                          if(hasreceivedpersons)
                                    tableString+="			    <col width=\"15%\"  text=\""+SystemEnv.getHtmlLabelName(16354,user.getLanguage())+"\" column=\"requestid\" otherpara=\""+user.getUID()+"\" transmethod=\"weaver.general.WorkFlowTransMethod.getUnOperators\"/>";
						  }
						  if(hasSubWorkflow) 

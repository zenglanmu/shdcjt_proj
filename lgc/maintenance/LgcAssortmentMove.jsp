...
<BUTTON class=Btn accessKey=2 onclick='location="../LgcMaintenance.jsp"'><U>2</U>-取消</BUTTON> 
	...
	<td>
		...
		<% if(assortmentid1.equals("")) {%><IMG src='/images/BacoError.gif' align=absMiddle>
	...
	<td>
		...
		<% if(assortmentid2.equals("")) {%><IMG src='/images/BacoError.gif' align=absMiddle>
...
sub onShowAssortmentID1()
	...
	if NOT isempty(id) then
	    if id(0)<> "" then
			...
			assortmentidspan1.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowAssortmentID2()
	...
	if NOT isempty(id) then
	    if id(0)<> "" then
			...
			assortmentidspan2.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

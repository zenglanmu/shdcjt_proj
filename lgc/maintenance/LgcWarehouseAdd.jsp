...
%>
  ...
  <TABLE class=ViewForm>
    ...
    <tr> 
	  ...
	  <SPAN ID=rolesidspan class=InputStyle><IMG src='/images/BacoError.gif' align=absMiddle></SPAN>
...
sub onShowRolesID()
	...
	if (Not IsEmpty(id))  then
		...
		rolesidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
		right.roleid.value=""
		end if
	end if
end sub

      ...
      <TABLE cellSpacing=0 cellPadding=0 border=0>
		...
		%>
          <TD vAlign=top align=left bgColor="#<%=thenavibarbgcolor%>"><IMG height=8 
            src="/images/bp_tab_left_white.gif" width=6 border=0></TD>
          ...
          <TD vAlign=top align=left bgColor="#<%=thenavibarbgcolor%>"><IMG height=8 
            src="/images/bp_tab_right_white.gif" width=6 border=0></TD>
      	  <%}%>    
		  </TR>
		 </TBODY>
		</TABLE>
                        ...
                        method=post -->
                          <TABLE cellSpacing=0 cellPadding=2 width="100%" border=0>
                            ...
                            <TR> 
                              ...
                              <td width=20><INPUT type=image height=18 alt=Go width=18 src="/images/BacoSearch.gif" border=0></td>
                            </TR>
                            </TBODY> 
                          </TABLE>
                          <!--/FORM -->
                              ...
                              <TABLE cellSpacing=0 cellPadding=0 width="100%" bgColor=<%=toolbarlinkbgcolor%> border=0>
								...
								%>
                                 <TR><TD>
									...
									<IMG SRC="\images\btnDocExpand.gif" BORDER="0" HEIGHT="12px" WIDTH="12px" onClick="changeassortment('<%=assortmentid%>','1')" style="CURSOR:'HAND'" >
									<%} else if(assortmentimage.equals("2")) {%>
									<IMG SRC="\images\btnDocCollapse.gif" BORDER="0" HEIGHT="12px" WIDTH="12px" onClick="changeassortment('<%=assortmentid%>','0')" style="CURSOR:'HAND'">
									<% } %>
									</td>
                    ...
                    <TABLE width="100%" border=0>
					  ...
					  <TR class=DataDark>
                        ...
                        <TD vAlign=top align=right width=40> 
                          ...
                          <img src="/images/ShopAddToCart.gif" title="Add to basket" border=0></a>
                        </TD>
                        <%}%>
                      </tr>
                      <%	

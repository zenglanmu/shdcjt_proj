...
<TR class=Line><TD colSpan=8></TD></TR>
  ...
  <TR class=DataDark>
    ...
    <TD style="margin:0px"><IMG src="\images\BacoDelete.gif" border=0 alt=Delete style="CURSOR:'HAND'" onclick="if(isdel()){onDelete('<%=cookiename%>');}"></TD>
  </TR>
  <%	
		isLight = !isLight;
  }%>
...
<TR class=Line><TD colSpan=6></TD></TR>
 ...
 if(isLight) {%>
  ...
  <TR class=DataDark>
    ...
    <TD style="margin:0px"><IMG src="\images\ShopAddToCart.gif" border=0 alt="Add to basket" style="CURSOR:'HAND'" onclick="onAdd('<%=relassetid%>','<%=thecountryid%>')"></TD>
  </TR>
 <%}}%>
</TABLE>
		</td>

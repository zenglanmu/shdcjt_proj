...
%>
	<td><%if (step.equals("1")){%><IMG src="../../images/arrownext.gif"><%}%></td>
	<td><img src="0.gif" width="<%=tdwidth%>" height="1"><a href="LgcAsset.jsp?&paraid=<%=subassetid%>"><%=Util.toScreen(AssetComInfo.getAssetName(subassetid),user.getLanguage())%></a></td>	<td><a href="../maintenance/LgcAssetRelationTypeEdit.jsp?&id=<%=relationtypeid%>"><%=Util.toScreen(AssetRelationTypeComInfo.getAssetRelationTypename(relationtypeid),user.getLanguage())%></a></td>
    <td>

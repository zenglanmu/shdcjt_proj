                        ...
                        <table class=Monitor cellspacing=1 cellpadding=0>
                          ...
                          <tr> 
                            <td width=29><img height=22 
                              src="/images/mtr_account.gif" width=29 
                              border=0></td>
                    ...
                    <tr> 
                      <td> 
                        <table class=Monitor cellspacing=1 cellpadding=0>
                          ...
                          <tr> 
                            <td width=29><img height=22 
                              src="/images/mtr_docs.gif" width=29 
                              border=0></td>
                    ...
                    <tr> 
                      <td> 
                        <table class=Monitor cellspacing=1 cellpadding=0>
                          ...
                          <tr> 
                            <td width=29><img height=22 
                              src="/images/mtr_request.gif" width=29 
                              border=0></td>
                            <td class=Entity>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%">
              ...
              <TR> 
                <TD> 
                  ...
                  <IMG src="/images/BacoCheck.gif" border=0><A href="LgcAssetStock.jsp?paraid=<%=assetid%>">库存</A> 
                  <%} else {%>
                  <IMG src="/images/BacoCross.gif" border=0>库存
                  <%}%>
                </TD>
              </TR><tr><td class=Line colspan=3></td></tr>
              </TBODY> 

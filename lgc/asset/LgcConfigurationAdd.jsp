...
%>    
 ...
 <TABLE class=ViewForm width="100%">
    ...
    <tr> 
      <td>类型</td>
        <td class=Field> <BUTTON class=Browser id=SelectRelationTypeID onClick="onShowRelationTypeID()"></BUTTON> 
              <span id=relationtypeidspan><IMG src='/images/BacoError.gif' align=absMiddle></span> 
    ...
    <td class=Field> <BUTTON class=Browser id=SelectRelateAssetID onClick="onShowRelateAssetID()"></BUTTON> 
       <span id=relateassetidspan><IMG src='/images/BacoError.gif' align=absMiddle></span> 
...
sub onShowRelationTypeID()
	...
	if NOT isempty(id) then
		...
		relationtypeidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowRelateAssetID()
	...
	frmain.relateassetid.value="<IMG src='/images/BacoError.gif' align=absMiddle>"
	end if
	end if
end sub
</SCRIPT>

...
<TABLE class=ViewForm>
    ...
    <TR> 
	 ...
	 <input class=InputStyle  id=warehouseidspan><IMG src='/images/BacoError.gif' align=absMiddle></span> 
...
sub onShowWarehouseID()
	...
	if NOT isempty(id) then
		...
		warehouseidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

...
*/
	...
	response.sendRedirect("LgcAsset.jsp?paraid="+id);   
...
*/
	...
	response.sendRedirect("LgcAsset.jsp?paraid="+assetid+"&assetcountryid="+assetcountryid);
	...
	sqlTemp = "select assortmentid from LgcAsset where id = " + assetid ;
	RecordSet.executeSql(sqlTemp);
	if (RecordSet.next()) {
...
*/	  
	...
	response.sendRedirect("/lgc/maintenance/LgcAssortment.jsp?addorsub=3");
 }
%>

	...
	<tr> 
		...
		<FORM name="Magazine"  action="tom_magazine.jsp" method="post">
			...
			<tr>
				...
				<td width="21%"><img src="images/tom/mail3.gif" width="117" height="20"></td>
				<td width="14%"> 
					<select name="id">
					<%
				...
				<td width="11%"><img src="images/tom/search.gif" width="56" style="cursor:hand" onclick="Magazine.submit()"></td>
			</tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr> 
					...
					<td width="13%" height="30" bgcolor="#F3FFE4"><img src="images/tom/icon_news.gif" width="63" height="42"></td>
            	...
            	<tr> 
            		<td width="30%"> 
           				<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            				<tr> 
            					<td width="100%" height="115" background="images/tom/bg.gif"> 
								<%
									
									String strImgSrc="";
									String temppics="/images/homepage/noimgdefault.gif";
									String links="/images/homepage/noimgdefault.gif";
									...
									if(!tmppicid.equals("")) {
									  ...
									  if(!"#".equals(strImgSrc)){
										   ...
										   temppics="/images/homepage/noimgdefault.gif";
										   links="/images/homepage/noimgdefault.gif";
										}


									}  else{
									 strImgSrc="/images/homepage/noimgdefault.gif";
									}
								%>		
								<%}%>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <td width="70%" valign="top" style="font-size:9pt"><a href="/docs/docs/DocDsp.jsp?id=<%=docid%>" target="_blank"><%=docsubject%></a>
	                ...
	                <a href="/docs/docs/DocDsp.jsp?id=<%=docid%>" target="_blank">
							...
							<tr> 
								<td colspan="4" height="1" background="images/r_title_bg2.gif"></td>
							</tr>
						</table>
					</td>
				</tr>
			  ...
			  %>
				<tr> 
					<td width="4%" height="30"> 
						<div align="center"><img src="images/icon3.gif" width="6" height="9"></div>
					</td>

...
function setCompany(nodeid){
    ...
    document.SearchForm.action="/hrm/jobtitles/HrmJobTitles.jsp";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/jobtitles/HrmJobTitles.jsp?subcompanyid="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/jobtitles/HrmJobTitles.jsp?from=hrmorg&department="+deptid;
    document.SearchForm.submit();
}

...
<%
if(hasright){
RCMenu += "{"+SystemEnv.getHtmlLabelName(93,user.getLanguage())+",javascript:location.href=\"PieceRateMaintenanceEdit.jsp?isedit=1&subCompanyId="+subcompanyid+"&departmentid="+departmentid+"&PieceYear="+PieceYear+"&PieceMonth="+PieceMonth+"\",_self} " ;

...
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",javascript:location.href=\"PieceRateSetting.jsp?subCompanyId="+subcompanyid+"\",_self} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
...
function addrow(){
    ...
    oCell.style.background= "#E7E7E7";
    var oDiv = document.createElement("div");
    var sHtml = "<input type='text' class=inputstyle size=15 id='PieceRateNo_"+rowindex+"' name='PieceRateNo_"+rowindex+"' maxlength=30 onchange='checkinput(\"PieceRateNo_"+rowindex+"\",\"PieceRateNospan_"+rowindex+"\")'><SPAN id=PieceRateNospan_"+rowindex+" name=PieceRateNospan_"+rowindex+"><IMG src='/images/BacoError.gif' align=absMiddle></SPAN>";
    oDiv.innerHTML = sHtml
    oCell.appendChild(oDiv);
    oCell = oRow.insertCell();
    oCell.style.height=24;

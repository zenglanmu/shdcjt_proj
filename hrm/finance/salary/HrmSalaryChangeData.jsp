  	...
  	<COL width="85%">
        ...
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(179,user.getLanguage())%></TD> 
		    <TD class=Field>
              ...
              <span id=multresourceidspan><IMG src='/images/BacoError.gif' align=absMiddle></span> 
        ...
        <TR>
          <TD><%=SystemEnv.getHtmlLabelName(15815,user.getLanguage())%></TD> 
		    <TD class=Field>
                ...
                <span id=itemidspan><IMG src="/images/BacoError.gif" 
        ...
        <TR>
          ...
          <TD class=Field>
              ...
              <SPAN id=salaryimage><IMG src="/images/BacoError.gif" 
                    align=absMiddle></SPAN>
          </TD> 
        </TR>
        <TR style="height:1px"><TD class=Line colSpan=2></TD></TR>

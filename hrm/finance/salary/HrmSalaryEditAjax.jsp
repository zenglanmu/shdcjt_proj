<%@ page language="java" contentType="text/html; charset=GBK" %><%@ page import="weaver.hrm.*" %><%@ page import="weaver.general.Util" %><%@ page import="java.util.ArrayList" %><jsp:useBean id="RecordSet" class="weaver.conn.RecordSet" scope="page" /><jsp:useBean id="RecordSet1" class="weaver.conn.RecordSet" scope="page" />
<%
...
<table style="width:100%;" border="0" >
  ...
  while(RecordSet.next()){
      ...
      String resourcepay = "";
      sql="select resourcepay from HrmSalaryResourcePay where resourceid="+cuserid+" and itemid = "+itemid;

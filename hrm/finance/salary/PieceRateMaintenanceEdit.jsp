...
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",javascript:location.href=\"PieceRateMaintenance.jsp?subCompanyId="+subcompanyid+"&departmentid="+departmentid+"\",_self} " ;
RCMenuHeight += RCMenuHeightStep ;
%>
...
function addrow(){
    ...
    oCell.style.background= "#E7E7E7";
    var oDiv = document.createElement("div");
    var sHtml = "<button type='button' class=Browser onclick=\"onShowUserCode('UserCode_"+rowindex+"','UserCodespan_"+rowindex+"')\"></button><SPAN id=UserCodespan_"+rowindex+"><IMG src='/images/BacoError.gif' align=absMiddle></SPAN><input type='hidden' id='UserCode_"+rowindex+"' name='UserCode_"+rowindex+"' >";
    oDiv.innerHTML = sHtml;
    oCell.appendChild(oDiv);
    ...
    oCell.style.background= "#E7E7E7";
    var oDiv = document.createElement("div");
    var sHtml = "<button type='button' class=Browser onclick=\"onShowPieceRateNo('PieceRateNo_"+rowindex+"','PieceRateNospan_"+rowindex+"')\"></button><SPAN id=PieceRateNospan_"+rowindex+" name=PieceRateNospan_"+rowindex+"><IMG src='/images/BacoError.gif' align=absMiddle></SPAN><input type='hidden' id='PieceRateNo_"+rowindex+"' name='PieceRateNo_"+rowindex+"'>";
    oDiv.innerHTML = sHtml
    oCell.appendChild(oDiv);
    ...
    oCell.style.background= "#E7E7E7";
    var oDiv = document.createElement("div");
    var sHtml = "<input type='text' class=inputstyle size=10 name='PieceNum_"+rowindex+"' maxlength=13 onKeyPress='ItemNum_KeyPress()' onBlur='checknumber1(this)' onchange=\"checkinput('PieceNum_"+rowindex+"','PieceNumspan_"+rowindex+"')\"><SPAN id=\"PieceNumspan_"+rowindex+"\"><IMG src='/images/BacoError.gif' align=absMiddle></SPAN>";
    oDiv.innerHTML = sHtml;
    oCell.appendChild(oDiv);

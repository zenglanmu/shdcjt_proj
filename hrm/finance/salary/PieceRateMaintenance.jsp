...
<%
if(hasright){
RCMenu += "{"+SystemEnv.getHtmlLabelName(82,user.getLanguage())+",javascript:location.href=\"PieceRateMaintenanceEdit.jsp?subCompanyId="+subcompanyid+"&departmentid="+departmentid+"\",_self} " ;

...
<tr>
	...
	switch(goalType){
		case 0:
	%>
	<BUTTON class=Browser id=SelectSubCompany onclick="onShowDepartment2()"></BUTTON>
   ...
   <INPUT class=inputstyle id=objId type=hidden name=objId value="">
	...
	<%
		...
		case 1:
	%>
	<BUTTON class=Browser id=SelectDepartment onclick="onShowDepartment2()"></BUTTON>
	<SPAN id=objIdSpan><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
	<INPUT class=inputstyle id=objId type=hidden name=objId value="">
	<%
			break;
...
sub onShowTargetTypeBrowser()
	...
	if (Not IsEmpty(id)) then
		if id(0)<> "" then
			targetTypeSpan.innerHtml = "<A href='HrmResource.jsp?id="&id(0)&"'>"&id(1)&"</A>"

...
sub onShowParentTargetID1()
	...
	if (Not IsEmpty(id)) then
		if id(0)<> "" then
			parentTargetSpan.innerHtml = "<A href='myGoalView.jsp?id="&id(0)&"'>"&id(1)&"</A>"
...
sub onShowTargetSingle()
	...
	if (Not IsEmpty(id)) then
		if id(0)<> "" then
			location.href = "myGoalAdd.jsp?targetImportId="&id(0)
		end if
	end if
end sub
</script>
...
if(!_orderby.equals("")){
	...
	strOrderBy = "ORDER BY a.percent_n DESC";
}
...
<tr class="Header">
	<th width="5%"></th>
	<th width="20%"><%=SystemEnv.getHtmlLabelName(195,user.getLanguage())//名称%></th>
	<th width="18%"><%=SystemEnv.getHtmlLabelName(18085,user.getLanguage())//指标类型%></th>
	<th width="17%"><%=SystemEnv.getHtmlLabelName(18239,user.getLanguage())//负责单位%></th>
	<th width="5%"><%=SystemEnv.getHtmlLabelName(713,user.getLanguage())//属性%></th>
	<th width="15%"><%=SystemEnv.getHtmlLabelName(18087,user.getLanguage())//目标值%></th>
	<th width="5%"><%=SystemEnv.getHtmlLabelName(6071,user.getLanguage())//权重%></th>
	<th width="10%"><%=SystemEnv.getHtmlLabelName(19709,user.getLanguage())//上级目标%></th>
	<th width="5%"><%=SystemEnv.getHtmlLabelName(18215,user.getLanguage())//分解%></th>
</tr>
</thead>

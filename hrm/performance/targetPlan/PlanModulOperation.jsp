    ...
    { 
		...
		rs.executeSql(sql);
		rs.execute("DELETE FROM HrmPerformancePlanCheck WHERE planModulId = " + planId+" and plandate>='"+nowdate+"'"); //清空标志表
    ...
    {   
		...
		//System.out.println("sql : "+sql);
		rs.executeSql(sql);
		rs.execute("DELETE FROM HrmPerformancePlanCheck WHERE planModulId = " + id+" and plandate>='"+nowdate+"'"); //清空标志表

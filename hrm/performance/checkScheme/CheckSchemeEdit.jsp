...
<table width="100%" class=viewform>
 <COLGROUP> <COL width="10%"> <COL width="70%"> <COL width="10%"><TBODY> 
		...
		<input type=hidden name="viewSuperiorId" id="viewSuperiorId" value="<%=viewSuperiorId%>"><input type=hidden name="viewPostId" id="viewPostId" value="<%=viewPostId%>"><input type=hidden name="viewHrmId" id="viewHrmId" value="<%=viewHrmId%>">

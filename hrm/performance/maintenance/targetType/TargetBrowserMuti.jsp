...
<TD width=35% class=field><BUTTON class=Browser id=SelectProjectID onClick="onShowProject('prjid','projectspan')"></BUTTON>
...
<TD class=Field>
<BUTTON class=Calendar onclick="getBDate(1)"></BUTTON> 
<SPAN id=begindatespan><%=begindate%></span> 
<input type="hidden" name="begindate" id="begindate" value="<%=begindate%>">   
</td>
<TD><%=SystemEnv.getHtmlLabelName(741,user.getLanguage())%></TD>
<TD class=Field>
<BUTTON class=Calendar onclick="getEDate(1)"></BUTTON> 
...
<TD width=35% class=field><BUTTON class=Browser id=SelectHrmID onClick="onShowHrmID(hrmid,hrmspan)"></BUTTON>

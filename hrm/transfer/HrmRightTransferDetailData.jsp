...
<table class=viewform>
  ...
  <TR CLASS=title>
    <TD COLSPAN=4>
      <B><%=SystemEnv.getHtmlLabelName(17992,user.getLanguage())%>:<%=Util.toScreen(ResourceComInfo.getResourcename(fromid),user.getLanguage())%>(<%=SystemEnv.getHtmlLabelName(523,user.getLanguage())%>:<%=eventAllNum%>)</B>
    </TD>
  </TR>
  <TR CLASS=spacing>

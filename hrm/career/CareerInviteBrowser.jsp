...
jQuery(document).ready(function(){
	...
	jQuery("#BrowseTable").find("tr[class^='Data'][class!='DataHeader']").bind("click",function(){
		...
		window.parent.parent.returnValue = {"id":jQuery(this).find("td:nth-child(3)").text(),"name":jQuery(this).find("td:nth-child(2)").text(),other1:jQuery(this).find("td:first").text(),other2:jQuery(this).find("td:nth-child(9)").text()};

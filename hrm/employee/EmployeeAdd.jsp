      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <TR> 
			...
			<SPAN id=nameimage><%if (name.equals("")) {%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></SPAN>
            </TD>
          </TR>
        <TR><TD class=Line colSpan=2></TD></TR> 
          ...
          <TR> 
            ...
            <TD class=Field><BUTTON class=Calendar id=selectworkday onclick="getworkdayDate()"></BUTTON> 
              <SPAN id=workdayspan style="FONT-SIZE: x-small"><%if (workday.equals("")) {%><IMG src="/images/BacoError.gif"  align=absMiddle><%}%></SPAN> 
          ...
          <TR> 
            ...
            <TD class=Field><button class=Browser id=SelectDeparment onClick="onShowDepartment()"></button> 
              <span class=inputStyle id=departmentspan><IMG src="/images/BacoError.gif" 
          ...
          <TR> 
            ...
            <TD class=Field><BUTTON class=Browser id=SelectJobTitle onclick="onShowJobtitle()"></BUTTON> 
              <SPAN id=jobtitlespan><IMG src="/images/BacoError.gif" 
            align=absMiddle></SPAN> 
         ...
         <TR><TD class=Line colSpan=2></TD></TR> 
          ...
          <TR> 
            ...
            <TD class=Field><BUTTON class=Browser id=SelectManagerID onClick="onShowManagerID()"></BUTTON> 
              <span 
            id=manageridspan><img src="/images/BacoError.gif" 
            align=absMiddle></span> 

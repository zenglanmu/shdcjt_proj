...
if(!check_per.equals("")){
    ...
    strtmp = "select id,lastname,departmentid from HrmResourcemanager where id in ("+check_per+")";
	RecordSet.executeSql(strtmp);
	while(RecordSet.next()){
...
<tr>
  <td height="10" colspan="3" align="right">
  	  已选择<label id="chose_num" style="text-decoration: underline;"></label>人
      <input style="margin-left: 80px;" type="checkbox" value="1" name="isNoAccount" id="isNoAccount" <%=isNoAccount.equals("1")?"checked='checked'":""%>>显示无账号人员
  </td>
</tr>

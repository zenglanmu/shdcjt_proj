      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <tr> 
            ...
            <td class=Field><button class=Calendar id=selectbememberdate onClick="getbememberdateDate()"></button> 
          ...
          <tr> 
            ...
            <td class=Field><button class=Calendar id=selectbepartydate onClick="getbepartydateDate()"></button> 
    ...
    <TR> 
      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <td class=Field><%if((!isSelf)||(displayAll)){%>
		  <button class=Calendar id=selectcontractbegintime onClick="getContractbegintimeDate()"></button> 
          ...
          <TR> 
            ...
            <TD class=Field><%if((!isSelf)||(displayAll)){%>
			 <BUTTON class=Calendar id=selectenddate onclick="getHendDate()"></BUTTON> 
        ...
        <TR><TD class=Line colSpan=2></TD></TR> 
         ...
         <TR><TD class=Line colSpan=2></TD></TR> 
          <TR> 
            ...
            <TD class=Field><%if((!isSelf)||(displayAll)){%>
			<BUTTON class=Calendar id=SelectCreditcardExpirationDate onclick="getexpiryDate()"></BUTTON> 
...
if(hasFF)
{
	for(int i=1;i<=5;i++)
	{
        ...
        <TR>
          ...
          <TD class=Field><%if((!isSelf)||(displayAll)){%>
		  <BUTTON class=Calendar onclick="getHreDate(<%=i%>)"></BUTTON> 
...
sub onShowSystemLanguage()
	...
	systemlanguagespan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowCountryID()
	...
	countryidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowTitleID()
	...
	titleidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
function doSave() {
    if(check_form(document.resource,"loginid,password,lastname,titleid,systemlanguage,countryid,jobtitle,departmentid,costcenterid,managerid,seclevel")) {
		if(document.resource.password.value != document.resource.confirmpassword.value)  {
			alert("<%=SystemEnv.getHtmlLabelName(15803,user.getLanguage())%>!") ;
			return ;
		}
		document.resource.submit()  ;
	}

...
<script language=javascript>
	function resetbanner(objid){
		...
		if(objid == 0 ){
		        window.frame1.location="/hrm/resource/SingleSearchByOrganDecDet.jsp?onlyselfdept=<%=onlyselfdept%>&sqlwhere=<%=sqlwhere%>&departments=<%=departments%>&subcompanyids=<%=subcompanyids%>&isall=<%=isall%>";
		        try{

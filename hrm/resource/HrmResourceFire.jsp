    ...
    <TABLE class=ViewForm>
      ...
      <TD vAlign=top> 
        <TABLE width="100%">
          ...
          <TR> 
            <TD><%=SystemEnv.getHtmlLabelName(16086,user.getLanguage())%></TD>
...
<TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
    ...
    <TR style="height:1px"><TD class=Line colSpan=2></TD></TR>       
          <TR>
            <td><%=SystemEnv.getHtmlLabelName(16087,user.getLanguage())%></td>
            <td class=Field>
       ...
       <TR style="height:1px"><TD class=Line colSpan=2></TD></TR>    
          <TR>
            <td><%=SystemEnv.getHtmlLabelName(16088,user.getLanguage())%></td>
            <td class=Field>
    ...
    <TR style="height:1px"><TD class=Line colSpan=2></TD></TR>       
          <TR>
            <td><%=SystemEnv.getHtmlLabelName(16089,user.getLanguage())%></td>
            <td class=Field>

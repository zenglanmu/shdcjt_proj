  ...
  <TABLE class=viewForm id=tblScenarioCode>
    ...
    <tr> 
      ...
      <td class=FIELD><BUTTON class=Browser 
            ...
            id=componentidspan><img src="/images/BacoError.gif" align=absMiddle></SPAN> 
    ...
    <tr> 
      ...
      <td class=field> <BUTTON class=Browser 
            ...
            id=currencyidspan><img src="/images/BacoError.gif" align=absMiddle></SPAN> 
    ...
    <tr> 
      ...
      <td class=FIELD> 
        ...
        <span id=salarysumimage><img src="/images/BacoError.gif" align=absMiddle></span> 
      </td>
      <td>&nbsp;</td>
      <td>
      </td>
...
sub onShowComponentID()
	...
	if NOT isempty(id) then
		if id(0)<> "" then
			...
			componentidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
			salarysumimage.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

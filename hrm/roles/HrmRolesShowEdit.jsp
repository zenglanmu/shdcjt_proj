...
.cycleTD{background-image:url(/images/tab2.png);cursor:hand;text-align:center;border-bottom:1px solid #879293;}
.cycleTDCurrent{padding-top:2px;background-image:url(/images/tab.active2.png);cursor:hand;text-align:center;}
...
<input type="hidden" name="id" value="<%=id%>">
	...
	<%if(detachable==1){%>
		<td class="cycleTDCurrent" name="oTDtype_0"  id="oTDtype_0" background="/images/tab.active2.png" width=79px  align=center onmouseover="style.cursor='hand'" onclick="resetbanner(0)" ><%=SystemEnv.getHtmlLabelName(15068,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_1"  id="oTDtype_1" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='hand'" onclick="resetbanner(1)" ><%=SystemEnv.getHtmlLabelName(17864,user.getLanguage())%></td>
		
		<td class="cycleTD" name="oTDtype_2"  id="oTDtype_2" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='hand'" onclick="resetbanner(2)" ><%=SystemEnv.getHtmlLabelName(17865,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_3"  id="oTDtype_3" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='hand'" onclick="resetbanner(3)" ><%=SystemEnv.getHtmlLabelName(431,user.getLanguage())%></td>
		<td style="border-bottom:1px solid rgb(145,155,156)">&nbsp;</td>
		<%}else{%>
		<td class="cycleTDCurrent" name="oTDtype_0"  id="oTDtype_0" background="/images/tab.active2.png" width=79px  align=center onmouseover="style.cursor='hand'" onclick="resetbanner(0)" ><%=SystemEnv.getHtmlLabelName(15068,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_1"  id="oTDtype_1" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='hand'" onclick="resetbanner(1)" ><%=SystemEnv.getHtmlLabelName(17864,user.getLanguage())%></td>
		<td class="cycleTD" name="oTDtype_2"  id="oTDtype_2" background="/images/tab2.png" width=79px align=center onmouseover="style.cursor='hand'" onclick="resetbanner(2)" ><%=SystemEnv.getHtmlLabelName(431,user.getLanguage())%></td>
		<td style="border-bottom:1px solid rgb(145,155,156)">&nbsp;</td>
		<%}%>
	</tr>
	<tr>
...
if(<%=typeid%>==0){
	...
	$GetEle("oTDtype_0").background="/images/tab.active2.png";
	...
	$GetEle("oTDtype_1").background="/images/tab.active2.png";
	...
	$GetEle("oTDtype_2").background="/images/tab.active2.png";
	...
	$GetEle("oTDtype_3").background="/images/tab.active2.png";

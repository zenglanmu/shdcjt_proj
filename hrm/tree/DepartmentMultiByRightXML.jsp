...
envelope.setTitle("envelope");
    ...
    if(isedit==1){
        ...
        SubCompanyComInfo.getSubCompanyTreeListByEditRight(root,"0",0,100,true,"departmentMultiByRight",null,null,excludeid);
    }else{
        SubCompanyComInfo.getSubCompanyTreeListByRight(user.getUID(),rightStr);
        if (excludeid.equals(""))
        SubCompanyComInfo.getSubCompanyTreeListByRight(root,"0",0,100,true,"departmentMultiByRight",null,null);
        else
        SubCompanyComInfo.getSubCompanyTreeListByRight(root,"0",0,100,true,"departmentMultiByRight",null,null,excludeid);
    }

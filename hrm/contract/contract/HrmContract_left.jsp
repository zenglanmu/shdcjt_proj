...
function setCompany(nodeid){
    ...
    document.SearchForm.action="/hrm/contract/contract/HrmContract.jsp";
...
function setSubcompany(nodeid){ 
    ...
    document.SearchForm.action="/hrm/contract/contract/HrmContract.jsp?from=tree&subcompanyid="+subid;
    document.SearchForm.submit();
}
function setDepartment(nodeid){
    ...
    document.SearchForm.action="/hrm/contract/contract/HrmContract.jsp?from=tree&department="+deptid;
    document.SearchForm.submit();
}

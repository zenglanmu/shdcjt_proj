...
%>                
      ...
      <tr>
        ...
        <td class=field> 
          <button class=Calendar id=selectcontractstartdate onClick="getDate(contractstartdatespan,contractstartdate)"></button> 
          <span id=contractstartdatespan ><%=startdate%></span> -&nbsp;
          <button class=Calendar id=selectcontractenddate onClick="getDate(contractenddatespan,contractenddate)"></button> 
    ...
    %>  
      <tr>
        ...
        <td class=field> 
          <button class=Calendar id=selectproenddate onClick="getDate(proenddatespan,proenddate)"></button> 

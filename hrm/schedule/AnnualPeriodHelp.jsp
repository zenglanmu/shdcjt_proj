...
<TABLE class=viewform>
  ...
  <TR>
    <TD></TD>
        <TD><li><%if(user.getLanguage()==8){%>click left subcompany tree,set the subcompany's annual leave period
    		<%}else if(user.getLanguage()==9){%>點擊左邊分部，對該分部進行年假有效期設置
    		<%}else{%>点击左边分部，对该分部进行年假有效期设置<%}%>
    </li></TD>
   </TR>
   </TR>
</TABLE>

...
String sql = "select * from HrmPSLBatchProcess where subcompanyid = '" + subcompanyid + "' order by workingage desc";
...
String titlename = SystemEnv.getHtmlLabelName(24038,user.getLanguage()) + " : "+SystemEnv.getHtmlLabelName(365 , user.getLanguage()) ; 
String needfav = "1" ; 
String needhelp = "" ; 
%>
<BODY>
  ...
  <TR style="height:2px"><TD class=Line1 colSpan=2></TD></TR>
    ...
    <TR> 
      ...
      <TD class=Field>
         ...
         <SPAN id=PSLdaysimage><IMG src='/images/BacoError.gif' align=absMiddle></SPAN>               
      </TD>
	  </TR>
    <TR style="height:1px"><TD class=Line colSpan=2></TD></TR>  
    </TBODY> 

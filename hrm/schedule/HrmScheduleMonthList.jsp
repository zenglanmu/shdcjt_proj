...
<%
RCMenu += "{"+SystemEnv.getHtmlLabelName(93,user.getLanguage())+",HrmScheduleMonthEdit.jsp?year="+theyear+"&month="+themonth+"&type="+orgtype+"&id="+orgid+",_self} " ;
...
if(i==0) {
		i=1 ;
%>
<TR height="20" style="background-color:#e7e7e7">
<%
	}else{
		i=0 ;
%>
<TR  height="20" style="background-color:#f5f5f5">
<%
}
%>

  ...
  <TR class=spacing>
    <TD class=line1 colSpan=2 ></TD>
        ...
        <tr>
          ...
          <td class=Field>
            <BUTTON class=Calendar id=selectlayoutstartdate onclick="getDate(layoutstartdatespan,layoutstartdate)"></BUTTON> 
        ...
        <tr>
          ...
          <td class=Field>
            <BUTTON class=Calendar id=selectlayoutenddate onclick="getDate(layoutenddatespan,layoutenddate)"></BUTTON> 
        ...
        <tr>
          ...
          <td class=Field>
            <BUTTON class=Calendar id=selectlayouttestdatedate onclick="getDate(layouttestdatespan,layouttestdate)"></BUTTON> 

	...
	for(j=0; j<ncol; j++) {
		...
		switch(j) {
			...
			case 1:
				...
				var oDiv = document.createElement("div"); 
				var sHtml = "<BUTTON class=Calendar  id=selectcontractdate onclick='getDate(datespan_"+rowindex+" , date_"+rowindex+")' > </BUTTON><SPAN id='datespan_"+rowindex+"'></SPAN> <input class=inputstyle  type=hidden id='date_"+rowindex+"' name='date_"+rowindex+"'>";
				oDiv.innerHTML = sHtml;   
				oCell.appendChild(oDiv);  
				break;							
			case 2: 

...
budget="0.0";
 ...
 rs.executeSql(sql);
    ...
    response.sendRedirect("HrmTrainPlanEdit.jsp?id="+id);
}
...
if(budget.equals(""))
budget="0.0";
sql="insert into HrmTrainPlan (planname,layoutid ,planorganizer,planstartdate,planenddate,plancontent,planaim,planaddress,planresource,planactor,planbudget,planbudgettype,openrange,createrid,createdate,traindocs) values('"
+name+"',"
+ layoutid+",'"
+ organizer+"','"
+ startdate+"','"

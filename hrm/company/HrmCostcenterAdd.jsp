...
<TABLE class=viewForm width="100%" border=0>
  ...
  <TR>
    ...
    <TD class=FIELD id=Code>
      ...
      <SPAN id=costcentermarkimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
    </TD>
  </TR>
  ...
  <TR>
    ...
    <TD class=FIELD>
      ...
      <SPAN id=costcenternameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
   </TR>
   <TR><TD class=Line colSpan=2></TD></TR> 
   <TR>
...
sub onShowSubcc()
	...
	subccspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

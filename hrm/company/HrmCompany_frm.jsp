...
var contentUrl = (window.location+"").substring(0,(window.location+"").lastIndexOf("/")+1)+"HrmCompany.jsp";
//alert(contentUrl);
...
<IFRAME name=contentframe id=contentframe <%if(!gotopage.equals("")){%>src="<%=gotopage%>?<%=parments%>"<%}else{%>src="HrmCompany.jsp"<%}%> width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
  </TBODY>

...
function initTree(){
	CXLoadTreeItem("", "/hrm/tree/SubcompanyMutiXMLByDec.jsp?onlyselfdept=<%=onlyselfdept%>&excludeid=<%=excludeid%><%if(nodeid!=null){%>&init=true&nodeid=<%=nodeid%><%}%>&mathrandom="+Math.random());

...
function initTree(){
CXLoadTreeItem("", "/hrm/tree/SubcompanySingleXMLByDec.jsp?rightStr=<%=rightStr%>&onlyselfdept=<%=onlyselfdept%>&excludeid=<%=excludeid%><%if(nodeid!=null){%>&init=true&nodeid=<%=nodeid%><%}%>&mathrandom="+Math.random());

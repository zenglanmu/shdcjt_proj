...
while(en.hasMoreElements()){
    ...
    if(paramName.indexOf("column_")>-1) {
     customFieldMap.put(paramName.substring(7),Util.fromScreen2(request.getParameter(paramName),user.getLanguage()));
    }
}
...
HrmSearchComInfo.setCustomField(customFieldMap);
//×Ô¶¨Òå×Ö¶Î
...
if(from.equals("reportall")){
	response.sendRedirect("/hrm/report/resource/HrmRpResourceResult.jsp");
}

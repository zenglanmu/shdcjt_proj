  ...
  <TR class=spacing style="height:2px">
    <TD class=line1 colSpan=2 ></TD></TR>
        ...
        <TR>
          ...
          <TD class=Field><input class=inputstyle maxLength=3 type=text size=8 name="inceptipaddressA" onBlur="checkcount1(this),CheckIntRange1(this),checkinputip('inceptipaddressimage')" value = "<%=inceptipaddressA%>">.<input class=inputstyle maxLength=3 type=text size=8 name="inceptipaddressB" onBlur="checkcount1(this),CheckIntRange(this),checkinputip('inceptipaddressimage')" value = "<%=inceptipaddressB%>">.<input class=inputstyle maxLength=3 type=text size=8 name="inceptipaddressC" onBlur="checkcount1(this),CheckIntRange(this),checkinputip('inceptipaddressimage')" value = "<%=inceptipaddressC%>">.<input class=inputstyle maxLength=3 type=text size=8 name="inceptipaddressD" onBlur="checkcount1(this),CheckIntRange(this),checkinputip('inceptipaddressimage')" value = "<%=inceptipaddressD%>">
          <SPAN id=inceptipaddressimage><%if(inceptipaddressA.equals("")&&inceptipaddressB.equals("")&&inceptipaddressC.equals("")&&inceptipaddressD.equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></TD>
        </TR>
		<TR>
          <TD><%=SystemEnv.getHtmlLabelName(21388,user.getLanguage())%></TD>
          <TD class=Field><input class=inputstyle maxLength=3 type=text size=8 name="endipaddressA" onBlur="checkcount1(this),CheckIntRange1(this),checkinputipB('endipaddressimage')" value = "<%=endipaddressA%>">.<input class=inputstyle maxLength=3 type=text size=8 name="endipaddressB" onBlur="checkcount1(this),CheckIntRange(this),checkinputipB('endipaddressimage')" value = "<%=endipaddressB%>">.<input class=inputstyle maxLength=3 type=text size=8 name="endipaddressC" onBlur="checkcount1(this),CheckIntRange(this),checkinputipB('endipaddressimage')" value = "<%=endipaddressC%>">.<input class=inputstyle maxLength=3 type=text size=8 name="endipaddressD" onBlur="checkcount1(this),CheckIntRange(this),checkinputipB('endipaddressimage')" value = "<%=endipaddressD%>">
		  <SPAN id=endipaddressimage><%if(endipaddressA.equals("")&&endipaddressB.equals("")&&endipaddressC.equals("")&&endipaddressD.equals("")){%><IMG src="/images/BacoError.gif" align=absMiddle><%}%></SPAN></TD>
        </TR>
		  <TR>
          <TD><%=SystemEnv.getHtmlLabelName(21386,user.getLanguage())%></TD>
          <TD class=Field><input class=inputstyle type=text size=60 name="segmentdesc" value="<%=segmentdesc%>">
          </TD>
        </TR>
        <TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 

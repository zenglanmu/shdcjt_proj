...
String sql = "";
if(!olddepartment.equals("")){
  sql = "select count(t1.id) from HrmStatusHistory t1,HrmJobtitles t2 where type_n = 7 "+sqlwhere;
}else{
...
String sqlstr = "";
if(!olddepartment.equals("")){
  sqlstr = "select t1.* from HrmStatusHistory t1,HrmJobtitles t2 where type_n = 7 "+sqlwhere+" order by changedate desc";
}else{
...
RCMenuHeight += RCMenuHeightStep ;
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",/hrm/report/rehire/HrmRpRehire.jsp,_self} " ;
RCMenuHeight += RCMenuHeightStep ;
%>	
...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmRpRehireDetail.jsp">
...
<tr>
    <TD ><%=SystemEnv.getHtmlLabelName(16010,user.getLanguage())%></TD>
    <TD class=Field>
    ...
    <TD ><%=SystemEnv.getHtmlLabelName(16011,user.getLanguage())%></TD>
    <TD class=Field>
...
<tr>    
    <td ><%=SystemEnv.getHtmlLabelName(16005,user.getLanguage())%></td>
    <td class=field >

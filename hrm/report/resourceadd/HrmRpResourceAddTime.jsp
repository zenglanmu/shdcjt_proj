...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmRpResourceAddTime.jsp">
<%
   GraphFile.init ();
   ...
   GraphFile.setPiclable (  SystemEnv.getHtmlLabelName(16024,user.getLanguage()) );
   GraphFile.newLine ();
   ...
   for(int month = 1;month<13;month++){
	   ...
	   sql = "select count(t1.id) resultcount from HrmResource t1 where (t1.accounttype is null or t1.accounttype=0) and 4 = 4 "+sqlwhere;
	   //out.println(sql+"<br>");		     	   
	   rs.executeSql(sql);
	   rs.next();

...
String sql = "select count(id) from HrmStatusHistory t1 where type_n = 6 "+sqlwhereyear;
rs.executeSql(sql);
rs.next();
total = rs.getInt(1);
%>
...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmRpRetireTime.jsp">
<%
   GraphFile.init ();
   ...
   GraphFile.setPiclable ( SystemEnv.getHtmlLabelName(16028,user.getLanguage()) );
   GraphFile.newLine ();
   ...
   for(int month = 1;month<13;month++){
	   ...
	   sql = "select count(t1.id) resultcount from HrmStatusHistory t1 where type_n = 6 "+sqlwhere;		     
	   rs.executeSql(sql);
	   rs.next();

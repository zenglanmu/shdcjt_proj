...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmExtendReport.jsp">
...
<%     
     for(int month = 1;month<13;month++){   
	   ...
	   sql = "select count(t1.id) resultcount from HrmStatusHistory t1,HrmJobTitles t3 where type_n = 3 and t1.oldjobtitleid = t3.id and t3.jobdepartmentid = "+resultid+sqlwhere;
	   //out.println(sql+"<br>");		     	   
	   rs.executeSql(sql);
	   rs.next();	   

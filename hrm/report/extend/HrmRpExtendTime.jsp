...
String sql = "select count(id) from HrmStatusHistory t1 where type_n = 3 "+sqlwhereyear;
rs.executeSql(sql);
rs.next();
total = rs.getInt(1);
%>
...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmRpExtendTime.jsp">
<%
   GraphFile.init ();
   ...
   for(int month = 1;month<13;month++){
	   ...
	   sql = "select count(t1.id) resultcount from HrmStatusHistory t1 where type_n = 3 "+sqlwhere;		     
	   rs.executeSql(sql);
	   rs.next();

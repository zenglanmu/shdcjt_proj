...
String titlename = SystemEnv.getHtmlLabelName(179 , user.getLanguage()) + "£º" + SystemEnv.getHtmlLabelName(515,user.getLanguage()) ; 
String needfav ="1";
String needhelp ="";
...
<TABLE class=viewForm width="100%">
  <TBODY>
  <TR class=title>
    <TH><%=SystemEnv.getHtmlLabelName(15861,user.getLanguage())%>£º<%=total%></TH>
  </TR>
  </TBODY></TABLE>

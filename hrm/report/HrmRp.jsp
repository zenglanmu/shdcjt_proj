...
<TABLE CLASS=viewForm>
        ...
        <tr><TD><A  href="/hrm/report/schedulediff/HrmRpTimecard.jsp">打卡数据报表</TD></tr>
        <tr><TD><A  href="/hrm/report/schedulediff/HrmArrangeShiftReport.jsp">排班管理报表</TD></tr>
      </TABLE>           
	</TD>
	<TD></TD>
	<TD VALIGN=Top>
        ...
        <!--tr> 
          <td><a href="/cpt/report/CptRpCarDriver.jsp">驾驶员统计表</a></td>
        </tr -->
		</TABLE>
<%if(software.equals("ALL") || software.equals("HRM")){%>		
		<TABLE class=ViewForm>

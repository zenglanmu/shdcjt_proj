...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmRedeployReport.jsp">
...
<%
   ...
   String sql = "select distinct(t2.id) resultid from HrmStatusHistory t1,HrmDepartment t2,HrmJobTitles t3 where t1.newjobtitleid = t3.id and t3.jobdepartmentid = t2.id";
   rs2.executeSql(sql);
   while(rs2.next()){   
...
<%     
     for(int month = 1;month<13;month++){   
	   ...
	   sql = "select count(t1.id) resultcount from HrmStatusHistory t1,HrmJobTitles t3 where t1.type_n = 4 and t1.newjobtitleid = t3.id and t3.jobdepartmentid = "+resultid+sqlwhere;
	   //out.println(sql+"<br>");		     	   
	   rs.executeSql(sql);
	   rs.next();	   

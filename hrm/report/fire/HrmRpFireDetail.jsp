...
String sql = "";
if(!olddepartment.equals("")){
  sql = "select count(t1.id) from HrmStatusHistory t1,HrmJobtitles t2 where type_n = 1 "+sqlwhere;
}else{
...
String sqlstr = "";
if(!olddepartment.equals("")){
  sqlstr = "select t1.* from HrmStatusHistory t1,HrmJobtitles t2 where type_n = 1 "+sqlwhere+" order by changedate desc";
}else{
...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmRpFireDetail.jsp">
...
<tr>    
    <td ><%=SystemEnv.getHtmlLabelName(15976,user.getLanguage())%></td>

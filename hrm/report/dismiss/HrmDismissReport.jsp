...
<tr>
<td valign="top">
<form name=frmmain method=post action="HrmDismissReport.jsp">
...
<%
   ...
   String sql = "select distinct(t3.jobdepartmentid) resultid from HrmStatusHistory t1,HrmResource t2,HrmJobTitles t3,HrmDepartment t4 where (t2.accounttype is null or t2.accounttype=0) and t1.resourceid=t2.id and t2.jobtitle = t3.id";
...
<%     
	 for(int month = 1;month<13;month++){ 
	   ...
	   sql = "select count(t1.id) resultcount from HrmStatusHistory t1,HrmResource t2,HrmJobTitles t3 where (t2.accounttype is null or t2.accounttype=0) and type_n = 5 and t1.resourceid=t2.id and t2.jobtitle = t3.id and t3.jobdepartmentid = "+resultid+sqlwhere;
	   //out.println(sql+"<br>");	
	   rs.executeSql(sql);
	   rs.next();	   

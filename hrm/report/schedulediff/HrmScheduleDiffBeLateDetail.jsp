...
<%
   ExcelFile.init ();
   String fileName = fromDate+" "+SystemEnv.getHtmlLabelName(15322,user.getLanguage())+" "+toDate+" "+SystemEnv.getHtmlLabelName(20088,user.getLanguage()) ;
...
<%
   ...
   er.addStringValue(SystemEnv.getHtmlLabelName(20035,user.getLanguage()), "Header" ) ;  
%>

...
<%
   ExcelFile.init ();
   String fileName = fromDate+" "+SystemEnv.getHtmlLabelName(15322,user.getLanguage())+" "+toDate+" "+SystemEnv.getHtmlLabelName(20094,user.getLanguage()) ;
...
<%
   ...
   er.addStringValue(SystemEnv.getHtmlLabelName(20096,user.getLanguage()), "Header" ) ;   
%>
...
<%  
	...
	sb.append(" select c.departmentId,c.lastName,b.fromDate,b.fromTime,b.toDate,b.toTime,a.status ")
	  .append("   from Workflow_Requestbase a,Bill_BoHaiOut b,HrmResource c ")
    ...
    while(RecordSet.next()){
		...
		//outDays=HrmScheduleDiffUtil.getTotalWorkingDays(tempFromDate,tempFromTime,tempToDate,tempToTime);
		outDays=HrmScheduleDiffUtil.getTotalWorkingDays(tempFromDate,tempFromTime,tempToDate,tempToTime,subCompanyId);

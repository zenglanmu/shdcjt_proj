...
<%
   ExcelFile.init ();
   String fileName = fromDate+" "+SystemEnv.getHtmlLabelName(15322,user.getLanguage())+" "+toDate+" "+SystemEnv.getHtmlLabelName(20093,user.getLanguage()) ;
...
<%
   ...
   er.addStringValue(SystemEnv.getHtmlLabelName(20095,user.getLanguage()), "Header" ) ;   
%>
...
<%  
    ...
    while(RecordSet.next()){
		...
		//evectionDays=HrmScheduleDiffUtil.getTotalWorkingDays(tempFromDate,tempFromTime,tempToDate,tempToTime);
		evectionDays=HrmScheduleDiffUtil.getTotalWorkingDays(tempFromDate,tempFromTime,tempToDate,tempToTime,subCompanyId);
        ...
        er.addStringValue(evectionDays);
%>
<tr class="<%=trClass%>">

...
<tr>    
    ...
    гн<BUTTON type=button class=calendar id=SelectDate onclick=getDate(enddatespan,enddate)></BUTTON>&nbsp;
    ...
    гн<BUTTON type=button class=calendar id=SelectDate onclick=getDate(endTodatespan,endTodate)></BUTTON>&nbsp;
...
<tr>    
    ...
    гн<BUTTON type=button type=button class=Clock  onclick=onShowTime(endtimespan,endtime)></BUTTON>&nbsp;
    ...
    гн<BUTTON type=button class=Clock  onclick=onShowTime(endTotimespan,endTotime)></BUTTON>&nbsp;

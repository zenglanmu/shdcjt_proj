...
<%
   ExcelFile.init ();
   String fileName = fromDate+" "+SystemEnv.getHtmlLabelName(15322,user.getLanguage())+" "+toDate+" "+SystemEnv.getHtmlLabelName(20089,user.getLanguage()) ;
...
<%
   ...
   er.addStringValue(SystemEnv.getHtmlLabelName(20039,user.getLanguage()), "Header" ) ;  
%>
...
<%  
	...
	for(int i=0 ; i<scheduleList.size() ; i++ ) {
		...
		tempSignDate=Util.null2String((String)scheduleMap.get("signDate"));
		tempSignTime=Util.null2String((String)scheduleMap.get("signTime"));
        ...
        er.addStringValue(tempSignTime);

...
RCMenu += "{"+SystemEnv.getHtmlLabelName(83,user.getLanguage())+",/systeminfo/SysMaintenanceLog.jsp?sqlwhere=where operateitem="+65+",_self} " ;
RCMenuHeight += RCMenuHeightStep ;
}
%>	
...
<%
    rs.executeProc("HrmJobCall_Select","");
    int needchange = 0;
      while(rs.next()){
...
%>
  ...
  <%  	}
  %>
    <TD><a href="HrmJobCallEdit.jsp?id=<%=rs.getString(1)%>"><%=name%></TD>
    <TD><%=description%></a></TD>

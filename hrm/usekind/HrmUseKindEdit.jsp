...
if(HrmUserVarify.checkUserRight("HrmUseKind:Log", user)){
RCMenu += "{"+SystemEnv.getHtmlLabelName(83,user.getLanguage())+",/systeminfo/SysMaintenanceLog.jsp?sqlwhere=where operateitem="+64+" and relatedid="+id+",_self} " ;
RCMenuHeight += RCMenuHeightStep ;
}

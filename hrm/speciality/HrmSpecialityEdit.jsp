...
RCMenu += "{"+SystemEnv.getHtmlLabelName(83,user.getLanguage())+",/systeminfo/SysMaintenanceLog.jsp?sqlwhere=where operateitem="+63+" and relatedid="+id+",_self} " ;
RCMenuHeight += RCMenuHeightStep ;
}

...
String needusbnetwork = settings.getNeedusbnetwork();// «∑Ò∆Ù”√usbÕ¯∂Œ≤ﬂ¬‘
	...
	<td valign="top">
			  ...
			  <TABLE class=ViewForm>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
					<% if(canedit) { %>
					<input accesskey=Z name=remindperiod  value="<%=remindperiod%>" maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<% } else {%>
        ...
        <br>
			   <TABLE class=ViewForm>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
				  <%if(canedit){ %>
					<input  name=minpasslen value="<%=minpasslen%>"  maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<%}else{ %>
        ...
        <br>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
				  	<%if(canedit){ %>
					<input  name=ChangePasswordDays value="<%=ChangePasswordDays%>"  maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<%}else{ %>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
				  <%if(canedit){ %>
					<input  name=DaysToRemind value="<%=DaysToRemind%>"  maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<%}else{ %>
		...
		<TABLE class=ViewForm>
				...
				<tr id="sumPasswordLockTr" style='display:<%=PasswordLockInfo %>;'>
                  ...
                  <td width="79%" class=Field>
                  <%if(canedit){ %>
                    <input type="text" class="InputStyle" size=10 maxlength=8 name="sumPasswordLock" value="<%=sumPasswordLock %>" onBlur='checknumber("sumPasswordLock")'>
                    <%}else{ %>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
					<% if(canedit) { %>
					<input accesskey=Z name=birthremindperiod  value="<%=birthremindperiod%>" maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<% } else {%>
			  ...
			  <br>
			   <TABLE class=ViewForm>
				...
				<tr>
					...
					<td width="79%" class=Field>
						<select name=usbType onChange="usbTypeChange()" <% if(!canedit) { %>disabled<%}%>>
							...
							<option value="3" <%if("3".equals(usbType)){%>selected<%}%> >∂ØÃ¨¡Ó≈∆</option>
						</select>
					</td>
				</tr>
				<TR><TD class=Line colSpan=2></TD></TR>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
					<% if(canedit) { %>
					<input accesskey=Z name=firmcode  value="<%=firmcode%>" maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<% } else {%>
				...
				<tr>
				  ...
				  <td class=Field>
					<% if(canedit) { %>
					<input accesskey=Z name=usercode  value="<%=usercode%>" maxlength="50" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<% } else {%>
              ...
              <br>
			   <TABLE class=ViewForm>
				...
				<tr>
				  ...
				  <td width="79%" class=Field>
					<% if(canedit) { %>
					<input accesskey=Z name=dynapasslen  value="<%=dynapasslen%>" maxlength="1" style="width :50%" onKeyPress="ItemCount_KeyPress()" onBlur='checkcount1(this)' class="InputStyle">
					<% } else {%>
					<%=dynapasslen%>
					<%}%>
				  </td>
...
function onSubmit()
{
	if(document.frmMain.openPasswordLock.checked == true){
		...
		if(sumPasswordLock == null || sumPasswordLock == '' || sumPasswordLock == '0'){
			alert('<%=SystemEnv.getHtmlLabelName(24082,user.getLanguage())%>0!');
			return;
		}
	}
	if(document.getElementById("dynapasslen") && document.getElementById("dynapasslen").value > 8){
		alert('<%=SystemEnv.getHtmlLabelName(26018,user.getLanguage())%>');

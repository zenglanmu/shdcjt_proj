...
%>
   ...
   <TR> 
    ...
    <TD class=Field> 
      <input class=inputstyle  maxLength=30 size=5 name="checkexpecd" value="<%=checkexpecd%>" onchange='checkinput("checkexpecd","checkexpecdspan")' onKeyPress="ItemCount_KeyPress()">天
...
<TR><TD class=Line colSpan=2></TD></TR> 
     <TR> 
          <TR>
            ...
            <TD class=Field><BUTTON class=Calendar id=selectcontractbegintime onClick="getHrmDate(checkstartdatespan,checkstartdate)"></BUTTON> 
        ...
        <TABLE width=100%  class=ListStyle cellspacing=1 cols=3 id="trainTable">
          ...
          <TR class=header> 
			...
			<Td align=right colspan=2>
			 <BUTTON class=btnNew accessKey=A onClick="addtrainRow();"><U>A</U>-<%=SystemEnv.getHtmlLabelName(551,user.getLanguage())%></BUTTON>
			 <BUTTON class=btnDelete accessKey=D onClick="javascript:if(isdel()){deletetrainRow1()};"><U>D</U>-<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></BUTTON>	
 		    </Td>
          </TR>
...
<%		}%>
            <TD align="center" class="Field" width=20>
                <DIV>
                <input class=inputstyle type='checkbox' name='check_train' value='0'>
                </DIV>
            </td>
            <TD class=Field>
                <DIV>
                   <BUTTON class=Browser onClick="onShowJobID(jobidspan_<%=trainrowindex%>,jobid_<%=trainrowindex%>)">
                   </BUTTON>
        ...
        <TABLE width="100%"  class=ListStyle cellspacing=1 cols=3 id="cerTable">
          ...
          <TR class=header> 
			...
			<Td align=right colspan=3>
			 <BUTTON class=btnNew accessKey=A onClick="addcerRow();"><U>A</U>-<%=SystemEnv.getHtmlLabelName(551,user.getLanguage())%></BUTTON>
			 <BUTTON class=btnDelete accessKey=D onClick="javascript:if(isdel()){deletecerRow1()};"><U>D</U>-<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></BUTTON>	
 		    </Td>
          </TR>
          <TR class=spacing style="display:none"> 
...
<%		}%>
            <TD align="center" class=Field width=20>
              <input class=inputstyle type='checkbox' name='check_cer' value='0'>
            </td>
	       
	        <TD class=Field>
             <BUTTON class=Browser onClick="onShowCheckID(checkitemidspan_<%=cerrowindex%>,checkitemid_<%=cerrowindex%>)"></BUTTON> 
    ...
    <%=Util.toScreen(CheckItemComInfo.getCheckName(checkitemid),user.getLanguage())%>
	        ...
	        <TD class=Field>
                <input class=inputstyle type=text style='width:30%' name="checkitemproportion_<%=cerrowindex%>" value="<%=checkitemproportion%>">%
        ...
        <TABLE width="100%"  class=ListStyle cellspacing=1 cols=4 id="rewardTable">
          ...
          <TR class=header> 
			...
			<Td align=right colspan=1>
			 <BUTTON class=btnNew accessKey=A onClick="addrewardRow();"><U>A</U>-<%=SystemEnv.getHtmlLabelName(551,user.getLanguage())%></BUTTON> 
			 <BUTTON class=btnDelete accessKey=D onClick="javascript:if(isdel()){deleterewardRow1()};"><U>D</U>-<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%></BUTTON>
 		    </Td>
          </TR>
          <TR class=spacing style="display:none"> 
...
<%		}%>
        ...
        <TD class=Field>
                <input class=inputstyle type=text style='width:30%' name="checkproportion_<%=rewardrowindex%>" value="<%=checkproportion%>">%

...
%>
   ...
   <TR> 
    ...
    <TD class=Field>    
      <SPAN id=checkexpecdspan><%=checkexpecd%></SPAN>天
    </TD>
  </TR>
<TR style="height:1px"><TD class=Line colSpan=2></TD></TR> 
     <TR> 

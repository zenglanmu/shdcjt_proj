...
rs.executeSql(sql);
while(rs.next()){
	s += "<tree text=\""+rs.getString("subject")+"\" icon=\"/images_face/ecologyFace_2/LeftMenuIcon/level3.gif\" action=\"javascript:window.open('/voting/VotingPoll.jsp?votingid="+rs.getInt("id")+"', '','toolbar,resizable,scrollbars,dependent,height=600,width=800,top=0,left=100');void(0);\" />";
}

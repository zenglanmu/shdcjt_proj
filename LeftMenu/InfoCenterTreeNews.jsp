...
while(rs.next()){
	...
	s += "<tree text='"+rs.getString("menuName")+"' icon='/images_face/ecologyFace_2/LeftMenuIcon/level3.gif' action='"+rs.getString("linkAddress")+"'>";
	s += "</tree>";
}

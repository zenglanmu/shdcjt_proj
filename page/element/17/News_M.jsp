												 ...
												 if ("docdocsubject".equals(columnName)) {
													...
													if(!"".equals(newstemplateid)){
														if ("1".equals(linkmode)) {
															showValue = "<a href='/page/maint/template/news/newstemplate.jsp?templateid="+newstemplateid+"&docid="+ docid	+ "' target='_self'>"+ cloumnValue + "</a>\n";
														} else {
															showValue = "<a href=\"javascript:openFullWindowForXtable('/page/maint/template/news/newstemplate.jsp?templateid="+newstemplateid+"&docid="+ docid+ "')\">"+ cloumnValue+ "</a>\n";
														}
													}else{
														if ("1".equals(linkmode)) {

...
%>
<iframe id="ifrm_<%=eid%>" name="ifrm_<%=eid%>" BORDER=0 FRAMEBORDER="no" NORESIZE=NORESIZE  
width="100%" height="<%=strHeight%>"  scrolling="auto" src="<%=strAddr%>" onload='onLoadComplete(this)'></iframe>

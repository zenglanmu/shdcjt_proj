...
<%} else if("style".equals(type)){%>	
	<table class="viewform" width="100%">
		...
		<tr>
			...
			<td class="field"><input name="eLogo_<%=eid%>" onchanage="setElementLogo('<%=eid%>',this.value)" id="eLogo_<%=eid%>" <%if(!"2".equals(esharelevel)) out.println("disabled");%>  class="filetree" type="text" value="<%=hpec.getLogo(eid)%>">

...
<script src="/js/weaver.js" type="text/javascript"></script>
<script src="/js/jquery/jquery.js" type="text/javascript"></script>
<script src="/js/jquery/plugins/jqueryFileTree/jquery.easing.js"
	type="text/javascript"></script>
<script src="/js/jquery/plugins/jqueryFileTree/jqueryFileTree.js"
	type="text/javascript"></script>
<script type="text/javascript" src="/js/page/swfupload/swfupload.js"></script>
<script type="text/javascript" src="/js/page/swfupload/swfupload.queue.js"></script>
<script type="text/javascript" src="/js/page/swfupload/fileprogress.js"></script>
<script type="text/javascript" src="/js/page/swfupload/handlers.js"></script>

<link href="/js/jquery/plugins/jqueryFileTree/jqueryFileTree.css" rel="stylesheet" type="text/css" media="screen" />
<link href="/js/page/swfupload/default.css" rel="stylesheet" type="text/css" />
...
<%if(user.getLanguage()==7) {%>
	<script type="text/javascript" src="/js/page/maint/common/lang-cn.js"></script>
<%} else if(user.getLanguage()==8) {%>
	<script type='text/javascript' src='/js/page/maint/common/lang-en.js'></script>
<%} else if(user.getLanguage()==9) {%>
	<script type='text/javascript' src='/js/page/maint/common/lang-tw.js'></script>
<%}%>
...
<script type="text/javascript">
 ...
 var swfu;
		...
		function init() {
            ...
            button_text_style : '.button {color:#414141; font-family:Î¢ÈíÑÅºÚ; FONT: 11px arial,tahoma,verdana,helvetica; } .buttonSmall { font-size: 10pt; }',
...
<script src="/js/page/maint/common/userresourcebrowse.js" type="text/javascript"></script>
</HTML>

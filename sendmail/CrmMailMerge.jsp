		...
		<td valign="top">
			...
			<COL WIDTH="35%"><COL WIDTH="65%">
			 ...
			 <TR>
				...
				<TD Class=Field><INPUT TYPE=TEXT ID=subject NAME=subject class="InputStyle" SIZE=80 MAXLENGTH=255  onchange='checkinput("subject","subjectimage")'><SPAN id=subjectimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
			  </TR>
...
<SCRIPT language="javascript" defer="defer" src="/js/selectDateTime.js"></script>

...
%>
	<TR CLASS=<%if(isLight){%>DataLight<%}else{%>DataDark<%}%>>
          ...
          <TD>
			...
			<img src="/images/project_rank.gif" alt="<%=RecordSet.getString("wbscoding")%>"><a href="/proj/plan/ViewTaskProcess.jsp?taskrecordid=<%=RecordSet.getString("id")%>" title="<%=RecordSet.getString("wbscoding")%>"><%=RecordSet.getString("subject")%></a>
              <%

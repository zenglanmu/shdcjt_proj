...
<SCRIPT language="javascript" src="/js/projTask/ProjTask.js"></script>
</HEAD>
<%
      ...
      <COLGROUP>
        ...
        <TD><%=SystemEnv.getHtmlLabelName(1323,user.getLanguage())%></TD>
         ...
         <TD><%=SystemEnv.getHtmlLabelName(1324,user.getLanguage())%></TD>
          ...
          <TR>
         <TD>项目预算</TD>
          <TD class=Field><INPUT class=inputstyle maxLength=20 size=20 name="fixedcost" value="<%=RecordSet.getString("fixedcost")%>" onKeyPress="ItemNum_KeyPress()" onBlur='checknumber("fixedcost")'>元<SPAN id=workdayimage></SPAN></TD>
         </TR><TR style="height:1px;"><TD class=Line colSpan=2></TD></TR>
       <TR>

  ...
  <col width="10%">
	<TR CLASS=<%if(isLight){%>DataLight<%}else{%>DataDark<%}%>>
          ...
          <TD>
			...
			<img <%if(RecordSet.getInt("level_n")==Util.getIntValue(level) && RecordSet.getInt("childnum")>0){%>src="/images/project_rank2.gif"<%}else{%>src="/images/project_rank1.gif"<%}%> class="project_rank"  onmouseup='rankclick("taskdiv<%=RecordSet.getString("id")%>")'><a href="#" ><%=RecordSet.getString("subject")%></a></TD>

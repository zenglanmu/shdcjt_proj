...
if(relatedRequestId!=-1){
	response.sendRedirect("/proj/process/RequestOperation.jsp?method=add&type=1&ProjID="+ProjID+"&taskid="+taskrecordid+"&requestid="+relatedRequestId+"");
}
int relatedDocId = Util.getIntValue(request.getParameter("docid"),-1);
if(relatedDocId!=-1){
	response.sendRedirect("/proj/process/DocOperation.jsp?method=add&type=1&ProjID="+ProjID+"&taskid="+taskrecordid+"&docid="+relatedDocId+"");
}
//==============================================================================================
...
RCMenu += "{"+SystemEnv.getHtmlLabelName(1290,user.getLanguage())+",/proj/plan/NewPlan.jsp?ProjID="+RecordSet.getString("prjid")+",_self} " ;
RCMenuHeight += RCMenuHeightStep;
%>

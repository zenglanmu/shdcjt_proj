...
%>
	<TR CLASS=<%if(isLight){%>DataLight<%}else{%>DataDark<%}%>>
          ...
          <TD>
			...
			<img src="/images/project_rank.gif" alt="<%=RecordSet2.getString("wbscoding")%>"><a href="/proj/plan/ViewTask.jsp?taskrecordid=<%=RecordSet2.getString("taskrecordid")%>" title="<%=RecordSet2.getString("wbscoding")%>"><%=RecordSet2.getString("subject")%></a></TD>

...
rs.executeSql("SELECT t1.id,t1.name,t1.procode,t1.prjtype,t1.worktype,t1.manager,t1.department,t1.status FROM Prj_ProjectInfo t1,PrjShareDetail t2 "+sqlwhere+" ORDER BY t1.id DESC");
%>
<html>

...
String titlename = SystemEnv.getHtmlLabelName(119,user.getLanguage())+"гн"+SystemEnv.getHtmlLabelName(586,user.getLanguage())+":<a href='/proj/Maint/EditProjectType.jsp?id="+typeid+"'>"+Util.toScreen(prjtypename,user.getLanguage(),"0")+"</a>";
String needfav ="1";
String needhelp ="";
%>
<BODY>

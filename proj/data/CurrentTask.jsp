...
<%
    ...
    String sqlStr = "Select * From Prj_TaskProcess t1, Prj_ProjectInfo t2 Where t1.isdelete =0 and t1.hrmid="+user.getUID()+" and (t1.begindate<='"+CurrentDate+"' or t1.begindate='x') and ( t1.enddate>='"+CurrentDate+"' or t1.enddate='-' ) and t2.id = t1.prjid and t2.status not in (0,6,7)";

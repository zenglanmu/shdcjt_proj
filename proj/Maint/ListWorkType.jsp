...
<%
	RecordSet.executeProc("Prj_WorkType_SelectAll","");
...
RCMenu += "{"+SystemEnv.getHtmlLabelName(82,user.getLanguage())+",/proj/Maint/AddWorkType.jsp,_self} " ;
...
<%		}else{%>
	<TR CLASS=DataDark>
<%		}%>
		<TD><a href="/proj/Maint/EditWorkType.jsp?id=<%=RecordSet.getString(1)%>"><%=Util.toScreen(RecordSet.getString(2),user.getLanguage())%></a></TD>

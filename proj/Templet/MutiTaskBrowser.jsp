		...
		<td valign="top">
		   ...
		   <tr>  
			 ...
			 <TD class=Field colspan="2">&nbsp;
					  ...
					  гн	<BUTTON class=calendar id=SelectDate onclick=getDate(begindate02span,begindate02)></BUTTON>&nbsp;
			 ...
			 <TD class=Field colspan="2">&nbsp;
					  ...
					  гн	<BUTTON class=calendar id=SelectDate onclick=getDate(enddate02span,enddate02)></BUTTON>&nbsp;

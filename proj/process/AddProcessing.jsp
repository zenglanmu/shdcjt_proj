  	...
  	<COL width="35%">
        ...
        <TR>
          ...
          <BUTTON class=Browser onClick="onShowPlanID()"></BUTTON> <span 
            id=planspan><IMG src='/images/BacoError.gif' align=absMiddle></span> 
              <%}else{%>
          ...
          <TD class=Field colspan=3><INPUT class=inputstyle maxLength=150 size=50 name="title" onchange='checkinput("title","titleimage")'><SPAN id=titleimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
         </TR>   <TR class=spacing>
          <TD class=line colSpan=4></TD></TR>     
         <tr>
...
sub onShowPlanID()
	...
	planspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

...
<table class=liststyle cellspacing=1 >
  <tr class=datadark>
     ...
     <TD class=Field>
			  ...
			  гн	<BUTTON class=calendar id=SelectDate onclick=getProjSubDate(begindate02span,begindate02)></BUTTON>&nbsp;
     ...
     <TD class=Field>
			  ...
			  гн	<BUTTON class=calendar id=SelectDate onclick=getProjSubDate(enddate02span,enddate02)></BUTTON>&nbsp;
...
%>
	<TR CLASS=<%if(isLight){%>DataLight<%}else{%>DataDark<%}%>>
          ...
          <TD>
			...
			<img src="/images/project_rank.gif"><a href="/proj/process/ViewTask.jsp?taskrecordid=<%=RecordSet2.getString("id")%>" ><%=RecordSet2.getString("subject")%></a></TD>
          <TD nowrap>
<%
		String temptaskid="";
...
%>
			<%if(!temprequestcount.equals("0")){%>
				<a href="/proj/process/ViewTask.jsp?taskrecordid=<%=RecordSet2.getString("id")%>" ><img src="/images/prj_request.gif" border=0 alt="<%=SystemEnv.getHtmlLabelName(259,user.getLanguage())%>"></a><%=temprequestcount%> 
			<%}%>
			<%if(!tempdoccount.equals("0")){%>
				<a href="/proj/process/ViewTask.jsp?taskrecordid=<%=RecordSet2.getString("id")%>" ><img src="/images/prj_doc.gif" border=0 alt="<%=SystemEnv.getHtmlLabelName(58,user.getLanguage())%>"></a><%=tempdoccount%>
			<%}%>
		  </TD>

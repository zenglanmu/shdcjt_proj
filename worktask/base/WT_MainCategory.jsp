...
<IFRAME name=leftframe id=leftframe src="WT_TreeLeft.jsp" width="100%" height="100%" frameborder=no scrolling=no>
...
<IFRAME name=contentframe id=contentframe src="worktaskSysSet.jsp" width="100%" height="100%" frameborder=no scrolling=auto>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
  </TBODY>

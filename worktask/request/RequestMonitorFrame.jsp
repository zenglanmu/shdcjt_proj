...
function resetbanner(objid, typeid){
	...
	//alert("RequestMonitorList.jsp?wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&type="+typeid+"&type_d=<%=type_d%>&objId=<%=objId%>&years="+years);
	o.location="RequestMonitorList.jsp?wtid="+wtid+"&worktaskStatus="+worktaskStatus+"&type="+typeid+"&type_d=<%=type_d%>&objId=<%=objId%>&years="+years+"&isfromleft=<%=isfromleft%>";
}

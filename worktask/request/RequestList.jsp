...
if(isLiableperson==1 || isCheckor==1 || isCreater==1 || isCoadjutant==1){
	sqlWhere += " and ( ";
	if(isLiableperson == 1){
		sqlWhere += " o.userid = "+user.getUID()+" or";
	}
	if(isCheckor == 1){
...
tableString =" <table instanceid=\"WorktaskRequestTable\" tabletype=\"none\" pagesize=\""+perpage+"\" >"+
                         ...
                         "			<col width=\"11%\"   text=\""+SystemEnv.getHtmlLabelName(63,user.getLanguage())+"\" column=\"taskid\" otherpara=\""+para+"\" orderkey=\"taskid\" transmethod=\"weaver.splitepage.transform.SptmForWorktask.getWorktaskName\"/>"+
                       	 ...
                       	 "			<col width=\"37%\"   text=\""+SystemEnv.getHtmlLabelName(22134,user.getLanguage())+"\" column=\"taskcontent\" otherpara=\"column:id+column:viewtype+column:createrviewtype+column:checkorviewtype+column:userid+column:creater+column:needcheck+column:checkor+column:optstatus+"+user.getUID()+"\" transmethod=\"weaver.splitepage.transform.SptmForWorktask.getWorktaskLinkIcon\" />"+

...
.popupMenuTable{background-image:url(/images/popup/bg_menu.gif);background-repeat:repeat-y;}
...
tree.add(rti = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(2029,user.getLanguage())%>","MailAdd.jsp","","/images/mail_add.gif","/images/mail_add.gif"));

tree.add(rtiInbox = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(19816,user.getLanguage())%>", "MailInbox.jsp", "", "/images/mail_inbox.gif", "/images/mail_inbox.gif"));
rtiInbox.folderId = "0";
<%=getInboxFolderTreeNode(user, 0)%>
tree.add(rtiOutbox = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(2038,user.getLanguage())%>", "MailInbox.jsp?groupId=-1", "", "/images/mail_outbox.gif", "/images/mail_outbox.gif"));
rtiOutbox.folderId = "-1";
tree.add(rtiDraftbox = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(220,user.getLanguage())%>", "MailInbox.jsp?groupId=-2", "", "/images/mail_draft.gif", "/images/mail_draft.gif"));
rtiDraftbox.folderId = "-2";
tree.add(rtiTrashbox = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(19817,user.getLanguage())%>", "MailInbox.jsp?groupId=-3", "", "/images/mail_junk.gif", "/images/mail_junk.gif"));
rtiTrashbox.folderId = "-3";

tree.add(rti = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(19824,user.getLanguage())%>", "MailSearch.jsp", "", "/images/mail_search.gif", "/images/mail_search.gif"));

tree.add(rtiContacter = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(572,user.getLanguage())%>", "MailContacter.jsp", "", "/images/mail_contact.gif", "/images/mail_contact.gif"));
rtiContacter.groupId = "0";
<%=getContacterGroupTreeNode(user, 0)%>

tree.add(rti = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(16218,user.getLanguage())%>", "MailTemplate.jsp", "", "/images/mail_template.gif", "/images/mail_template.gif"));
tree.add(rti = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(24267,user.getLanguage())%>", "MailSign.jsp", "", "/images/mail_template.gif", "/images/mail_template.gif"));
tree.add(rti = new WebFXTreeItem("<%=SystemEnv.getHtmlLabelName(68,user.getLanguage())%>", "MailOption.jsp", "", "/images/mail_option.gif", "/images/mail_option.gif"));
...
function addTreeNode(id, name, flag){
	...
	imgsrc = flag=="folder" ? "/images/mail_folder.gif" : "/images/mail_contact.gif";
...
<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%" class="popupMenuTable">
	<tr height="22">
		<td class="popupMenuRow" menuid="1">
			<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
				<tr>
					<td width="28"><img src="/images/popup/newfolder.gif" /></td>
	...
	<tr height="22">
		<td class="popupMenuRow" menuid="2">
			<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
				<tr>
					<td width="28"><img src="/images/popup/remove.gif" /></td>
...
<!--
	<tr height="22">
		<td class="popupMenuRow" menuid="3">
			<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
				<tr>
					<td width="28"><img src="/images/popup/moveup.gif" /></td>
					<td onclick="">向上移动</td>
				</tr>
			</table>
		</td>
	...
	<tr height="22">
		<td class="popupMenuRow" menuid="4">
			<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
				<tr>
					<td width="28"><img src="/images/popup/movedown.gif" /></td>
					<td onclick="">向下移动</td>
				</tr>
			</table>
		</td>

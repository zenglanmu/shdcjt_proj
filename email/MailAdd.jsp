...
<%
if(true){
	response.sendRedirect("/email/new/MailAdd.jsp");
}
...
<script type="text/javascript" src="/wui/common/js/ckeditor/ckeditorext.js">
</script>
...
function setTemplate(resp){
    ...
    {
         $("mailSubjectSpan").innerHTML="<img src='/images/BacoError.gif' align=\"absMiddle\">";
    }
...
function doSend(obj){
	...
	hideRightClickMenu();
	showMsgBox($("msgBox"), "<img src='/images/loading2.gif'> <%=SystemEnv.getHtmlLabelName(19940,user.getLanguage())%>...", $("mouldtext").parentElement.offsetTop+30);
	/****###@2007-08-28 modify by yeriwei!
...
function doDraft(obj){
	if(!validateForm()) return false;
	hideRightClickMenu();
	showMsgBox($("msgBox"), "<img src='/images/loading2.gif'> <%=SystemEnv.getHtmlLabelName(19941,user.getLanguage())%>...", $("mouldtext").parentElement.offsetTop+30);
	/****##@2007-08-28 modify by yeriwei!
	if(jQuery("#texttype").val()==1){
		editorToTextarea();
	}**/
...
.receiverSelector{
	...
	background-image:url(/images/menuItemBgGray.gif);
	*/
}
	...
	<tr height="22">
		<td class="popupMenuRow" 
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%" height="100%">
				<tr>
					<td width="28"><img src="/images/BacoBrowser.gif"/></td>
...
<tr>
	<td valign="top">
		...
		<td valign="top">
<!--==========================================================================================-->
<form id="weaver" name="weaver" action="MailOperationSend.jsp" method="post" enctype="multipart/form-data">
...
<tr height="20">
	<td valign="top">
	<div id="receiverSelector" class="receiverSelector"><%=SystemEnv.getHtmlLabelName(2046, user.getLanguage())%> <img src="/images/menuArrowDown.gif" align="absmiddle" /></div>
	...
	<td class="Field">
		...
		<span id="receiverSpan"><%if(receiver.equals("")){%><img src='/images/BacoError.gif' align="absMiddle"><%}%></span>
...
<tr id="tdCC" style="display:<%=(!"".equals(_sendcc) && (flag==2 || flag==4))?"block":"none" %>" height="20">
	<td valign="top">
	<div id="receiverSelectorCC" class="receiverSelector"><%=SystemEnv.getHtmlLabelName(2084, user.getLanguage())%>　 <img src="/images/menuArrowDown.gif" align="absmiddle" /></div>
	</td>
	<td class="Field">
...
<tr id="tdBCC" style="display:none" height="20">
	<td valign="top">
	<div id="receiverSelectorBCC" name="receiverSelectorBCC" class="receiverSelector"><%=SystemEnv.getHtmlLabelName(2085, user.getLanguage())%>　 <img src="/images/menuArrowDown.gif" align="absmiddle" /></div>
	</td>
	<td class="Field">
...
<tr height="20">
	...
	<tr>
		...
		<td class="Field">
			...
			<%}%>
			</select><img id="templateLoading" src="/images/loading2.gif" align="absmiddle" />
		</td>
		<!-- 插入图片============================================= -->
		<!---###@2007-08-28 modify by yeriwei!
...
<tr height="20">
	...
	<td class="Field">
		...
		<span id="mailSubjectSpan"><%if("".equals(subject)||null==subject){%><img src='/images/BacoError.gif' align="absMiddle"><%} %></span>
	</td>
</tr>
...
<tr height="20">
	...
	if(flag==3 || flag==4){
		...
		String attachUrl = "";
		while(wmc.next()){
			attachmentNameEncode = new String((wmc.getCurrentFilename()).getBytes("ISO8859_1"), "GBK");

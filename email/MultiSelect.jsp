...
if((tabid.equals("2") && isInit) ||(tabid.equals("0") && nodeid.equals(""))) sqlstr = "select id,lastname,departmentid,jobtitle,email from hrmresource WHERE 1=2";
%>
...
<tr width=100%>
  ...
  <td align="center" valign="center" width="10%">
				...
				<br>
				<img src="/images/arrow_r.gif" style="cursor:hand" title="<%=SystemEnv.getHtmlLabelName(456,user.getLanguage())%>" onClick="javascript:one2two('from','srcList');">
				<br>
				<img src="/images/arrow_out.gif"  style="cursor:hand" title="<%=SystemEnv.getHtmlLabelName(91,user.getLanguage())%>" onclick="javascript:two2one('from','srcList');">				
				<br>
				<img src="/images/arrow_all.gif" style="cursor:hand" title="<%=SystemEnv.getHtmlLabelName(17025,user.getLanguage())%>" onClick="javascript:removeAll('from','srcList');">
				<br>				
				<img src="/images/arrow_all_out.gif"  style="cursor:hand" title="<%=SystemEnv.getHtmlLabelName(16335,user.getLanguage())%>" onclick="javascript:removeAll('srcList','from');">				
				<br>
...
init(jQuery("select[name=from]")[0],jQuery("select[name=srcList]")[0])

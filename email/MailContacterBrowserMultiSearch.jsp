...
<tr>
	<td width=15%><%=SystemEnv.getHtmlLabelName(413,user.getLanguage())//姓名%></td>
	<td width=35% class="field"><input type="text" name="mailUserName" value="<%=mailUserName%>" class="inputstyle"/></td>
	<td></td>	
	<td width=15%><%=SystemEnv.getHtmlLabelName(19805,user.getLanguage())//邮件地址%></td>
	<td width=35% class="field"><input type="text" name="mailAddress" value="<%=mailAddress%>" class="inputstyle"/></td>
</tr>
<tr style="height:1px"><td class="line" colspan="5"></td></tr>
<tr>
	<td width=15%><%=SystemEnv.getHtmlLabelName(63,user.getLanguage())//类型%></td>
	<td width=35% class="field">
	<select name="mailUserType">
		<option></option>
		<option value="2" <%if(mailUserType.equals("2")){out.print("selected");}%>><%=SystemEnv.getHtmlLabelName(179,user.getLanguage())//人力资源%></option>
		<option value="3" <%if(mailUserType.equals("3")){out.print("selected");}%>><%=SystemEnv.getHtmlLabelName(17129,user.getLanguage())//客户联系人%></option>
		<option value="1" <%if(mailUserType.equals("1")){out.print("selected");}%>><%=SystemEnv.getHtmlLabelName(19078,user.getLanguage())//其它人员%></option>
	</select>
	</td>
	<td></td>
	<td></td>

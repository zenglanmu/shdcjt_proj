...
<tr>
	<td><%=SystemEnv.getHtmlLabelName(63,user.getLanguage())//类型%></td>
	<td class="Field">
		<select id="contacterType" name="contacterType" onchange="contacterTypeChange(this)">
		<option value="2"><%=SystemEnv.getHtmlLabelName(179,user.getLanguage())//人力资源%></option>
		<option value="3"><%=SystemEnv.getHtmlLabelName(17129,user.getLanguage())//客户联系人%></option>
		<option value="1"><%=SystemEnv.getHtmlLabelName(19815,user.getLanguage())//CSV格式文件%></option>
		</select>
	</td>
</tr>
</tbody>
...
<tr>
	<td><%=SystemEnv.getHtmlLabelName(1867,user.getLanguage())//人员%></td>
	<td class="Field">
		<button class="Browser" type=button id="btnBrowser" onclick="onShowResourcemail()"></button>
		<span id="resourceidspan" name="resourceidspan"><img src="/images/BacoError.gif" align="absMiddle"></span>
...
<tr style="height:1px"><td class="Line" colspan="2"></td></tr>
<tr>
	<td><%=SystemEnv.getHtmlLabelName(18493,user.getLanguage())//文件%></td>
	<td class="Field">

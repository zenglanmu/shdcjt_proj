		...
		<td valign="top">
		  ...
		  <table class=ListStyle cellspacing="1">
			...
			<tr class=Header> 
			  ...
			  <%=SystemEnv.getHtmlLabelName(2037,user.getLanguage())%> £º
			  <%} else if(mailtype.equals("1")) {%>
			  <%=SystemEnv.getHtmlLabelName(2038,user.getLanguage())%> £º
			  <%} else if(mailtype.equals("2")) {%>
			  <%=SystemEnv.getHtmlLabelName(2039,user.getLanguage())%> £º
			  <%} else if(mailtype.equals("3")) {%>
			  <%=SystemEnv.getHtmlLabelName(2040,user.getLanguage())%> £º
			  <%}%>

...
<tr>
	...
	<td valign="top">
		...
		<%=Util.toScreen("ื้",user.getLanguage(),"0")%></B></TD></TR>
		...
		<TR><TD><%=SystemEnv.getHtmlLabelName(195,user.getLanguage())%></TD><TD CLASS=FIELD>
				...
				<span id=idnamespan><%if(idname.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
			</td>
		</TR>
		...
		<TR><TD><%=SystemEnv.getHtmlLabelName(433,user.getLanguage())%></TD><TD CLASS=FIELD colspan=3>
				...
				<span id=descspan><%if(description.equals("")){%><IMG src='/images/BacoError.gif' align=absMiddle><%}%></span>
			</TD>
		</TR>
		<TR><TD class=Line colSpan=4></TD></TR> 
		</TABLE>
		...
		<col width="25%"><col width="25%"><col width="25%"><col width="25%">
		 <TBODY>
		 <tr >    <td><%=SystemEnv.getHtmlLabelName(71,user.getLanguage())%><%=Util.toScreen("ื้",user.getLanguage(),"0")%><%=SystemEnv.getHtmlLabelName(431,user.getLanguage())%>
		 </td>
		...
		<col width="25%"><col width="25%"><col width="25%"><col width="25%"> 
		<TR class=Header>
		 <th><%=SystemEnv.getHtmlLabelName(71,user.getLanguage())%><%=Util.toScreen("ื้",user.getLanguage(),"0")
		  %></th>

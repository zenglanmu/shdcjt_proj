...
<div style="position:relative;height:100%">
    ...
    <div  style="position:absolute;left:63px;top:5px;font-size:12px;height:16px;right:25px;">
       ...
       %>
           <img src="/wui/theme/ecology7/page/images/skin/skinSetting.png" title="<%=SystemEnv.getHtmlLabelName(27714, user.getLanguage())%>" style="height:16px;widht:16px;display:block;cursor:pointer;" onclick="javascript:showSkinListDialog();" id="themeQh"/>
       <%
       }
       %>    
       </span>
	...
	<div  style="position:absolute;width:170px;height:18px;left:8px;top:66px;">
		<table width="100%" cellpadding="0px" cellspacing="0px" id="tblHrmToolbr" align="left">
			<tr>
				...
				<td width="24px"><a  href="/org/OrgChartHRM.jsp" title='<%=SystemEnv.getHtmlLabelName(16455,user.getLanguage())%>'  target="mainFrame" style><span style="cursor:pointer;height:16px;width:16px;display:block;overflow:hidden;background:url(/wui/theme/ecology7/page/images/hrminfo/org.png) no-repeat;"></span></a></td>

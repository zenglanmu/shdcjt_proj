                  ...
                  <table class=viewform cellspacing=1 >
                      ...
                      <tr>
                        ...
                        <tr>
                          ...
                          <td width="80%" class="Field">
                              <textarea type="text" class=inputstyle cols=120 rows=4 name="sqlwhere_<%=recordexindex%>" onChange="dochange()" ><%=Util.convertDB2Input(sqlwhere)%></textarea><br><font color="red"><%=SystemEnv.getHtmlLabelName(20733,user.getLanguage())%></font>
                          </td>
                        </tr>
                        <tr class="spacing"><td class="line" colspan="2"></td></tr>
                        <tr class="title">

	...
	var loading="<img src='/js/src/widget/templates/images/progress.gif'/>&nbsp;"+msg;
    ...
    function doGet(tab, str) {
        ...
        tab.innerHTML = "<img src='/js/src/widget/templates/images/progress.gif'/>&nbsp;"+msg;
        var bindArgs = {
            url:  str,
    ...
    function doPost(form,container) {
        ...
        dojo.io.bind(kw);
        container.innerHTML = "<img src='/js/src/widget/templates/images/progress.gif'/>&nbsp;"+msg;
        return false;

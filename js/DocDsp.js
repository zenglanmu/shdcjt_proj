...
Ext.onReady(function(){
	...
	if (canViewLog) {
		strTable+="<td  style='padding-right:5px'><a onClick='DocAllPropPanel.expand(true);DocSetTabPanel.setActiveTab(\"DocDetailLog\");'><img align='absmiddle' src='/images/docs/read.png'>&nbsp;"+wmsg.base.readcount+":<font color='red'>"+readCount_int+"</font></a></td>";
	}	else {
		strTable+="<td  style='padding-right:5px'><img align='absmiddle' src='/images/docs/read.png'>&nbsp;"+wmsg.base.readcount+":<font color='red'>"+readCount_int+"</font></td>";
	}
	
	if (canReplay) {
		strTable+="<td  style='padding-right:5px'><a onClick='DocAllPropPanel.expand(true);DocSetTabPanel.setActiveTab(\"DocReply\");'><img align='absmiddle' src='/images/docs/reply.png'>&nbsp;"+wmsg.base.replycount+":<font color='red'  id='fontReply'>0</font></a></td>";
	}
	
	
	
	
	strTable+="<td width='100px'><a onClick='DocAllPropPanel.expand(true);DocSetTabPanel.setActiveTab(\"DocImgs\");'><img align='absmiddle' src='/images/docs/acc.png'>&nbsp;"+wmsg.base.acccount+":<font color='red' id='fontImgAcc'>0</font></a></td>"+
				"<td width='16px'><img align='absmiddle' src='/images/docs/expand.png'></td>"+
				 "</tr></table> ";

...
Element.prototype.objectCreate = function(strUrl,objDiv,isRss){
    if(this.languageid==8)
        objDiv.innerHTML="<img src=/images/loading2.gif> Executing..."
    else if(this.languageid==9)
         objDiv.innerHTML="<img src=/images/loading2.gif>處理中..."
    else
        objDiv.innerHTML="<img src=/images/loading2.gif> 处理中..."
    //alert(this.loading)
	...
	xmlHttp.onreadystatechange = function () {
        ...
        switch (xmlHttp.readyState) {
           case 3 :
                    if(this.languageid==8)
                        objDiv.innerHTML="<img src=/images/loading2.gif> Transfering...";
                    else if(this.languageid==9)
         				objDiv.innerHTML="<img src=/images/loading2.gif>傳輸中..."
                    else
                        objDiv.innerHTML="<img src=/images/loading2.gif> 传输中...";

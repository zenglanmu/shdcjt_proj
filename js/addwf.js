...
//设置当前选择的标签且从后台取数据
{
	...
	} else if("tab00000" == tabname)
	{
		if(tab000001OldURL != tab000001URL)
		{
			doGet(tab000001, tab000001URL);
			tab000001OldURL = tab000001URL;
		}
	}
}
...
function setNowTab0002(tabName)
{
	...
	if(tab0002OldURL != tab0002URL)
	{
		doGet(tab0002, tab0002URL);
		tab0002OldURL = tab0002URL;
	}
}

function setNowTab0003(tabName)
{
	nowtab = tabName;
...
function setNowTab0004(tabName){
    nowtab = tabName;
...
{
	nowtab = tabName;
	if(tabName == "tab000001"){
		tab_t = tabName;
	}else if(tabName == "tab000002"){
		tab_t = tabName;
	}else if(tabName == "tab00000"){
		nowtab = tab_t;
	}
	if(tabName=="tab000002"){
		doGet(tab000002,"/workflow/workflow/fieldTrigger.jsp?ajax=1&wfid="+workflowidAll);
	}else{
	//if(tab000001OldURL != tab000001URL)
	//{
		doGet(tab000001, tab000001URL);
...
function showRightClickMenu(e){
		...
		if (bottomedge<rightMenu.offsetHeight){
			if(nowtab=="tab0"){
			rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0").offsetTop-document.getElementById("tab1").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab0).scrollTop;
			}
			else if(nowtab=="tab00"){
			rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab00").offsetTop-document.getElementById("tab01").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab1).scrollTop;
			}
			else if(nowtab=="tab0000"||nowtab=="tab0001")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0001").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0002")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0002").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0003")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0003").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0004"){
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0004").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0005"){
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0005").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}
			else if(nowtab=="tab00000"||nowtab=="tab000001")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab00000").offsetTop-document.getElementById("tab000001").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab000002")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab00000").offsetTop-document.getElementById("tab000002").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
			}
		}else{
			if(nowtab=="tab0"){
			rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0").offsetTop-document.getElementById("tab1").offsetTop+document.getElementById(nowtab0).scrollTop;
			}
			else if(nowtab=="tab00"){

			rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab00").offsetTop-document.getElementById("tab01").offsetTop+document.getElementById(nowtab1).scrollTop;
			}
			else if(nowtab=="tab0000"||nowtab=="tab0001")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0001").offsetTop+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0002")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0002").offsetTop+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0003")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0003").offsetTop-rightMenu.offsetHeight+document.getElementById(nowtab).scrollTop;
            }else if(nowtab=="tab0004"){
            	rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0004").offsetTop+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab0005"){
            	rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab0000").offsetTop-document.getElementById("tab0005").offsetTop+document.getElementById(nowtab).scrollTop;
			}
			else if(nowtab=="tab00000"||nowtab=="tab000001")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab00000").offsetTop-document.getElementById("tab000001").offsetTop+document.getElementById(nowtab).scrollTop;
			}else if(nowtab=="tab000002")
			{
				rightMenu.style.top=document.body.scrollTop+event.clientY-document.getElementById("tab00000").offsetTop-document.getElementById("tab000002").offsetTop+document.getElementById(nowtab).scrollTop;
			}
		}
		
		//判断当前tab页是否为 节点信息
		if(nowtab == "tab0" &&  nowtab0 == "tab2"){
			...
			var tabTop = document.getElementById("tab2").scrollTop;
			//tab2即为当前tab页(节点信息tab页)可滚动的高度值,    变值
			var tabHeight = document.getElementById("tab2").scrollHeight;
			//tab2即为当前tab页(节点信息tab页)的总高度,   变值
			var tabCt = document.getElementById("tab2").clientHeight;
...
function nodeedit() {
		doGet(tab2, "/workflow/workflow/addwfnode.jsp?ajax=1&src=editwf&wfid="+workflowidAll);
	}
function toformtab(){
	tab01oldurl="";
...
function cancelEditNode(){
		doGet(tab2, "/workflow/workflow/Editwfnode.jsp?ajax=1&wfid="+workflowidAll  );
}
function nodefieldedit(id){
		doGet(tab2, "/workflow/workflow/addwfnodefield.jsp?ajax=1&wfid="+workflowidAll+"&nodeid="+id  );
	}
function nodefieldbatchset(nodeid,ajax){
	doGet(tab2, "/workflow/workflow/edithtmlnodefield.jsp?wfid="+workflowidAll+"&nodeid="+nodeid+"&ajax="+ajax);
}
function cancelBatchSet(tmpnodeid){
	doGet(tab2, "/workflow/workflow/addwfnodefield.jsp?ajax=1&wfid="+workflowidAll+"&nodeid="+tmpnodeid);
}
...
function tab2ref(){
	var tmpURL = tab2url+designTime;
	if(isEdit==1&&usrId!=editor) tmpURL = wfEditor;
	if(tab2oldurl!=tmpURL){
		doGet(tab2,tmpURL);
		tab2oldurl=tmpURL;
	}
	setnowtab0('tab2');
...
function tab3ref(){
	var tmpURL = tab3url+designTime;
	if(isEdit==1&&usrId!=editor) tmpURL = wfEditor;
	if(tab3oldurl!=tmpURL){
		doGet(tab3,tmpURL);
		tab3oldurl=tmpURL;
	}
	setnowtab0('tab3');
...
function tab10ref(){
	if(tab10oldurl!=tab10url){
		doGet(tab10,tab10url);
		tab10oldurl=tab10url;
	}
	setnowtab0('tab10');
}
function tab11ref(){
	if(tab11oldurl!=tab11url){
		doGet(tab11,tab11url);
		tab11oldurl=tab11url;
	}
	setnowtab0('tab11');
}
...
function nodeopadd(formid,nodeid,isbill,iscust){
        doGet(tab2, "addoperatorgroup.jsp?ajax=1&wfid="+workflowidAll+"&nodeid="+nodeid+"&formid="+formid+"&isbill="+isbill+"&iscust="+iscust);
}
function nodeopedit(formid,nodeid,id,isbill,iscust){
        doGet(tab2, "editoperatorgroup.jsp?ajax=1&wfid="+workflowidAll+"&nodeid="+nodeid+"&formid="+formid+"&isbill="+isbill+"&iscust="+iscust+"&id="+id);
    }
...
function wfurgersave(obj){
        ...
        obj.disabled = true;
        doPost(wfurgerform, tab11);
}
//xwj for td3665 200602223
function wfmsave(obj){
    obj.disabled=true;
    doPost($("form[name=wfmForm]")[0],tab6);
}
...
function flowCodeSave(obj)
{
 obj.disabled=true;
 onSave(obj);
 doPost($("form[name=frmCoder]")[0],tab10);
}
...
function linkageviewattrsubmit(obj){
    if (check_form(frmlinkageviewattr,document.all('checkfield').value)) {
        obj.disabled=true;
        doPost(frmlinkageviewattr,tab000001)  ;
   }
}
...
function onSaveShortNameSetting(obj) {
	...
	doPost(formShortNameSetting, tab10);
}
...
function onSearchSupSubComAbbr(obj) {
	...
	doPost(formSupSubComAbbr, tab10);
}

								...
								tbar:[{									
									...
									for (var i=0;i<arrRecord.length;i++ ){
											try{
												...
												if(dvid==sd){alert("文档正在使用中,无法删除!");return;}
											}catch(e){}
									 }
									}
									//td33488 end
 ...
 DocCommonExt.getDocVerPanel=function(){
 	var storeDocVers = new Ext.data.Store({
        ...
        reader: new Ext.data.JsonReader({
            fields: [{name: 'docsubject'}, {name: 'versionid' }, { name: 'creator'}, {name: 'doclastmoditime'}]
        })      
        /*,listeners: {
            load: function(sm, records, options){
    ...
    var columnsDocVers = new Ext.grid.ColumnModel([
	    ...
	    { header: wmsg.base.creator,width: .1,sortable: true,dataIndex: 'creator', hideable: true},
 ...
 /*文档打分*/
  ...
  DocCommonExt.finalDo=function(mode){
	...
	divFavorite.innerHTML="<img src='/images/btnFavorite.gif' style='cursor:hand' onclick=\"openFavouriteBrowser();\" title="+wmsg.base.addToFavorite+">" +
			"&nbsp;<img src='/images/help2.gif'  style='cursor:hand' onclick='DocCommonExt.showHelp()' title="+wmsg.base.help+">"; 

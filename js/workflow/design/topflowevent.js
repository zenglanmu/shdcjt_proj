...
function showFouces(id){
	...
	if(((Math.abs(event.x-parseInt(proc.X))<3||Math.abs(event.x-parseInt(proc.X)-parseInt(proc.Width))<3)&&(event.y>=parseInt(proc.Y)&&event.y<=parseInt(proc.Y)+parseInt(proc.Height)))
		||((Math.abs(event.y-parseInt(proc.Y))<3||Math.abs(event.y-parseInt(proc.Y)-parseInt(proc.Height))<3)&&(event.x>=parseInt(proc.X)&&event.x<=parseInt(proc.X)+parseInt(proc.Width)))
	){
...
function showPoint(id){
	...
	if(start!=null){
		...
		if(event.x<parseInt(start.style.left)+parseInt(start.style.width)&&event.x>parseInt(start.style.left)&&
			event.y<parseInt(start.style.top)+parseInt(start.style.height)&&event.y>parseInt(start.style.top)){
			start.style.display ='';
		}else{
	...
	if(end!=null){
		...
		if(event.x<parseInt(end.style.left)+parseInt(end.style.width)&&event.x>parseInt(end.style.left)&&
			event.y<parseInt(end.style.top)+parseInt(end.style.height)&&event.y>parseInt(end.style.top)){
			end.style.display ='';
		}else{

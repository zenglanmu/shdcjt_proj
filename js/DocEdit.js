 ...
 Ext.onReady(function(){
		...
		if (canViewLog) {
			strTable+="<td width='105px'><a onClick='DocAllPropPanel.expand(true);DocSetTabPanel.setActiveTab(\"DocReply\");'><img align='absmiddle' src='/images/docs/reply.png'>&nbsp;"+wmsg.base.replycount+":<font color='red'  id='fontReply'>0</font></a></td>";
		} else{
			strTable+="<td width='105px'><img align='absmiddle' src='/images/docs/reply.png'>&nbsp;"+wmsg.base.replycount+":<font color='red'  id='fontReply'>0</font></td>";
		}
	 	//"<td width='96px'><img align='absmiddle' src='/images/docs/read.png'>&nbsp;"+wmsg.base.readcount+":<font color='red'>"+readCount_int+"</font></td>"+
//		if (canReplay) {
...
//		 }
		   strTable+="<td width='16px'><img align='absmiddle' src='/images/docs/expand.png'></td>"+
					 "</tr></table> ";

...
function iSignatureFunc(rev){
	...
	if(resValue == rev){
		try{
			...
			document.getElementById('thSure_id').style.display = "none";
		}catch(e){
		}
		try{	
		    //Ext.getCmp('thModeS_id').hide();
			document.getElementById('thModeS_id').style.display = "none";
		}catch(e){
		}
		try{
		    //Ext.getCmp('signature_id1').show();
		    document.getElementById('signature_id1').style.display = "block";
		}catch(e){
		}
		try{
		    //Ext.getCmp('signature_id2').show();
			document.getElementById('signature_id2').style.display = "block";
		}catch(e){
		}
		try{
		    //Ext.getCmp('thCancel_id').show();
			document.getElementById('thCancel_id').style.display = "block";
		}catch(e){
		}

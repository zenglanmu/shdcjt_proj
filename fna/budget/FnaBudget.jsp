...
<IFRAME name=leftframe id=leftframe src="/fna/budget/FnaBudgetLeft.jsp" width="100%" height="100%" frameborder=no scrolling=auto>
...
<IFRAME name=contentframe id=contentframe src="/fna/budget/FnaBudgetView.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
</TBODY>

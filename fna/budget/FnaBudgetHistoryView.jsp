...
<%
	...
	while(RecordSet.next()) {
	    ...
	    if(!"0".equals(Util.null2String(RecordSet.getString(3)))) {
		    tmprevision+=SystemEnv.getHtmlLabelName(567,user.getLanguage());//版本
		    tmprevision+=Util.null2String(RecordSet.getString(2));
		    tmprevision+="&nbsp;(";
		    if("1".equals(Util.null2String(RecordSet.getString(3)))) tmprevision+=SystemEnv.getHtmlLabelName(18431,user.getLanguage());//生效
		    if("2".equals(Util.null2String(RecordSet.getString(3)))) tmprevision+=SystemEnv.getHtmlLabelName(1477,user.getLanguage());//历史
		    if("3".equals(Util.null2String(RecordSet.getString(3)))) tmprevision+=SystemEnv.getHtmlLabelName(2242,user.getLanguage());//待审批
		    tmprevision+=")";
		} else tmprevision+=SystemEnv.getHtmlLabelName(220,user.getLanguage());//草稿

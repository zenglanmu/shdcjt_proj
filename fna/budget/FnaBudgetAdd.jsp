  ...
  <input class=inputstyle type=hidden name="createdate" value="<%=currentdate%>">
   <table class=Viewform>
    ...
    <tr> 
      ...
      <SPAN id=periodsidimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
	  </td>
    </tr>
...
sub onShowDepartment()
	...
	if (Not IsEmpty(id)) then
		...
		if issame = false then
			budgetcostercenteridspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
			frmMain.budgetcostercenterid.value=""
			budgetresourceidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"
...
sub onShowCurrencyID()
	...
	if NOT isempty(id) then
		...
		budgetcurrencyidspan.innerHtml = "<IMG src='/images/BacoError.gif' align=absMiddle>"

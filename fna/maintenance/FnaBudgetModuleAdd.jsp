  ...
  <TABLE class=viewForm id=tblScenarioCode>
    ...
    <TR> 
      ...
      <TD class=FIELD>
        ...
        <SPAN id=budgetnameimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
      <TD>Äê </TD>
      <TD class=field>
...
<%}%>
    ...
    <TR> 
      ...
      <TD class=FIELD><nobr>
        ...
        <SPAN id=budgetdescimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN></TD>
      ...
      <TD class=field> 
        ...
        <SPAN id=periodsidtoimage><IMG src="/images/BacoError.gif" align=absMiddle></SPAN>
		</TD>
    </TR>
        <TR style="height:1px"><TD class=Line colSpan=6></TD></TR> 

...
<IFRAME name=leftframe id=leftframe src="/fna/maintenance/FnaBudgetfeeTypeLeft.jsp" width="100%" height="100%" frameborder=no scrolling=auto>
...
<IFRAME name=contentframe id=contentframe src="/fna/maintenance/FnaBudgetfeeTypeView.jsp" width="100%" height="100%" frameborder=no scrolling=yes>
浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</IFRAME>
</td>
</tr>
</TBODY>

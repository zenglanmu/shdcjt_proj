...
<% if(ledgerimage.equals("0")) {%><IMG SRC="\images\imgBullet.gif" BORDER="0" HEIGHT="12px" WIDTH="12px">
<%} else if(ledgerimage.equals("1")) {%>
<A HREF="FnaLedger.jsp?selectedid=<%=selectedid%>&newselectedid=<%=ledgerid%>&addorsub=1"><IMG SRC="\images\btnDocExpand.gif" BORDER="0" HEIGHT="12px" WIDTH="12px"></A>
<%} else if(ledgerimage.equals("2")) {%>
<A HREF="FnaLedger.jsp?selectedid=<%=selectedid%>&newselectedid=<%=ledgerid%>&addorsub=0"><IMG SRC="\images\btnDocCollapse.gif" BORDER="0" HEIGHT="12px" WIDTH="12px"></A>
<% } %>
</td>

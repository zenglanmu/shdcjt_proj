	...
	<TD valign="top">
		<TABLE class="ListStyle" width="100%" id="WorkPlanTable" height="100%" cellspacing="1">
			...
			String sqlSelect = "SELECT C.*, WorkPlanExchange.exchangeCount FROM(SELECT * FROM "
				...
				+ " LEFT JOIN"
				+ " ("
				+ " SELECT workPlanShareDetail.workId, max(shareLevel) shareLevel "
				+ " FROM WorkPlanShareDetail workPlanShareDetail"
				+ " WHERE workPlanShareDetail.userId = " + userId
				//+ " AND workPlanShareDetail.userType = 1 and workPlanShareDetail.sharesrc='1' "
				+ " AND workPlanShareDetail.userType = 1 "
				+ " GROUP BY workPlanShareDetail.workId"
				+ " ) B"
...
<%!
	...
	public String getUrgent(int urgentLevel)
	{
	    if(2 == urgentLevel)
	    {
	        return "<IMG src='/images/important.gif' align=absMiddle>";
	    }
	    else if(3 == urgentLevel)
	    {
	        return "<IMG src='/images/urgent.gif' align=absMiddle>";
	    }
	    else
	    {
	        return "";

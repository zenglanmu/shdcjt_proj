	  ...
	  <TABLE class="viewform">
        ...
        <TBODY>
            ...
            <%=SystemEnv.getHtmlLabelName(16094,user.getLanguage())%>
         	...
         	<TR style="height:1px">
            <Td colSpan=2 class="Line1" style="padding:0"></Td>
          </TR>
        <TR>
          <TD>
		  ...
		  <select class=inputstyle  name=sharetyped onchange="onChangeSharetyped()" >
			...
			<button type="button" class=Browser style="display:none" onClick="onShowResource('showrelatedsharenamed','relatedshareided')" name=showresourced></BUTTON> 
...
<!--原有共享--><br>
        <table class=liststyle cellspacing=1>
          ...
          <tr class="Spacing"  style="height:1px"> 
            <td class="Line1" colspan=7 style="padding:0;"></td>
          </tr>
		  <tr class=Header> 
		  ...
		  <TR style="height:1px">
            <Td colSpan=7 class="Line1"  style="padding:0;"></Td>
          </TR>
<%
	//查找已经添加的共享
	String newName="";
	String oldName="";
	RecordSet.execute("select workPlanType.workPlanTypename ,WorkPlanShareSet.* from WorkPlanShareSet,workPlanType  where settype=0 and workPlanTypeID=planid order by planid ,id desc");
...
function delplan(id)
{
	if (isdel())
	{
		location.href="PlanShareOperation.jsp?types=0&method=delete&id="+id;
	}
}
function doSave(obj) {

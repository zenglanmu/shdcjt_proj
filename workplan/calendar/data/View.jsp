...
<head id="Head1">
    ...
    <script src="/workplan/calendar/src/Plugins/jquery.alert.js" type="text/javascript"></script>    
    <script src="/workplan/calendar/src/Plugins/jquery.ifrmdailog.js" defer="defer" type="text/javascript"></script>
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">   
	            ...
	            <div class="fshowdatep fbutton">
	                    <div>
	                        ...
	                        <span id="txtdatetimeshow" class="selectDate">选择日期</span>
            ...
            <div id="editButtons" style="display:none;">
            	<div class="fbutton" id="saveBtn">
            		<div>
            			<span class="saveCal">保存</span>
            		</div>
            	</div>
            	<div class="btnseparator"></div>
            	<div class="fbutton" id="cancelEditBtn">
            		<div>
            			<span class="cancelCalEdit">取消</span>
            		</div>
            	</div>
            	<div class="btnseparator"></div>
            	<div class="fbutton" id="DeleteBtn">
            		<div>
            			<span class="deleteCal">删除</span>
            		</div>
            	</div>
            	<div class="btnseparator"></div>
            	<div class="fbutton" id="EndEventBtns">
            		<div>
            			<span class="endCal">结束日程</span>
            		</div>
            	</div>
            ...
            <div style="float:right">
            	...
            	<div class="fbutton">
            		<div>
            			<span  onclick="showMyCalnedar()" class="myCal">我的日程</span>
            		</div>
            	</div>
            </div>
            <div class="clear"></div>
            				...
            				<form action="">
            					<table style="width:100%;padding:10;" class="ViewForm" >
            						...
            						<tr class="calLine">
            							<td >日程类型</td>
     										<td></td>
     										<td><select id="workPlanType" name="workPlanType"><option value="0">工作安排</option></select></td>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td width="145"><a href="http:\\www.weaver.com.cn" target=_blank><img alt="Weaver" src="/images_frame/logo.gif" border="0"></a></td>
          <td background="/images_frame/top_bg.gif" valign="bottom"> 
            <table width="85%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td align="center" ><a href="/main.jsp?targetid=1"  target=_top><%if(targetidstr.equals("1")) {%><img src="/images_frame/top_button1_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button1.gif" border="0" ><%}%></a></td>
			<%if(!logintype.equals("2")){%>
                <td align="center" ><a href="/main.jsp?targetid=2"  target=_top><%if(targetidstr.equals("2")) {%><img src="/images_frame/top_button2_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button2.gif" border="0" ><%}%></a></td>
			<%}%>
			<%if(!logintype.equals("2")){%>
				 <td align="center" ><a href="/main.jsp?targetid=9"  target=_top><%if(targetidstr.equals("9")) {%><img src="/images_frame/top_button3_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button3.gif" border="0" ><%}%></a></td>
			<%}%>
			<%if(!logintype.equals("2")){%>
                <!-- td align="center" ><a href="/main.jsp?targetid=4"  target=_top><%if(targetidstr.equals("4")) {%><img src="/images_frame/top_button3_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button3.gif" border="0" ><%}%></a></td -->
			<%}%>
			<%if(!logintype.equals("2")){%>
                <td align="center" ><a href="/main.jsp?targetid=3"  target=_top><%if(targetidstr.equals("3")) {%><img src="/images_frame/top_button4_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button4.gif" border="0" ><%}%></a></td>
			<%}%>
                <td align="center" ><a href="/main.jsp?targetid=5"  target=_top><%if(targetidstr.equals("5")) {%><img src="/images_frame/top_button5_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button5.gif" border="0" ><%}%></a></td>
                <td align="center" ><a href="/main.jsp?targetid=6"  target=_top><%if(targetidstr.equals("6")) {%><img src="/images_frame/top_button7_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button7.gif" border="0" ><%}%></a></td>
                <td align="center" ><a href="/main.jsp?targetid=7"  target=_top><%if(targetidstr.equals("7")) {%><img src="/images_frame/top_button6_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button6.gif" border="0" ><%}%></a></td>
			<%if(!logintype.equals("2")){%>
                <td align="center" ><a href="/main.jsp?targetid=8"  target=_top><%if(targetidstr.equals("8")) {%><img src="/images_frame/top_button8_in.gif" border="0" ><%} else {%> <img src="/images_frame/top_button8.gif" border="0" ><%}%></a></td>
			<%}%>
              </tr>
              <tr height="20"> 
...
<%}%>
	...
	<%}%>
				...
				<td width=20></td>
                <td>
                <img alt="快速搜索" src="/images_frame/search_dot.gif" border="0" onclick="form1.submit()" style="CURSOR:HAND"></td>

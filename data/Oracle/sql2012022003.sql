   ...
   begin 
    ...
    begin
        ...
        while cursor0%found loop
           WHILE val_managerid<>0 AND val_managerid IS NOT NULL and ((val_id=val_managerid and val_managerCount=1) or (val_id<>val_managerid and val_managerCount<=2)) loop
